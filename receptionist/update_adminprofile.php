<?php
// ============================================================
// RECEPTIONIST PROFILE - UPDATE PROFILE & PASSWORD
// (No permission checks – any logged‑in Receptionist can view/edit)
// ============================================================
...
// Allow only 'Receptionist' (and optionally Admins/Super Admins if needed)
$allowed_roles = ['Receptionist', 'Admin', 'Super Admin'];
...
if ($result->num_rows > 0) {
    ...
    echo "<script>
            alert('Receptionist profile not found.');
            window.location='dashboard_receptionist.php';
          </script>";
    exit();
}
...
if (isset($_POST['update_profile'])) {
    ...
    if (isset($_FILES['profile_image']) && $_FILES['profile_image']['error'] == 0) {
        ...
        if (empty($errors['profile_image'])) {
            $folder = "documents/receptionist/images/";
            if (!is_dir($folder)) {
            ...
            <div class="form-card">
                ...
                <form action="update_adminprofile.php" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="form-actions">
                        <a href="dashboard_receptionist.php" class="btn btn-secondary">
