...
(16, 1058, 'abhishek mandhare', NULL, 'documents/receptionist/images/1785595331_default.jpeg', '2026-08-01 05:00:53', '2026-08-01 14:42:11', 0),
(17, 1072, 'Hrugwed More', NULL, 'documents/accountant/images/1785597359_acc.jpg', '2026-08-01 15:09:31', '2026-08-03 07:50:18', 0);
...
CREATE TABLE `advance_deposits` (
  ...
  `mode` enum('Cash','Card','UPI','Bank') DEFAULT 'Cash',
...
(835, 5, 1040, 'Rahul Namya', 'Lab Technician', 'Logout', 'User logged out', 'Logout', 'User logged out', '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/150.0.0.0 Safari/537.36 Edg/150.0.0.0', 'Chrome', '2026-07-31 10:14:06', 0),
(836, NULL, 1006, 'Super Admin', 'Super Admin', 'Dashboard', 'Super Admin accessed dashboard', 'Dashboard', 'Super Admin accessed dashboard', '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/150.0.0.0 Safari/537.36', 'Chrome', '2026-07-31 10:19:07', 0),
(837, NULL, 1006, 'Super Admin', 'Super Admin', 'Dashboard', 'Super Admin accessed dashboard', 'Dashboard', 'Super Admin accessed dashboard', '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/150.0.0.0 Safari/537.36', 'Chrome', '2026-07-31 10:23:22', 0),
(838, NULL, 1006, 'Super Admin', 'Super Admin', 'Dashboard', 'Super Admin accessed dashboard', 'Dashboard', 'Super Admin accessed dashboard', '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/150.0.0.0 Safari/537.36', 'Chrome', '2026-07-31 10:24:20', 0),
(839, NULL, 1006, 'Super Admin', 'Super Admin', 'Audit Logs', 'User viewed audit logs', 'Audit Logs', 'User viewed audit logs', '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/150.0.0.0 Safari/537.36', 'Chrome', '2026-07-31 10:24:27', 0);
INSERT INTO `audit_logs` (`log_id`, `hospital_id`, `register_id`, `user_name`, `user_role`, `action_type`, `description`, `module`, `action`, `ip_address`, `user_agent`, `browser`, `created_at`, `delete_flag`) VALUES
(840, NULL, 1006, 'Super Admin', 'Super Admin', 'Staff', 'Updated Staff ID 21', 'Staff', 'Updated Staff ID 21', '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/150.0.0.0 Safari/537.36', 'Chrome', '2026-07-31 10:40:36', 0),
(841, NULL, 1006, 'Super Admin', 'Super Admin', 'Staff', 'Updated Staff ID 11', 'Staff', 'Updated Staff ID 11', '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/150.0.0.0 Safari/537.36', 'Chrome', '2026-07-31 10:42:10', 0),
(842, NULL, 1006, 'Super Admin', 'Super Admin', 'Staff', 'Updated Staff ID 11', 'Staff', 'Updated Staff ID 11', '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/150.0.0.0 Safari/537.36', 'Chrome', '2026-07-31 10:42:25', 0),
(843, NULL, 1006, 'Super Admin', 'Super Admin', 'Dashboard', 'Super Admin accessed dashboard', 'Dashboard', 'Super Admin accessed dashboard', '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/150.0.0.0 Safari/537.36', 'Chrome', '2026-07-31 10:42:33', 0),
(844, NULL, 1006, 'Super Admin', 'Super Admin', 'Dashboard', 'Super Admin accessed dashboard', 'Dashboard', 'Super Admin accessed dashboard', '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/150.0.0.0 Safari/537.36', 'Chrome', '2026-07-31 10:47:53', 0),
(845, NULL, 1006, 'Super Admin', 'Super Admin', 'Dashboard', 'Super Admin accessed dashboard', 'Dashboard', 'Super Admin accessed dashboard', '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/150.0.0.0 Safari/537.36', 'Chrome', '2026-07-31 10:47:59', 0),
(846, NULL, 1006, 'Super Admin', 'Super Admin', 'Dashboard', 'Super Admin accessed dashboard', 'Dashboard', 'Super Admin accessed dashboard', '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/150.0.0.0 Safari/537.36', 'Chrome', '2026-07-31 10:48:23', 0),
(847, NULL, 1006, 'Super Admin', 'Super Admin', 'Dashboard', 'Super Admin accessed dashboard', 'Dashboard', 'Super Admin accessed dashboard', '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/150.0.0.0 Safari/537.36', 'Chrome', '2026-07-31 10:48:30', 0),
(848, NULL, 1006, 'Super Admin', 'Super Admin', 'Dashboard', 'Super Admin accessed dashboard', 'Dashboard', 'Super Admin accessed dashboard', '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/150.0.0.0 Safari/537.36', 'Chrome', '2026-07-31 10:49:01', 0),
(849, NULL, 1006, 'Super Admin', 'Super Admin', 'Subscription', 'Super Admin updated limits for Hospital ID 7: Dep=2, Doc=4, Staff=5', 'Subscription', 'Super Admin updated limits for Hospital ID 7: Dep=2, Doc=4, Staff=5', '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/150.0.0.0 Safari/537.36', 'Chrome', '2026-07-31 11:22:12', 0),
(850, NULL, 1006, 'Super Admin', 'Super Admin', 'Subscription', 'Super Admin updated limits for Hospital ID 7: Dep=2, Doc=4, Staff=5', 'Subscription', 'Super Admin updated limits for Hospital ID 7: Dep=2, Doc=4, Staff=5', '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/150.0.0.0 Safari/537.36', 'Chrome', '2026-07-31 11:22:18', 0),
(851, NULL, 1006, 'Super Admin', 'Super Admin', 'Subscription', 'Super Admin applied bulk limits: Dep=2, Doc=10, Staff=10 to 4 hospitals', 'Subscription', 'Super Admin applied bulk limits: Dep=2, Doc=10, Staff=10 to 4 hospitals', '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/150.0.0.0 Safari/537.36', 'Chrome', '2026-07-31 11:22:22', 0),
(852, NULL, 1006, 'Super Admin', 'Super Admin', 'Logout', 'User logged out', 'Logout', 'User logged out', '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/150.0.0.0 Safari/537.36', 'Chrome', '2026-07-31 11:22:25', 0),
(853, NULL, 1006, 'Super Admin', 'Super Admin', 'Dashboard', 'Super Admin accessed dashboard', 'Dashboard', 'Super Admin accessed dashboard', '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/150.0.0.0 Safari/537.36', 'Chrome', '2026-07-31 11:22:27', 0),
(854, NULL, 1006, 'Super Admin', 'Super Admin', 'Subscription', 'Super Admin applied bulk limits: Dep=2, Doc=4, Staff=4 to 4 hospitals', 'Subscription', 'Super Admin applied bulk limits: Dep=2, Doc=4, Staff=4 to 4 hospitals', '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/150.0.0.0 Safari/537.36', 'Chrome', '2026-07-31 11:22:44', 0),
(855, NULL, 1006, 'Super Admin', 'Super Admin', 'Dashboard', 'Super Admin accessed dashboard', 'Dashboard', 'Super Admin accessed dashboard', '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/150.0.0.0 Safari/537.36', 'Chrome', '2026-07-31 11:54:38', 0),
(856, 5, 1028, 'Ayush Nipanes', 'Doctor', 'Logout', 'User logged out', 'Logout', 'User logged out', '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/150.0.0.0 Safari/537.36 Edg/150.0.0.0', 'Chrome', '2026-08-01 04:51:42', 0),
(857, 5, 1028, 'Ayush Nipanes', 'Doctor', 'Logout', 'User logged out', 'Logout', 'User logged out', '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/150.0.0.0 Safari/537.36 Edg/150.0.0.0', 'Chrome', '2026-08-01 04:56:21', 0),
(858, 5, 1058, 'abhishek mandhare', 'Receptionist', 'Logout', 'User logged out', 'Logout', 'User logged out', '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/150.0.0.0 Safari/537.36', 'Chrome', '2026-08-01 04:56:35', 0),
(859, 5, 1058, 'abhishek mandhare', 'Receptionist', 'Logout', 'User logged out', 'Logout', 'User logged out', '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/150.0.0.0 Safari/537.36', 'Chrome', '2026-08-01 05:03:40', 0),
(860, 5, 1058, 'abhishek mandhare', 'Receptionist', 'Logout', 'User logged out', 'Logout', 'User logged out', '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/150.0.0.0 Safari/537.36', 'Chrome', '2026-08-01 05:23:29', 0),
(861, 5, 1028, 'Ayush Nipanes', 'Doctor', 'Logout', 'User logged out', 'Logout', 'User logged out', '127.0.0.1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/150.0.0.0 Safari/537.36', 'Chrome', '2026-08-01 05:24:44', 0),
(862, 6, 1058, 'abhishek mandhare', 'Receptionist', 'Logout', 'User logged out', 'Logout', 'User logged out', '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/150.0.0.0 Safari/537.36', 'Chrome', '2026-08-01 05:24:53', 0),
(863, 5, 1058, 'abhishek mandhare', 'Receptionist', 'Logout', 'User logged out', 'Logout', 'User logged out', '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/150.0.0.0 Safari/537.36', 'Chrome', '2026-08-01 05:30:05', 0),
(864, 5, 1028, 'Ayush Nipanes', 'Doctor', 'Logout', 'User logged out', 'Logout', 'User logged out', '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/150.0.0.0 Safari/537.36 Edg/150.0.0.0', 'Chrome', '2026-08-01 06:22:20', 0),
(865, NULL, 1006, 'Super Admin', 'Super Admin', 'Dashboard', 'Super Admin accessed dashboard', 'Dashboard', 'Super Admin accessed dashboard', '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/150.0.0.0 Safari/537.36 Edg/150.0.0.0', 'Chrome', '2026-08-01 06:22:25', 0),
(866, NULL, 1006, 'Super Admin', 'Super Admin', 'Logout', 'User logged out', 'Logout', 'User logged out', '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/150.0.0.0 Safari/537.36 Edg/150.0.0.0', 'Chrome', '2026-08-01 06:30:13', 0),
(867, 5, 1028, 'Ayush Nipanes', 'Doctor', 'Logout', 'User logged out', 'Logout', 'User logged out', '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/150.0.0.0 Safari/537.36 Edg/150.0.0.0', 'Chrome', '2026-08-01 06:46:04', 0),
(868, 5, 1058, 'abhishek mandhare', 'Receptionist', 'Logout', 'User logged out', 'Logout', 'User logged out', '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/150.0.0.0 Safari/537.36', 'Chrome', '2026-08-01 07:05:42', 0),
(869, NULL, 1006, 'Super Admin', 'Super Admin', 'Dashboard', 'Super Admin accessed dashboard', 'Dashboard', 'Super Admin accessed dashboard', '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/150.0.0.0 Safari/537.36', 'Chrome', '2026-08-01 14:05:28', 0),
(870, NULL, 1006, 'Super Admin', 'Super Admin', 'Logout', 'User logged out', 'Logout', 'User logged out', '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/150.0.0.0 Safari/537.36', 'Chrome', '2026-08-01 14:05:44', 0),
(871, NULL, 1006, 'Super Admin', 'Super Admin', 'Dashboard', 'Super Admin accessed dashboard', 'Dashboard', 'Super Admin accessed dashboard', '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/150.0.0.0 Safari/537.36', 'Chrome', '2026-08-01 14:05:50', 0),
(872, NULL, 1006, 'Super Admin', 'Super Admin', 'Audit Logs', 'User viewed audit logs', 'Audit Logs', 'User viewed audit logs', '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/150.0.0.0 Safari/537.36', 'Chrome', '2026-08-01 14:06:09', 0),
(873, NULL, 1006, 'Super Admin', 'Super Admin', 'Audit Logs', 'User viewed audit logs', 'Audit Logs', 'User viewed audit logs', '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/150.0.0.0 Safari/537.36', 'Chrome', '2026-08-01 14:06:31', 0),
(874, NULL, 1006, 'Super Admin', 'Super Admin', 'Audit Logs', 'User viewed audit logs', 'Audit Logs', 'User viewed audit logs', '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/150.0.0.0 Safari/537.36', 'Chrome', '2026-08-01 14:06:41', 0),
(875, NULL, 1006, 'Super Admin', 'Super Admin', 'Audit Logs', 'User viewed audit logs', 'Audit Logs', 'User viewed audit logs', '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/150.0.0.0 Safari/537.36', 'Chrome', '2026-08-01 14:06:49', 0),
(876, 5, 1028, 'Ayush Nipanes', 'Doctor', 'Logout', 'User logged out', 'Logout', 'User logged out', '127.0.0.1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/150.0.0.0 Safari/537.36', 'Chrome', '2026-08-01 14:18:54', 0),
(877, 5, 1023, 'Niraj Bhuteeee', 'Patient', 'Logout', 'User logged out', 'Logout', 'User logged out', '127.0.0.1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/150.0.0.0 Safari/537.36', 'Chrome', '2026-08-01 14:19:19', 0),
(878, NULL, 1006, 'Super Admin', 'Super Admin', 'Dashboard', 'Super Admin accessed dashboard', 'Dashboard', 'Super Admin accessed dashboard', '127.0.0.1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/150.0.0.0 Safari/537.36', 'Chrome', '2026-08-01 14:20:38', 0),
(879, NULL, 1006, 'Super Admin', 'Super Admin', 'User', 'Updated role of User ID 1068 to Nurse (assigned by )', 'User', 'Updated role of User ID 1068 to Nurse (assigned by )', '127.0.0.1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/150.0.0.0 Safari/537.36', 'Chrome', '2026-08-01 14:20:51', 0),
(880, NULL, 1006, 'Super Admin', 'Super Admin', 'Logout', 'User logged out', 'Logout', 'User logged out', '127.0.0.1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/150.0.0.0 Safari/537.36', 'Chrome', '2026-08-01 14:20:58', 0),
(881, 5, 1008, 'Dr. Sanket Pawar', 'Admin', 'Logout', 'User logged out', 'Logout', 'User logged out', '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/150.0.0.0 Safari/537.36', 'Chrome', '2026-08-01 14:26:15', 0),
(882, NULL, 1006, 'Super Admin', 'Super Admin', 'Dashboard', 'Super Admin accessed dashboard', 'Dashboard', 'Super Admin accessed dashboard', '127.0.0.1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/150.0.0.0 Safari/537.36', 'Chrome', '2026-08-01 14:30:52', 0),
(883, NULL, 1006, 'Super Admin', 'Super Admin', 'Dashboard', 'Super Admin accessed dashboard', 'Dashboard', 'Super Admin accessed dashboard', '127.0.0.1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/150.0.0.0 Safari/537.36', 'Chrome', '2026-08-01 14:33:48', 0),
(884, NULL, 1006, 'Super Admin', 'Super Admin', 'Logout', 'User logged out', 'Logout', 'User logged out', '127.0.0.1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/150.0.0.0 Safari/537.36', 'Chrome', '2026-08-01 14:33:51', 0),
(885, NULL, 1006, 'Super Admin', 'Super Admin', 'Dashboard', 'Super Admin accessed dashboard', 'Dashboard', 'Super Admin accessed dashboard', '127.0.0.1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/150.0.0.0 Safari/537.36', 'Chrome', '2026-08-01 14:40:39', 0),
(886, NULL, 1006, 'Super Admin', 'Super Admin', 'Logout', 'User logged out', 'Logout', 'User logged out', '127.0.0.1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/150.0.0.0 Safari/537.36', 'Chrome', '2026-08-01 14:46:18', 0),
(887, 5, 1058, 'abhishek mandhare', 'Receptionist', 'Logout', 'User logged out', 'Logout', 'User logged out', '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/150.0.0.0 Safari/537.36 Edg/150.0.0.0', 'Chrome', '2026-08-01 14:49:06', 0),
(888, 5, 1008, 'Dr. Sanket Pawar', 'Admin', 'Logout', 'User logged out', 'Logout', 'User logged out', '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/150.0.0.0 Safari/537.36', 'Chrome', '2026-08-01 14:49:09', 0),
(889, 5, 1068, 'Priya Joshi', 'Nurse', 'Logout', 'User logged out', 'Logout', 'User logged out', '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/150.0.0.0 Safari/537.36', 'Chrome', '2026-08-01 14:51:40', 0),
(890, 5, 1008, 'Dr. Sanket Pawar', 'Admin', 'Logout', 'User logged out', 'Logout', 'User logged out', '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/150.0.0.0 Safari/537.36', 'Chrome', '2026-08-01 14:52:33', 0),
(891, 5, 1068, 'Priya Joshi', 'Nurse', 'Logout', 'User logged out', 'Logout', 'User logged out', '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/150.0.0.0 Safari/537.36', 'Chrome', '2026-08-01 14:54:02', 0),
(892, 5, 1028, 'Ayush Nipane', 'Doctor', 'Logout', 'User logged out', 'Logout', 'User logged out', '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/150.0.0.0 Safari/537.36', 'Chrome', '2026-08-01 14:54:22', 0),
(893, 5, 1068, 'Priya Joshi', 'Nurse', 'Logout', 'User logged out', 'Logout', 'User logged out', '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/150.0.0.0 Safari/537.36', 'Chrome', '2026-08-01 15:02:08', 0),
(894, 5, 1008, 'Dr. Sanket Pawar', 'Admin', 'Logout', 'User logged out', 'Logout', 'User logged out', '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/150.0.0.0 Safari/537.36', 'Chrome', '2026-08-01 15:04:58', 0),
(895, 5, 1072, 'Hrugwed More', 'Accountant', 'Logout', 'User logged out', 'Logout', 'User logged out', '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/150.0.0.0 Safari/537.36', 'Chrome', '2026-08-01 15:29:16', 0),
(896, 5, 1072, 'Hrugwed More', 'Accountant', 'Logout', 'User logged out', 'Logout', 'User logged out', '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/150.0.0.0 Safari/537.36', 'Chrome', '2026-08-01 15:29:31', 0),
(897, 5, 1058, 'abhishek mandhare', 'Receptionist', 'Logout', 'User logged out', 'Logout', 'User logged out', '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/150.0.0.0 Safari/537.36 Edg/150.0.0.0', 'Chrome', '2026-08-01 15:33:10', 0),
(898, 5, 1068, 'Priya Joshi', 'Nurse', 'Logout', 'User logged out', 'Logout', 'User logged out', '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/150.0.0.0 Safari/537.36', 'Chrome', '2026-08-01 16:42:57', 0),
(899, 5, 1040, 'Rahul Namya', 'Lab Technician', 'Logout', 'User logged out', 'Logout', 'User logged out', '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/150.0.0.0 Safari/537.36', 'Chrome', '2026-08-01 17:00:24', 0),
(900, NULL, 1006, 'Super Admin', 'Super Admin', 'Dashboard', 'Super Admin accessed dashboard', 'Dashboard', 'Super Admin accessed dashboard', '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/150.0.0.0 Safari/537.36', 'Chrome', '2026-08-01 17:02:50', 0),
(901, NULL, 1006, 'Super Admin', 'Super Admin', 'Dashboard', 'Super Admin accessed dashboard', 'Dashboard', 'Super Admin accessed dashboard', '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/150.0.0.0 Safari/537.36', 'Chrome', '2026-08-01 17:03:02', 0),
(902, NULL, 1006, 'Super Admin', 'Super Admin', 'Dashboard', 'Super Admin accessed dashboard', 'Dashboard', 'Super Admin accessed dashboard', '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/150.0.0.0 Safari/537.36', 'Chrome', '2026-08-01 17:03:04', 0),
(903, NULL, 1006, 'Super Admin', 'Super Admin', 'Dashboard', 'Super Admin accessed dashboard', 'Dashboard', 'Super Admin accessed dashboard', '127.0.0.1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/150.0.0.0 Safari/537.36', 'Chrome', '2026-08-01 17:05:09', 0),
(904, NULL, 1006, 'Super Admin', 'Super Admin', 'Dashboard', 'Super Admin accessed dashboard', 'Dashboard', 'Super Admin accessed dashboard', '127.0.0.1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/150.0.0.0 Safari/537.36', 'Chrome', '2026-08-01 17:05:18', 0),
(905, NULL, 1006, 'Super Admin', 'Super Admin', 'Dashboard', 'Super Admin accessed dashboard', 'Dashboard', 'Super Admin accessed dashboard', '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/150.0.0.0 Safari/537.36', 'Chrome', '2026-08-01 17:05:26', 0),
(906, NULL, 1006, 'Super Admin', 'Super Admin', 'Dashboard', 'Super Admin accessed dashboard', 'Dashboard', 'Super Admin accessed dashboard', '127.0.0.1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/150.0.0.0 Safari/537.36', 'Chrome', '2026-08-01 17:05:31', 0),
(907, NULL, 1006, 'Super Admin', 'Super Admin', 'Dashboard', 'Super Admin accessed dashboard', 'Dashboard', 'Super Admin accessed dashboard', '127.0.0.1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/150.0.0.0 Safari/537.36', 'Chrome', '2026-08-01 17:05:34', 0),
(908, 5, 1068, 'Priya Joshi', 'Nurse', 'Logout', 'User logged out', 'Logout', 'User logged out', '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/150.0.0.0 Safari/537.36', 'Chrome', '2026-08-01 17:10:04', 0),
(909, 5, 1008, 'Dr. Sanket Pawar', 'Admin', 'Dashboard', 'Admin accessed dashboard', 'Dashboard', 'Admin accessed dashboard', '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/150.0.0.0 Safari/537.36', 'Chrome', '2026-08-01 17:13:13', 0),
(910, 5, 1072, 'Hrugwed More', 'Accountant', 'Logout', 'User logged out', 'Logout', 'User logged out', '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/150.0.0.0 Safari/537.36 Edg/150.0.0.0', 'Chrome', '2026-08-01 17:18:32', 0),
(911, NULL, 1006, 'Super Admin', 'Super Admin', 'Dashboard', 'Super Admin accessed dashboard', 'Dashboard', 'Super Admin accessed dashboard', '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/150.0.0.0 Safari/537.36', 'Chrome', '2026-08-01 17:23:28', 0),
(912, 5, 1068, 'Priya Joshi', 'Nurse', 'Logout', 'User logged out', 'Logout', 'User logged out', '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/150.0.0.0 Safari/537.36 Edg/150.0.0.0', 'Chrome', '2026-08-01 17:24:56', 0),
(913, NULL, 1006, 'Super Admin', 'Super Admin', 'Dashboard', 'Super Admin accessed dashboard', 'Dashboard', 'Super Admin accessed dashboard', '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/150.0.0.0 Safari/537.36', 'Chrome', '2026-08-01 17:25:29', 0),
(914, NULL, 1006, 'Super Admin', 'Super Admin', 'Dashboard', 'Super Admin accessed dashboard', 'Dashboard', 'Super Admin accessed dashboard', '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/150.0.0.0 Safari/537.36', 'Chrome', '2026-08-01 17:25:40', 0),
(915, NULL, 1006, 'Super Admin', 'Super Admin', 'Dashboard', 'Super Admin accessed dashboard', 'Dashboard', 'Super Admin accessed dashboard', '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/150.0.0.0 Safari/537.36', 'Chrome', '2026-08-01 17:26:10', 0),
(916, 5, 1008, 'Dr. Sanket Pawar', 'Admin', 'Logout', 'User logged out', 'Logout', 'User logged out', '127.0.0.1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/150.0.0.0 Safari/537.36', 'Chrome', '2026-08-01 17:39:10', 0),
(917, 5, 1068, 'Priya Joshi', 'Nurse', 'Logout', 'User logged out', 'Logout', 'User logged out', '127.0.0.1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/150.0.0.0 Safari/537.36', 'Chrome', '2026-08-01 17:55:09', 0),
(918, 5, 1008, 'Dr. Sanket Pawar', 'Admin', 'Logout', 'User logged out', 'Logout', 'User logged out', '127.0.0.1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/150.0.0.0 Safari/537.36', 'Chrome', '2026-08-01 18:02:05', 0),
(919, 5, 1040, 'Rahul Namya', 'Lab Technician', 'Logout', 'User logged out', 'Logout', 'User logged out', '127.0.0.1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/150.0.0.0 Safari/537.36', 'Chrome', '2026-08-01 18:03:44', 0),
(920, 5, 1008, 'Dr. Sanket Pawar', 'Admin', 'Logout', 'User logged out', 'Logout', 'User logged out', '127.0.0.1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/150.0.0.0 Safari/537.36', 'Chrome', '2026-08-01 18:12:24', 0),
(921, 5, 1028, 'Ayush Nipane', 'Doctor', 'Logout', 'User logged out', 'Logout', 'User logged out', '127.0.0.1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/150.0.0.0 Safari/537.36', 'Chrome', '2026-08-01 18:50:26', 0),
(922, 5, 1068, 'Priya Joshi', 'Nurse', 'Logout', 'User logged out', 'Logout', 'User logged out', '127.0.0.1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/150.0.0.0 Safari/537.36', 'Chrome', '2026-08-01 18:55:03', 0),
(923, 5, 1068, 'Priya Joshi', 'Nurse', 'Logout', 'User logged out', 'Logout', 'User logged out', '127.0.0.1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/150.0.0.0 Safari/537.36', 'Chrome', '2026-08-02 10:37:07', 0),
(924, 5, 1008, 'Dr. Sanket Pawar', 'Admin', 'Logout', 'User logged out', 'Logout', 'User logged out', '127.0.0.1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/150.0.0.0 Safari/537.36', 'Chrome', '2026-08-02 10:52:19', 0),
(925, NULL, 1006, 'Super Admin', 'Super Admin', 'Dashboard', 'Super Admin accessed dashboard', 'Dashboard', 'Super Admin accessed dashboard', '127.0.0.1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/150.0.0.0 Safari/537.36', 'Chrome', '2026-08-02 10:52:27', 0),
(926, NULL, 1006, 'Super Admin', 'Super Admin', 'Dashboard', 'Super Admin accessed dashboard', 'Dashboard', 'Super Admin accessed dashboard', '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/151.0.0.0 Safari/537.36 Edg/151.0.0.0', 'Chrome', '2026-08-03 05:54:58', 0),
(927, NULL, 1006, 'Super Admin', 'Super Admin', 'Logout', 'User logged out', 'Logout', 'User logged out', '127.0.0.1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/150.0.0.0 Safari/537.36', 'Chrome', '2026-08-03 05:57:15', 0),
(928, NULL, 1006, 'Super Admin', 'Super Admin', 'Subscription', 'Super Admin updated limits for Hospital ID 5: Dep=2, Doc=4, Staff=9', 'Subscription', 'Super Admin updated limits for Hospital ID 5: Dep=2, Doc=4, Staff=9', '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/151.0.0.0 Safari/537.36 Edg/151.0.0.0', 'Chrome', '2026-08-03 06:03:14', 0),
(929, NULL, 1006, 'Super Admin', 'Super Admin', 'Permission', 'Added new permission: Payments View (Slug: payments-view)', 'Permission', 'Added new permission: Payments View (Slug: payments-view)', '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/151.0.0.0 Safari/537.36 Edg/151.0.0.0', 'Chrome', '2026-08-03 06:30:03', 0),
(930, NULL, 1006, 'Super Admin', 'Super Admin', 'Permission', 'Added new permission: Payments Create (Slug: payments-create)', 'Permission', 'Added new permission: Payments Create (Slug: payments-create)', '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/151.0.0.0 Safari/537.36 Edg/151.0.0.0', 'Chrome', '2026-08-03 06:31:00', 0),
(931, 5, 1040, 'Rahul Namya', 'Lab Technician', 'Logout', 'User logged out', 'Logout', 'User logged out', '127.0.0.1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/150.0.0.0 Safari/537.36', 'Chrome', '2026-08-03 06:31:16', 0),
(932, NULL, 1006, 'Super Admin', 'Super Admin', 'Permission', 'Added new permission: Payments Edit (Slug: payments-edit)', 'Permission', 'Added new permission: Payments Edit (Slug: payments-edit)', '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/151.0.0.0 Safari/537.36 Edg/151.0.0.0', 'Chrome', '2026-08-03 06:31:56', 0),
(933, NULL, 1006, 'Super Admin', 'Super Admin', 'Permission', 'Added new permission: Payments Delete (Slug: payments-delete)', 'Permission', 'Added new permission: Payments Delete (Slug: payments-delete)', '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/151.0.0.0 Safari/537.36 Edg/151.0.0.0', 'Chrome', '2026-08-03 06:32:16', 0),
(934, NULL, 1006, 'Super Admin', 'Super Admin', 'Permission', 'Deleted permission ID 88', 'Permission', 'Deleted permission ID 88', '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/151.0.0.0 Safari/537.36 Edg/151.0.0.0', 'Chrome', '2026-08-03 06:34:16', 0),
(935, NULL, 1006, 'Super Admin', 'Super Admin', 'Permission', 'Deleted permission ID 92', 'Permission', 'Deleted permission ID 92', '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/151.0.0.0 Safari/537.36 Edg/151.0.0.0', 'Chrome', '2026-08-03 06:34:43', 0),
(936, NULL, 1006, 'Super Admin', 'Super Admin', 'Permission', 'Deleted permission ID 94', 'Permission', 'Deleted permission ID 94', '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/151.0.0.0 Safari/537.36 Edg/151.0.0.0', 'Chrome', '2026-08-03 06:34:51', 0),
(937, NULL, 1006, 'Super Admin', 'Super Admin', 'Permission', 'Deleted permission ID 93', 'Permission', 'Deleted permission ID 93', '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/151.0.0.0 Safari/537.36 Edg/151.0.0.0', 'Chrome', '2026-08-03 06:34:57', 0),
(938, NULL, 1006, 'Super Admin', 'Super Admin', 'Permission', 'Deleted permission ID 91', 'Permission', 'Deleted permission ID 91', '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/151.0.0.0 Safari/537.36 Edg/151.0.0.0', 'Chrome', '2026-08-03 06:35:03', 0),
(939, NULL, 1006, 'Super Admin', 'Super Admin', 'Permission', 'Deleted permission ID 90', 'Permission', 'Deleted permission ID 90', '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/151.0.0.0 Safari/537.36 Edg/151.0.0.0', 'Chrome', '2026-08-03 06:35:14', 0),
(940, NULL, 1006, 'Super Admin', 'Super Admin', 'Permission', 'Deleted permission ID 89', 'Permission', 'Deleted permission ID 89', '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/151.0.0.0 Safari/537.36 Edg/151.0.0.0', 'Chrome', '2026-08-03 06:35:28', 0),
(941, NULL, 1006, 'Super Admin', 'Super Admin', 'Permission', 'Deleted permission ID 87', 'Permission', 'Deleted permission ID 87', '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/151.0.0.0 Safari/537.36 Edg/151.0.0.0', 'Chrome', '2026-08-03 06:35:40', 0),
(942, NULL, 1006, 'Super Admin', 'Super Admin', 'Permission', 'Added new permission: OPD Billing View (Slug: opd-billing-view)', 'Permission', 'Added new permission: OPD Billing View (Slug: opd-billing-view)', '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/151.0.0.0 Safari/537.36 Edg/151.0.0.0', 'Chrome', '2026-08-03 06:38:47', 0),
(943, NULL, 1006, 'Super Admin', 'Super Admin', 'Dashboard', 'Super Admin accessed dashboard', 'Dashboard', 'Super Admin accessed dashboard', '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/151.0.0.0 Safari/537.36 Edg/151.0.0.0', 'Chrome', '2026-08-03 06:44:59', 0),
(944, NULL, 1006, 'Super Admin', 'Super Admin', 'Dashboard', 'Super Admin accessed dashboard', 'Dashboard', 'Super Admin accessed dashboard', '127.0.0.1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/150.0.0.0 Safari/537.36', 'Chrome', '2026-08-03 06:46:06', 0),
(945, NULL, 1006, 'Super Admin', 'Super Admin', 'Dashboard', 'Super Admin accessed dashboard', 'Dashboard', 'Super Admin accessed dashboard', '127.0.0.1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/150.0.0.0 Safari/537.36', 'Chrome', '2026-08-03 06:46:43', 0),
(946, NULL, 1006, 'Super Admin', 'Super Admin', 'Dashboard', 'Super Admin accessed dashboard', 'Dashboard', 'Super Admin accessed dashboard', '127.0.0.1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/150.0.0.0 Safari/537.36', 'Chrome', '2026-08-03 06:46:47', 0),
(947, NULL, 1006, 'Super Admin', 'Super Admin', 'Dashboard', 'Super Admin accessed dashboard', 'Dashboard', 'Super Admin accessed dashboard', '127.0.0.1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/150.0.0.0 Safari/537.36', 'Chrome', '2026-08-03 06:47:00', 0),
(948, NULL, 1006, 'Super Admin', 'Super Admin', 'Dashboard', 'Super Admin accessed dashboard', 'Dashboard', 'Super Admin accessed dashboard', '127.0.0.1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/150.0.0.0 Safari/537.36', 'Chrome', '2026-08-03 06:47:20', 0),
(949, NULL, 1006, 'Super Admin', 'Super Admin', 'Dashboard', 'Super Admin accessed dashboard', 'Dashboard', 'Super Admin accessed dashboard', '127.0.0.1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/150.0.0.0 Safari/537.36', 'Chrome', '2026-08-03 06:47:21', 0),
(950, NULL, 1006, 'Super Admin', 'Super Admin', 'User', 'Updated role of User ID 1012 to HR (assigned by )', 'User', 'Updated role of User ID 1012 to HR (assigned by )', '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/151.0.0.0 Safari/537.36 Edg/151.0.0.0', 'Chrome', '2026-08-03 06:48:20', 0),
(951, NULL, 1006, 'Super Admin', 'Super Admin', 'Permission', 'Added new permission: Employee Management View (Slug: employee-management-view)', 'Permission', 'Added new permission: Employee Management View (Slug: employee-management-view)', '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/151.0.0.0 Safari/537.36 Edg/151.0.0.0', 'Chrome', '2026-08-03 06:51:31', 0),
(952, NULL, 1006, 'Super Admin', 'Super Admin', 'Permission', 'Added new permission: Employee Management Create (Slug: employee-management-create)', 'Permission', 'Added new permission: Employee Management Create (Slug: employee-management-create)', '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/151.0.0.0 Safari/537.36 Edg/151.0.0.0', 'Chrome', '2026-08-03 06:52:04', 0),
(953, NULL, 1006, 'Super Admin', 'Super Admin', 'Permission', 'Added new permission: Employee Management Edit (Slug: employee-management-edit)', 'Permission', 'Added new permission: Employee Management Edit (Slug: employee-management-edit)', '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/151.0.0.0 Safari/537.36 Edg/151.0.0.0', 'Chrome', '2026-08-03 06:52:35', 0),
(954, NULL, 1006, 'Super Admin', 'Super Admin', 'Permission', 'Added new permission: Employee Management Delete (Slug: employee-management-delete)', 'Permission', 'Added new permission: Employee Management Delete (Slug: employee-management-delete)', '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/151.0.0.0 Safari/537.36 Edg/151.0.0.0', 'Chrome', '2026-08-03 06:54:51', 0),
(955, NULL, 1006, 'Super Admin', 'Super Admin', 'Permission', 'Added new permission: Attendance View (Slug: attendance-view)', 'Permission', 'Added new permission: Attendance View (Slug: attendance-view)', '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/151.0.0.0 Safari/537.36 Edg/151.0.0.0', 'Chrome', '2026-08-03 06:56:25', 0),
(956, NULL, 1006, 'Super Admin', 'Super Admin', 'Permission', 'Added new permission: Attendance Create (Slug: attendance-create)', 'Permission', 'Added new permission: Attendance Create (Slug: attendance-create)', '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/151.0.0.0 Safari/537.36 Edg/151.0.0.0', 'Chrome', '2026-08-03 06:57:23', 0),
(957, NULL, 1006, 'Super Admin', 'Super Admin', 'Permission', 'Added new permission: Attendance Edit (Slug: attendance-edit)', 'Permission', 'Added new permission: Attendance Edit (Slug: attendance-edit)', '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/151.0.0.0 Safari/537.36 Edg/151.0.0.0', 'Chrome', '2026-08-03 06:57:41', 0),
(958, NULL, 1006, 'Super Admin', 'Super Admin', 'Permission', 'Added new permission: Attendance Delete (Slug: attendance-delete)', 'Permission', 'Added new permission: Attendance Delete (Slug: attendance-delete)', '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/151.0.0.0 Safari/537.36 Edg/151.0.0.0', 'Chrome', '2026-08-03 06:58:03', 0),
(959, NULL, 1006, 'Super Admin', 'Super Admin', 'Permission', 'Added new permission: Leave Management View (Slug: leave-management-view)', 'Permission', 'Added new permission: Leave Management View (Slug: leave-management-view)', '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/151.0.0.0 Safari/537.36 Edg/151.0.0.0', 'Chrome', '2026-08-03 07:00:13', 0),
(960, NULL, 1006, 'Super Admin', 'Super Admin', 'Permission', 'Added new permission: Leave Management Create (Slug: leave-management-create)', 'Permission', 'Added new permission: Leave Management Create (Slug: leave-management-create)', '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/151.0.0.0 Safari/537.36 Edg/151.0.0.0', 'Chrome', '2026-08-03 07:00:52', 0),
(961, NULL, 1006, 'Super Admin', 'Super Admin', 'Permission', 'Added new permission: Leave Management Edit (Slug: leave-management-edit)', 'Permission', 'Added new permission: Leave Management Edit (Slug: leave-management-edit)', '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/151.0.0.0 Safari/537.36 Edg/151.0.0.0', 'Chrome', '2026-08-03 07:01:06', 0),
(962, NULL, 1006, 'Super Admin', 'Super Admin', 'Permission', 'Added new permission: Leave Management Delete (Slug: leave-management-delete)', 'Permission', 'Added new permission: Leave Management Delete (Slug: leave-management-delete)', '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/151.0.0.0 Safari/537.36 Edg/151.0.0.0', 'Chrome', '2026-08-03 07:01:28', 0),
(963, NULL, 1006, 'Super Admin', 'Super Admin', 'Permission', 'Added new permission: Payroll View (Slug: payroll-view)', 'Permission', 'Added new permission: Payroll View (Slug: payroll-view)', '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/151.0.0.0 Safari/537.36 Edg/151.0.0.0', 'Chrome', '2026-08-03 07:01:55', 0),
(964, NULL, 1006, 'Super Admin', 'Super Admin', 'Permission', 'Added new permission: Payroll Process (Slug: payroll-process)', 'Permission', 'Added new permission: Payroll Process (Slug: payroll-process)', '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/151.0.0.0 Safari/537.36 Edg/151.0.0.0', 'Chrome', '2026-08-03 07:02:36', 0),
(965, NULL, 1006, 'Super Admin', 'Super Admin', 'Permission', 'Added new permission: Payroll Edit (Slug: payroll-edit)', 'Permission', 'Added new permission: Payroll Edit (Slug: payroll-edit)', '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/151.0.0.0 Safari/537.36 Edg/151.0.0.0', 'Chrome', '2026-08-03 07:02:52', 0),
(966, NULL, 1006, 'Super Admin', 'Super Admin', 'Permission', 'Added new permission: Payroll Delete (Slug: payroll-delete)', 'Permission', 'Added new permission: Payroll Delete (Slug: payroll-delete)', '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/151.0.0.0 Safari/537.36 Edg/151.0.0.0', 'Chrome', '2026-08-03 07:03:08', 0),
(967, NULL, 1006, 'Super Admin', 'Super Admin', 'Permission', 'Added new permission: Salary Slip View (Slug: salary-slip-view)', 'Permission', 'Added new permission: Salary Slip View (Slug: salary-slip-view)', '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/151.0.0.0 Safari/537.36 Edg/151.0.0.0', 'Chrome', '2026-08-03 07:03:50', 0),
(968, NULL, 1006, 'Super Admin', 'Super Admin', 'Permission', 'Added new permission: Salary Slip Generate (Slug: salary-slip-generate)', 'Permission', 'Added new permission: Salary Slip Generate (Slug: salary-slip-generate)', '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/151.0.0.0 Safari/537.36 Edg/151.0.0.0', 'Chrome', '2026-08-03 07:04:28', 0),
(969, NULL, 1006, 'Super Admin', 'Super Admin', 'Permission', 'Added new permission: HR Reports View (Slug: hr-reports-view)', 'Permission', 'Added new permission: HR Reports View (Slug: hr-reports-view)', '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/151.0.0.0 Safari/537.36 Edg/151.0.0.0', 'Chrome', '2026-08-03 07:05:06', 0),
(970, NULL, 1006, 'Super Admin', 'Super Admin', 'Permission', 'Added new permission: Employee Document Upload (Slug: employee-document-upload)', 'Permission', 'Added new permission: Employee Document Upload (Slug: employee-document-upload)', '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/151.0.0.0 Safari/537.36 Edg/151.0.0.0', 'Chrome', '2026-08-03 07:05:33', 0),
(971, NULL, 1006, 'Super Admin', 'Super Admin', 'Permission', 'Added new permission: Employee Document View (Slug: employee-document-view)', 'Permission', 'Added new permission: Employee Document View (Slug: employee-document-view)', '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/151.0.0.0 Safari/537.36 Edg/151.0.0.0', 'Chrome', '2026-08-03 07:07:10', 0),
(972, NULL, 1006, 'Super Admin', 'Super Admin', 'Permission', 'Added new permission: OPD Billing Create (Slug: opd-billing-create)', 'Permission', 'Added new permission: OPD Billing Create (Slug: opd-billing-create)', '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/151.0.0.0 Safari/537.36 Edg/151.0.0.0', 'Chrome', '2026-08-03 07:08:44', 0),
(973, NULL, 1006, 'Super Admin', 'Super Admin', 'Permission', 'Added new permission: OPD Billing Edit (Slug: opd-billing-edit)', 'Permission', 'Added new permission: OPD Billing Edit (Slug: opd-billing-edit)', '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/151.0.0.0 Safari/537.36 Edg/151.0.0.0', 'Chrome', '2026-08-03 07:08:59', 0),
(974, NULL, 1006, 'Super Admin', 'Super Admin', 'Permission', 'Added new permission: OPD Billing Delete (Slug: opd-billing-delete)', 'Permission', 'Added new permission: OPD Billing Delete (Slug: opd-billing-delete)', '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/151.0.0.0 Safari/537.36 Edg/151.0.0.0', 'Chrome', '2026-08-03 07:09:16', 0),
(975, NULL, 1006, 'Super Admin', 'Super Admin', 'Permission', 'Added new permission: IPD Billing View (Slug: ipd-billing-view)', 'Permission', 'Added new permission: IPD Billing View (Slug: ipd-billing-view)', '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/151.0.0.0 Safari/537.36 Edg/151.0.0.0', 'Chrome', '2026-08-03 07:09:51', 0),
(976, NULL, 1006, 'Super Admin', 'Super Admin', 'Permission', 'Added new permission: IPD Billing Create (Slug: ipd-billing-create)', 'Permission', 'Added new permission: IPD Billing Create (Slug: ipd-billing-create)', '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/151.0.0.0 Safari/537.36 Edg/151.0.0.0', 'Chrome', '2026-08-03 07:10:09', 0),
(977, NULL, 1006, 'Super Admin', 'Super Admin', 'Permission', 'Added new permission: IPD Billing Edit (Slug: ipd-billing-edit)', 'Permission', 'Added new permission: IPD Billing Edit (Slug: ipd-billing-edit)', '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/151.0.0.0 Safari/537.36 Edg/151.0.0.0', 'Chrome', '2026-08-03 07:10:27', 0),
(978, NULL, 1006, 'Super Admin', 'Super Admin', 'Permission', 'Added new permission: IPD Billing Delete (Slug: ipd-billing-delete)', 'Permission', 'Added new permission: IPD Billing Delete (Slug: ipd-billing-delete)', '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/151.0.0.0 Safari/537.36 Edg/151.0.0.0', 'Chrome', '2026-08-03 07:10:44', 0),
(979, NULL, 1006, 'Super Admin', 'Super Admin', 'Permission', 'Added new permission: OPD Billing View (Slug: opd-billing-view)', 'Permission', 'Added new permission: OPD Billing View (Slug: opd-billing-view)', '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/151.0.0.0 Safari/537.36 Edg/151.0.0.0', 'Chrome', '2026-08-03 07:13:39', 0),
(980, NULL, 1006, 'Super Admin', 'Super Admin', 'Permission', 'Added new permission: OPD Billing Create (Slug: opd-billing-create)', 'Permission', 'Added new permission: OPD Billing Create (Slug: opd-billing-create)', '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/151.0.0.0 Safari/537.36 Edg/151.0.0.0', 'Chrome', '2026-08-03 07:14:02', 0),
(981, NULL, 1006, 'Super Admin', 'Super Admin', 'Permission', 'Added new permission: OPD Billing Edit (Slug: opd-billing-edit)', 'Permission', 'Added new permission: OPD Billing Edit (Slug: opd-billing-edit)', '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/151.0.0.0 Safari/537.36 Edg/151.0.0.0', 'Chrome', '2026-08-03 07:14:19', 0),
(982, NULL, 1006, 'Super Admin', 'Super Admin', 'Permission', 'Added new permission: OPD Billing Delete (Slug: opd-billing-delete)', 'Permission', 'Added new permission: OPD Billing Delete (Slug: opd-billing-delete)', '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/151.0.0.0 Safari/537.36 Edg/151.0.0.0', 'Chrome', '2026-08-03 07:14:35', 0),
(983, 5, 1072, 'Hrugwed More', 'Accountant', 'Logout', 'User logged out', 'Logout', 'User logged out', '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/150.0.0.0 Safari/537.36', 'Chrome', '2026-08-03 07:15:24', 0),
(984, 5, 1072, 'Hrugwed More', 'Accountant', 'Logout', 'User logged out', 'Logout', 'User logged out', '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/150.0.0.0 Safari/537.36', 'Chrome', '2026-08-03 07:24:20', 0),
(985, 5, 1072, 'Hrugwed More', 'Accountant', 'Logout', 'User logged out', 'Logout', 'User logged out', '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/150.0.0.0 Safari/537.36', 'Chrome', '2026-08-03 07:27:16', 0),
(986, 6, 1012, 'Shiva Tevar', 'HR', 'Logout', 'User logged out', 'Logout', 'User logged out', '127.0.0.1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/150.0.0.0 Safari/537.36', 'Chrome', '2026-08-03 07:33:19', 0),
(987, 5, 1072, 'Hrugwed More', 'Accountant', 'Logout', 'User logged out', 'Logout', 'User logged out', '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/150.0.0.0 Safari/537.36', 'Chrome', '2026-08-03 07:42:43', 0),
(988, NULL, 1006, 'Super Admin', 'Super Admin', 'Logout', 'User logged out', 'Logout', 'User logged out', '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/151.0.0.0 Safari/537.36 Edg/151.0.0.0', 'Chrome', '2026-08-03 07:46:19', 0),
(989, NULL, 1006, 'Super Admin', 'Super Admin', 'Dashboard', 'Super Admin accessed dashboard', 'Dashboard', 'Super Admin accessed dashboard', '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/151.0.0.0 Safari/537.36 Edg/151.0.0.0', 'Chrome', '2026-08-03 07:46:21', 0),
(990, 5, 1072, 'Hrugwed More', 'Accountant', 'Logout', 'User logged out', 'Logout', 'User logged out', '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/150.0.0.0 Safari/537.36', 'Chrome', '2026-08-03 07:55:06', 0),
(991, 5, 1072, 'Hrugwed More', 'Accountant', 'Logout', 'User logged out', 'Logout', 'User logged out', '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/150.0.0.0 Safari/537.36', 'Chrome', '2026-08-03 09:05:40', 0),
(992, 5, 1072, 'Hrugwed More', 'Accountant', 'Logout', 'User logged out', 'Logout', 'User logged out', '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/150.0.0.0 Safari/537.36', 'Chrome', '2026-08-03 09:16:55', 0),
(993, 5, 1072, 'Hrugwed More', 'Accountant', 'Logout', 'User logged out', 'Logout', 'User logged out', '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/150.0.0.0 Safari/537.36', 'Chrome', '2026-08-03 09:17:01', 0),
(994, NULL, 1006, 'Super Admin', 'Super Admin', 'Audit Logs', 'User viewed audit logs', 'Audit Logs', 'User viewed audit logs', '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/151.0.0.0 Safari/537.36 Edg/151.0.0.0', 'Chrome', '2026-08-03 09:21:22', 0),
(995, NULL, 1006, 'Super Admin', 'Super Admin', 'Permission Update', 'Updated permissions for role ID 10', 'Permission Update', 'Updated permissions for role ID 10', '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/151.0.0.0 Safari/537.36 Edg/151.0.0.0', 'Chrome', '2026-08-03 09:28:54', 0),
(996, NULL, 1006, 'Super Admin', 'Super Admin', 'Permission Update', 'Updated permissions for role ID 2', 'Permission Update', 'Updated permissions for role ID 2', '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/151.0.0.0 Safari/537.36 Edg/151.0.0.0', 'Chrome', '2026-08-03 09:29:25', 0),
(997, NULL, 1006, 'Super Admin', 'Super Admin', 'Permission', 'Updated permissions for role ID: 2, hospital ID: 0', 'Permission', 'Updated permissions for role ID: 2, hospital ID: 0', '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/151.0.0.0 Safari/537.36 Edg/151.0.0.0', 'Chrome', '2026-08-03 09:57:44', 0),
(998, NULL, 1006, 'Super Admin', 'Super Admin', 'Permission', 'Updated permissions for role ID: 2, hospital ID: 0', 'Permission', 'Updated permissions for role ID: 2, hospital ID: 0', '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/151.0.0.0 Safari/537.36 Edg/151.0.0.0', 'Chrome', '2026-08-03 09:58:01', 0);
INSERT INTO `audit_logs` (`log_id`, `hospital_id`, `register_id`, `user_name`, `user_role`, `action_type`, `description`, `module`, `action`, `ip_address`, `user_agent`, `browser`, `created_at`, `delete_flag`) VALUES
(999, 5, 1008, 'Dr. Sanket Pawar', 'Admin', 'Logout', 'User logged out', 'Logout', 'User logged out', '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/150.0.0.0 Safari/537.36', 'Chrome', '2026-08-03 09:58:12', 0),
(1000, NULL, 1006, 'Super Admin', 'Super Admin', 'Permission', 'Updated permissions for role ID: 2, hospital ID: 0', 'Permission', 'Updated permissions for role ID: 2, hospital ID: 0', '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/151.0.0.0 Safari/537.36 Edg/151.0.0.0', 'Chrome', '2026-08-03 10:01:24', 0),
(1001, NULL, 1006, 'Super Admin', 'Super Admin', 'Permission', 'Updated permissions for role ID: 2, hospital ID: 0', 'Permission', 'Updated permissions for role ID: 2, hospital ID: 0', '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/151.0.0.0 Safari/537.36 Edg/151.0.0.0', 'Chrome', '2026-08-03 10:01:32', 0),
(1002, NULL, 1006, 'Super Admin', 'Super Admin', 'Permission', 'Updated permissions for role ID: 19, hospital ID: 0', 'Permission', 'Updated permissions for role ID: 19, hospital ID: 0', '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/151.0.0.0 Safari/537.36 Edg/151.0.0.0', 'Chrome', '2026-08-03 10:03:18', 0),
(1003, 6, 1012, 'Shiva Tevar', 'HR', 'Logout', 'User logged out', 'Logout', 'User logged out', '127.0.0.1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/150.0.0.0 Safari/537.36', 'Chrome', '2026-08-03 10:03:56', 0),
(1004, NULL, 1006, 'Super Admin', 'Super Admin', 'Permission', 'Updated permissions for role ID: 19, hospital ID: 0', 'Permission', 'Updated permissions for role ID: 19, hospital ID: 0', '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/151.0.0.0 Safari/537.36 Edg/151.0.0.0', 'Chrome', '2026-08-03 10:04:09', 0),
(1005, NULL, 1006, 'Super Admin', 'Super Admin', 'Permission', 'Updated permissions for role ID: 19, hospital ID: 0', 'Permission', 'Updated permissions for role ID: 19, hospital ID: 0', '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/151.0.0.0 Safari/537.36 Edg/151.0.0.0', 'Chrome', '2026-08-03 10:04:39', 0),
(1006, NULL, 1006, 'Super Admin', 'Super Admin', 'Permission', 'Updated permissions for role ID: 19, hospital ID: 6', 'Permission', 'Updated permissions for role ID: 19, hospital ID: 6', '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/151.0.0.0 Safari/537.36 Edg/151.0.0.0', 'Chrome', '2026-08-03 10:04:50', 0),
(1007, NULL, 1006, 'Super Admin', 'Super Admin', 'Permission', 'Updated permissions for role ID: 19, hospital ID: 6', 'Permission', 'Updated permissions for role ID: 19, hospital ID: 6', '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/151.0.0.0 Safari/537.36 Edg/151.0.0.0', 'Chrome', '2026-08-03 10:04:59', 0),
(1008, NULL, 1006, 'Super Admin', 'Super Admin', 'Permission', 'Updated permissions for role ID: 19, hospital ID: 6', 'Permission', 'Updated permissions for role ID: 19, hospital ID: 6', '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/151.0.0.0 Safari/537.36 Edg/151.0.0.0', 'Chrome', '2026-08-03 10:05:11', 0),
(1009, NULL, 1006, 'Super Admin', 'Super Admin', 'Permission', 'Updated permissions for role ID: 19, hospital ID: 6', 'Permission', 'Updated permissions for role ID: 19, hospital ID: 6', '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/151.0.0.0 Safari/537.36 Edg/151.0.0.0', 'Chrome', '2026-08-03 10:08:58', 0),
(1010, NULL, 1006, 'Super Admin', 'Super Admin', 'Permission', 'Updated permissions for role ID: 19, hospital ID: 0', 'Permission', 'Updated permissions for role ID: 19, hospital ID: 0', '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/151.0.0.0 Safari/537.36 Edg/151.0.0.0', 'Chrome', '2026-08-03 10:09:17', 0),
(1011, NULL, 1006, 'Super Admin', 'Super Admin', 'Permission', 'Updated permissions for role ID: 19, hospital ID: 0', 'Permission', 'Updated permissions for role ID: 19, hospital ID: 0', '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/151.0.0.0 Safari/537.36 Edg/151.0.0.0', 'Chrome', '2026-08-03 10:10:03', 0),
(1012, NULL, 1006, 'Super Admin', 'Super Admin', 'Permission', 'Updated permissions for role ID: 19, hospital ID: 0', 'Permission', 'Updated permissions for role ID: 19, hospital ID: 0', '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/151.0.0.0 Safari/537.36 Edg/151.0.0.0', 'Chrome', '2026-08-03 10:10:05', 0),
(1013, NULL, 1006, 'Super Admin', 'Super Admin', 'Permission', 'Updated permissions for role ID: 19, hospital ID: 0', 'Permission', 'Updated permissions for role ID: 19, hospital ID: 0', '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/151.0.0.0 Safari/537.36 Edg/151.0.0.0', 'Chrome', '2026-08-03 10:10:21', 0),
(1014, NULL, 1006, 'Super Admin', 'Super Admin', 'Permission', 'Updated permissions for role ID: 19, hospital ID: 0', 'Permission', 'Updated permissions for role ID: 19, hospital ID: 0', '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/151.0.0.0 Safari/537.36 Edg/151.0.0.0', 'Chrome', '2026-08-03 10:10:47', 0),
(1015, NULL, 1006, 'Super Admin', 'Super Admin', 'Permission', 'Deleted permission ID: 246', 'Permission', 'Deleted permission ID: 246', '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/151.0.0.0 Safari/537.36 Edg/151.0.0.0', 'Chrome', '2026-08-03 10:13:43', 0),
(1016, NULL, 1006, 'Super Admin', 'Super Admin', 'Permission', 'Deleted permission ID: 257', 'Permission', 'Deleted permission ID: 257', '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/151.0.0.0 Safari/537.36 Edg/151.0.0.0', 'Chrome', '2026-08-03 10:14:10', 0),
(1017, NULL, 1006, 'Super Admin', 'Super Admin', 'Permission', 'Deleted permission ID: 251', 'Permission', 'Deleted permission ID: 251', '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/151.0.0.0 Safari/537.36 Edg/151.0.0.0', 'Chrome', '2026-08-03 10:14:38', 0),
(1018, NULL, 1006, 'Super Admin', 'Super Admin', 'Permission', 'Updated permissions for role ID: 2, hospital ID: 0', 'Permission', 'Updated permissions for role ID: 2, hospital ID: 0', '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/151.0.0.0 Safari/537.36 Edg/151.0.0.0', 'Chrome', '2026-08-03 10:14:49', 0),
(1019, NULL, 1006, 'Super Admin', 'Super Admin', 'Permission', 'Updated permissions for role ID: 2, hospital ID: 0', 'Permission', 'Updated permissions for role ID: 2, hospital ID: 0', '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/151.0.0.0 Safari/537.36 Edg/151.0.0.0', 'Chrome', '2026-08-03 10:16:48', 0),
(1020, 5, 1008, 'Dr. Sanket Pawar', 'Admin', 'Logout', 'User logged out', 'Logout', 'User logged out', '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/150.0.0.0 Safari/537.36', 'Chrome', '2026-08-03 10:21:18', 0),
(1021, NULL, 1006, 'Super Admin', 'Super Admin', 'Permission', 'Updated permissions for role ID: 10, hospital ID: 0', 'Permission', 'Updated permissions for role ID: 10, hospital ID: 0', '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/151.0.0.0 Safari/537.36 Edg/151.0.0.0', 'Chrome', '2026-08-03 10:22:12', 0),
(1022, NULL, 1006, 'Super Admin', 'Super Admin', 'Permission', 'Updated permissions for role ID: 10, hospital ID: 0', 'Permission', 'Updated permissions for role ID: 10, hospital ID: 0', '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/151.0.0.0 Safari/537.36 Edg/151.0.0.0', 'Chrome', '2026-08-03 10:22:40', 0),
(1023, NULL, 1006, 'Super Admin', 'Super Admin', 'Permission', 'Updated permissions for role ID: 10, hospital ID: 0', 'Permission', 'Updated permissions for role ID: 10, hospital ID: 0', '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/151.0.0.0 Safari/537.36 Edg/151.0.0.0', 'Chrome', '2026-08-03 10:24:58', 0),
(1024, NULL, 1006, 'Super Admin', 'Super Admin', 'Permission', 'Updated permissions for role ID: 10, hospital ID: 0', 'Permission', 'Updated permissions for role ID: 10, hospital ID: 0', '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/151.0.0.0 Safari/537.36 Edg/151.0.0.0', 'Chrome', '2026-08-03 10:25:34', 0),
(1025, NULL, 1006, 'Super Admin', 'Super Admin', 'Permission', 'Updated permissions for role ID: 10, hospital ID: 0', 'Permission', 'Updated permissions for role ID: 10, hospital ID: 0', '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/151.0.0.0 Safari/537.36 Edg/151.0.0.0', 'Chrome', '2026-08-03 10:25:59', 0),
(1026, NULL, 1006, 'Super Admin', 'Super Admin', 'Logout', 'User logged out', 'Logout', 'User logged out', '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/151.0.0.0 Safari/537.36 Edg/151.0.0.0', 'Chrome', '2026-08-03 10:26:35', 0),
(1027, NULL, 1006, 'Super Admin', 'Super Admin', 'Dashboard', 'Super Admin accessed dashboard', 'Dashboard', 'Super Admin accessed dashboard', '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/151.0.0.0 Safari/537.36 Edg/151.0.0.0', 'Chrome', '2026-08-03 10:26:37', 0),
(1028, NULL, 1006, 'Super Admin', 'Super Admin', 'Permission', 'Updated permissions for role ID: 10, hospital ID: 0', 'Permission', 'Updated permissions for role ID: 10, hospital ID: 0', '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/151.0.0.0 Safari/537.36 Edg/151.0.0.0', 'Chrome', '2026-08-03 10:27:05', 0),
(1029, NULL, 1006, 'Super Admin', 'Super Admin', 'Permission', 'Updated permissions for role ID: 10, hospital ID: 0', 'Permission', 'Updated permissions for role ID: 10, hospital ID: 0', '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/151.0.0.0 Safari/537.36 Edg/151.0.0.0', 'Chrome', '2026-08-03 10:27:17', 0),
(1030, NULL, 1006, 'Super Admin', 'Super Admin', 'Permission', 'Updated permissions for role ID: 10, hospital ID: 0', 'Permission', 'Updated permissions for role ID: 10, hospital ID: 0', '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/151.0.0.0 Safari/537.36 Edg/151.0.0.0', 'Chrome', '2026-08-03 10:32:24', 0),
(1031, NULL, 1006, 'Super Admin', 'Super Admin', 'Permission', 'Updated permissions for role ID: 10, hospital ID: 0', 'Permission', 'Updated permissions for role ID: 10, hospital ID: 0', '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/151.0.0.0 Safari/537.36 Edg/151.0.0.0', 'Chrome', '2026-08-03 10:32:33', 0),
(1032, NULL, 1006, 'Super Admin', 'Super Admin', 'Permission', 'Updated permissions for role ID: 10, hospital ID: 0', 'Permission', 'Updated permissions for role ID: 10, hospital ID: 0', '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/151.0.0.0 Safari/537.36 Edg/151.0.0.0', 'Chrome', '2026-08-03 10:37:39', 0),
(1033, NULL, 1006, 'Super Admin', 'Super Admin', 'Permission', 'Updated permissions for role ID: 19, hospital ID: 0', 'Permission', 'Updated permissions for role ID: 19, hospital ID: 0', '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/151.0.0.0 Safari/537.36 Edg/151.0.0.0', 'Chrome', '2026-08-03 10:42:25', 0),
(1034, NULL, 1006, 'Super Admin', 'Super Admin', 'Permission', 'Updated permissions for role ID: 10, hospital ID: 0', 'Permission', 'Updated permissions for role ID: 10, hospital ID: 0', '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/151.0.0.0 Safari/537.36 Edg/151.0.0.0', 'Chrome', '2026-08-03 10:43:56', 0),
(1035, NULL, 1006, 'Super Admin', 'Super Admin', 'Permission', 'Updated permissions for role ID: 2, hospital ID: 0', 'Permission', 'Updated permissions for role ID: 2, hospital ID: 0', '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/151.0.0.0 Safari/537.36 Edg/151.0.0.0', 'Chrome', '2026-08-03 10:53:32', 0),
(1036, NULL, 1006, 'Super Admin', 'Super Admin', 'Permission', 'Updated permissions for role ID: 2, hospital ID: 0', 'Permission', 'Updated permissions for role ID: 2, hospital ID: 0', '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/151.0.0.0 Safari/537.36 Edg/151.0.0.0', 'Chrome', '2026-08-03 10:54:24', 0),
(1037, NULL, 1006, 'Super Admin', 'Super Admin', 'Permission', 'Updated permissions for role ID: 10, ALL HOSPITALS', 'Permission', 'Updated permissions for role ID: 10, ALL HOSPITALS', '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/151.0.0.0 Safari/537.36 Edg/151.0.0.0', 'Chrome', '2026-08-03 10:58:45', 0),
(1038, NULL, 1006, 'Super Admin', 'Super Admin', 'Permission', 'Updated permissions for role ID: 10, ALL HOSPITALS', 'Permission', 'Updated permissions for role ID: 10, ALL HOSPITALS', '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/151.0.0.0 Safari/537.36 Edg/151.0.0.0', 'Chrome', '2026-08-03 10:59:24', 0),
(1039, NULL, 1006, 'Super Admin', 'Super Admin', 'Permission', 'Updated permissions for role ID: 2, ALL HOSPITALS', 'Permission', 'Updated permissions for role ID: 2, ALL HOSPITALS', '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/151.0.0.0 Safari/537.36 Edg/151.0.0.0', 'Chrome', '2026-08-03 11:00:27', 0),
(1040, NULL, 1006, 'Super Admin', 'Super Admin', 'Logout', 'User logged out', 'Logout', 'User logged out', '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/151.0.0.0 Safari/537.36 Edg/151.0.0.0', 'Chrome', '2026-08-03 11:11:52', 0),
(1041, NULL, 1006, 'Super Admin', 'Super Admin', 'Dashboard', 'Super Admin accessed dashboard', 'Dashboard', 'Super Admin accessed dashboard', '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/151.0.0.0 Safari/537.36 Edg/151.0.0.0', 'Chrome', '2026-08-03 11:11:58', 0),
(1042, NULL, 1006, 'Super Admin', 'Super Admin', 'Permission', 'Seeded default permissions: 25 added, 70 skipped', 'Permission', 'Seeded default permissions: 25 added, 70 skipped', '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/151.0.0.0 Safari/537.36 Edg/151.0.0.0', 'Chrome', '2026-08-03 11:12:22', 0),
(1043, NULL, 1006, 'Super Admin', 'Super Admin', 'Permission', 'Seeded default permissions: 0 added, 95 skipped', 'Permission', 'Seeded default permissions: 0 added, 95 skipped', '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/151.0.0.0 Safari/537.36 Edg/151.0.0.0', 'Chrome', '2026-08-03 11:12:52', 0),
(1044, NULL, 1006, 'Super Admin', 'Super Admin', 'Permission', 'Updated permissions for role ID: 2, ALL HOSPITALS', 'Permission', 'Updated permissions for role ID: 2, ALL HOSPITALS', '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/151.0.0.0 Safari/537.36 Edg/151.0.0.0', 'Chrome', '2026-08-03 11:13:23', 0),
(1045, NULL, 1006, 'Super Admin', 'Super Admin', 'Permission', 'Seeded default permissions: 0 added, 95 skipped', 'Permission', 'Seeded default permissions: 0 added, 95 skipped', '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/151.0.0.0 Safari/537.36 Edg/151.0.0.0', 'Chrome', '2026-08-03 11:13:39', 0),
(1046, 5, 1008, 'Hrugwed More', 'Accountant', 'Logout', 'User logged out', 'Logout', 'User logged out', '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/150.0.0.0 Safari/537.36', 'Chrome', '2026-08-03 11:14:14', 0),
(1047, NULL, 1006, 'Super Admin', 'Super Admin', 'Dashboard', 'Super Admin accessed dashboard', 'Dashboard', 'Super Admin accessed dashboard', '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/151.0.0.0 Safari/537.36 Edg/151.0.0.0', 'Chrome', '2026-08-03 11:20:10', 0),
(1048, NULL, 1006, 'Super Admin', 'Super Admin', 'Audit Logs', 'User viewed audit logs', 'Audit Logs', 'User viewed audit logs', '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/151.0.0.0 Safari/537.36 Edg/151.0.0.0', 'Chrome', '2026-08-03 11:23:50', 0),
(1049, 5, 1072, 'Hrugwed More', 'Accountant', 'Logout', 'User logged out', 'Logout', 'User logged out', '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/150.0.0.0 Safari/537.36', 'Chrome', '2026-08-03 11:36:22', 0),
(1050, 5, 1008, 'Dr. Sanket Pawar', 'Admin', 'Logout', 'User logged out', 'Logout', 'User logged out', '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/150.0.0.0 Safari/537.36', 'Chrome', '2026-08-03 11:37:08', 0),
(1051, NULL, 1006, 'Super Admin', 'Super Admin', 'Permission', 'Added new permission: Employee View (Slug: hr-employee-view)', 'Permission', 'Added new permission: Employee View (Slug: hr-employee-view)', '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/151.0.0.0 Safari/537.36 Edg/151.0.0.0', 'Chrome', '2026-08-03 11:49:17', 0),
(1052, NULL, 1006, 'Super Admin', 'Super Admin', 'Permission', 'Updated permissions for role ID: 19, ALL HOSPITALS', 'Permission', 'Updated permissions for role ID: 19, ALL HOSPITALS', '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/151.0.0.0 Safari/537.36 Edg/151.0.0.0', 'Chrome', '2026-08-03 11:49:28', 0),
(1053, NULL, 1006, 'Super Admin', 'Super Admin', 'Permission', 'Added new permission: Department View (Slug: hr-department-view)', 'Permission', 'Added new permission: Department View (Slug: hr-department-view)', '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/151.0.0.0 Safari/537.36 Edg/151.0.0.0', 'Chrome', '2026-08-03 11:50:24', 0),
(1054, NULL, 1006, 'Super Admin', 'Super Admin', 'Permission', 'Updated permissions for role ID: 19, ALL HOSPITALS', 'Permission', 'Updated permissions for role ID: 19, ALL HOSPITALS', '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/151.0.0.0 Safari/537.36 Edg/151.0.0.0', 'Chrome', '2026-08-03 11:50:31', 0),
(1055, NULL, 1006, 'Super Admin', 'Super Admin', 'Permission', 'Added new permission: Designation View (Slug: hr-designation-view)', 'Permission', 'Added new permission: Designation View (Slug: hr-designation-view)', '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/151.0.0.0 Safari/537.36 Edg/151.0.0.0', 'Chrome', '2026-08-03 11:51:09', 0),
(1056, NULL, 1006, 'Super Admin', 'Super Admin', 'Logout', 'User logged out', 'Logout', 'User logged out', '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/151.0.0.0 Safari/537.36 Edg/151.0.0.0', 'Chrome', '2026-08-03 11:52:31', 0),
(1057, 5, 1073, 'Abhi Jagtap', 'Nurse', 'Logout', 'User logged out', 'Logout', 'User logged out', '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/151.0.0.0 Safari/537.36 Edg/151.0.0.0', 'Chrome', '2026-08-03 11:55:02', 0),
(1058, 5, 1073, 'Abhi Jagtap', 'Nurse', 'Logout', 'User logged out', 'Logout', 'User logged out', '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/151.0.0.0 Safari/537.36 Edg/151.0.0.0', 'Chrome', '2026-08-03 11:55:46', 0),
(1059, NULL, 1006, 'Super Admin', 'Super Admin', 'Dashboard', 'Super Admin accessed dashboard', 'Dashboard', 'Super Admin accessed dashboard', '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/150.0.0.0 Safari/537.36', 'Chrome', '2026-08-05 04:21:09', 0),
(1060, NULL, 1006, 'Super Admin', 'Super Admin', 'Dashboard', 'Super Admin accessed dashboard', 'Dashboard', 'Super Admin accessed dashboard', '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/150.0.0.0 Safari/537.36', 'Chrome', '2026-08-05 04:21:19', 0),
(1061, NULL, 1006, 'Super Admin', 'Super Admin', 'Dashboard', 'Super Admin accessed dashboard', 'Dashboard', 'Super Admin accessed dashboard', '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/150.0.0.0 Safari/537.36', 'Chrome', '2026-08-05 04:23:17', 0),
...
--
-- Table structure for table `doctor_instructions`
--
...
--
-- Dumping data for table `doctor_instructions`
--

INSERT INTO `doctor_instructions` (`instruction_id`, `prescription_id`, `patient_id`, `doctor_id`, `hospital_id`, `instruction`, `priority`, `status`, `created_at`, `modified_at`, `delete_flag`) VALUES
(1, 9, 6, 8, 5, 'Monitor BP every 4 hours', 'High', 'Pending', '2026-08-01 15:46:34', NULL, 0),
(2, 9, 6, 8, 5, 'Administer IV Fluids as prescribed', 'Normal', 'Pending', '2026-08-01 15:46:34', NULL, 0),
(3, 9, 6, 8, 5, 'Check blood sugar before breakfast', 'Normal', 'Pending', '2026-08-01 15:46:34', NULL, 0),
(4, 10, 6, 8, 5, 'Dressing once daily', 'High', 'Pending', '2026-08-01 15:46:34', NULL, 0);
...
CREATE TABLE `insurance_claims` (
  ...
  `status` enum('Pending','Approved','Partial','Rejected') DEFAULT 'Pending',
...
(1, 'IPD-20260722-7033', 7, 'Follow-up', 6, 9, 'Cardiology', 1, '1', 'BED-1', '2026-07-22', '05:00:00', '15', 'Fever', '', '', '', '', '', '', '', '', '', '', '', '', 'Admitted', '2026-07-22 12:18:23', '2026-08-01 15:27:41', 0, 5);
...
(23, 16, 'LAB0023', 'HbA1c', 500.00, 'Below 5.7%', '%', 'Blood', 'Average Blood Sugar', 'Active', 5, 1008, NULL, '2026-07-28 08:42:41', '2026-08-01 14:33:01', 0);
...
(94, 1006, NULL, '2026-07-31 11:34:00', '2026-07-31 16:52:25', '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/150.0.0.0 Safari/537.36', 'Desktop'),
...
(103, 1040, 5, '2026-07-31 15:27:56', '2026-07-31 15:44:06', '127.0.0.1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/150.0.0.0 Safari/537.36 Edg/150.0.0.0', 'Desktop'),
(104, 1028, 5, '2026-07-31 15:32:03', NULL, '127.0.0.1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/150.0.0.0 Safari/537.36', 'Desktop'),
(105, 1071, 5, '2026-07-31 15:44:50', NULL, '127.0.0.1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/150.0.0.0 Safari/537.36', 'Desktop'),
(106, 1071, 5, '2026-07-31 15:45:28', NULL, '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/150.0.0.0 Safari/537.36 Edg/150.0.0.0', 'Desktop'),
(107, 1058, 5, '2026-07-31 15:46:13', NULL, '127.0.0.1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/150.0.0.0 Safari/537.36', 'Desktop'),
(108, 1058, 5, '2026-07-31 15:46:32', NULL, '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/150.0.0.0 Safari/537.36 Edg/150.0.0.0', 'Desktop'),
(109, 1058, 5, '2026-07-31 15:47:18', NULL, '127.0.0.1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/150.0.0.0 Safari/537.36 Edg/150.0.0.0', 'Desktop'),
(110, 1028, 5, '2026-07-31 15:47:57', NULL, '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/150.0.0.0 Safari/537.36 Edg/150.0.0.0', 'Desktop'),
(111, 1028, 5, '2026-07-31 15:50:57', NULL, '127.0.0.1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/150.0.0.0 Safari/537.36', 'Desktop'),
(112, 1028, 5, '2026-07-31 15:51:31', NULL, '127.0.0.1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/150.0.0.0 Safari/537.36', 'Desktop'),
(113, 1028, 5, '2026-07-31 15:51:43', NULL, '127.0.0.1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/150.0.0.0 Safari/537.36', 'Desktop'),
(114, 1028, 5, '2026-07-31 15:52:32', NULL, '127.0.0.1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/150.0.0.0 Safari/537.36 Edg/150.0.0.0', 'Desktop'),
(115, 1028, 5, '2026-07-31 15:56:58', NULL, '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/150.0.0.0 Safari/537.36 Edg/150.0.0.0', 'Desktop'),
(116, 1028, 5, '2026-07-31 16:01:26', NULL, '127.0.0.1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/150.0.0.0 Safari/537.36 Edg/150.0.0.0', 'Desktop'),
(117, 1028, 5, '2026-07-31 16:07:13', NULL, '127.0.0.1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/150.0.0.0 Safari/537.36', 'Desktop'),
(118, 1028, 5, '2026-07-31 16:16:42', NULL, '127.0.0.1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/150.0.0.0 Safari/537.36', 'Desktop'),
(119, 1028, 5, '2026-07-31 16:17:47', NULL, '127.0.0.1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/150.0.0.0 Safari/537.36', 'Desktop'),
(120, 1028, 5, '2026-07-31 16:22:46', NULL, '127.0.0.1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/150.0.0.0 Safari/537.36', 'Desktop'),
(121, 1028, 5, '2026-07-31 16:23:56', NULL, '127.0.0.1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/150.0.0.0 Safari/537.36', 'Desktop'),
(122, 1008, 5, '2026-07-31 16:24:23', NULL, '127.0.0.1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/150.0.0.0 Safari/537.36', 'Desktop'),
(123, 1028, 5, '2026-07-31 16:25:16', NULL, '127.0.0.1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/150.0.0.0 Safari/537.36 Edg/150.0.0.0', 'Desktop'),
(124, 1028, 5, '2026-07-31 16:29:54', NULL, '127.0.0.1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/150.0.0.0 Safari/537.36 Edg/150.0.0.0', 'Desktop'),
(125, 1028, 5, '2026-07-31 16:41:24', NULL, '127.0.0.1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/150.0.0.0 Safari/537.36 Edg/150.0.0.0', 'Desktop'),
(126, 1006, NULL, '2026-07-31 16:52:27', NULL, '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/150.0.0.0 Safari/537.36', 'Desktop'),
(127, 1058, 5, '2026-08-01 10:15:53', '2026-08-01 10:26:35', '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/150.0.0.0 Safari/537.36', 'Desktop'),
(128, 1028, 5, '2026-08-01 10:19:48', '2026-08-01 10:21:42', '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/150.0.0.0 Safari/537.36 Edg/150.0.0.0', 'Desktop'),
(129, 1028, 5, '2026-08-01 10:21:45', '2026-08-01 10:26:21', '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/150.0.0.0 Safari/537.36 Edg/150.0.0.0', 'Desktop'),
(130, 1028, 5, '2026-08-01 10:26:23', NULL, '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/150.0.0.0 Safari/537.36 Edg/150.0.0.0', 'Desktop'),
(131, 1058, 5, '2026-08-01 10:26:50', '2026-08-01 10:33:40', '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/150.0.0.0 Safari/537.36', 'Desktop'),
(132, 1058, 5, '2026-08-01 10:34:01', '2026-08-01 10:53:29', '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/150.0.0.0 Safari/537.36', 'Desktop'),
(133, 1028, 5, '2026-08-01 10:35:28', '2026-08-01 11:52:20', '127.0.0.1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/150.0.0.0 Safari/537.36', 'Desktop'),
(134, 1040, 5, '2026-08-01 10:38:42', NULL, '127.0.0.1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/150.0.0.0 Safari/537.36 Edg/150.0.0.0', 'Desktop'),
(135, 1028, 5, '2026-08-01 10:53:40', '2026-08-01 10:54:44', '127.0.0.1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/150.0.0.0 Safari/537.36', 'Desktop'),
(136, 1058, 6, '2026-08-01 10:53:50', '2026-08-01 10:54:53', '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/150.0.0.0 Safari/537.36', 'Desktop'),
(137, 1008, 5, '2026-08-01 10:54:55', NULL, '127.0.0.1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/150.0.0.0 Safari/537.36', 'Desktop'),
(138, 1058, 5, '2026-08-01 10:55:19', '2026-08-01 11:00:05', '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/150.0.0.0 Safari/537.36', 'Desktop'),
(139, 1058, 5, '2026-08-01 11:00:12', '2026-08-01 12:35:42', '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/150.0.0.0 Safari/537.36', 'Desktop'),
(140, 1040, 5, '2026-08-01 11:29:41', NULL, '127.0.0.1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/150.0.0.0 Safari/537.36 Edg/150.0.0.0', 'Desktop'),
(141, 1006, NULL, '2026-08-01 11:52:25', '2026-08-01 12:00:13', '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/150.0.0.0 Safari/537.36 Edg/150.0.0.0', 'Desktop'),
(142, 1040, 5, '2026-08-01 11:53:46', NULL, '127.0.0.1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/151.0.0.0 Safari/537.36 Edg/151.0.0.0', 'Desktop'),
(143, 1040, 5, '2026-08-01 11:54:53', NULL, '127.0.0.1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/150.0.0.0 Safari/537.36', 'Desktop'),
(144, 1040, 5, '2026-08-01 12:00:29', NULL, '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/150.0.0.0 Safari/537.36 Edg/150.0.0.0', 'Desktop'),
(145, 1028, 5, '2026-08-01 12:03:59', '2026-08-01 12:16:04', '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/150.0.0.0 Safari/537.36 Edg/150.0.0.0', 'Desktop'),
(146, 1040, 5, '2026-08-01 12:09:44', NULL, '127.0.0.1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/150.0.0.0 Safari/537.36', 'Desktop'),
(147, 1040, 5, '2026-08-01 12:14:48', NULL, '127.0.0.1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/150.0.0.0 Safari/537.36', 'Desktop'),
(148, 1040, 5, '2026-08-01 12:16:16', NULL, '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/150.0.0.0 Safari/537.36 Edg/150.0.0.0', 'Desktop'),
(149, 1028, 5, '2026-08-01 12:19:43', NULL, '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/150.0.0.0 Safari/537.36 Edg/150.0.0.0', 'Desktop'),
(150, 1006, NULL, '2026-08-01 19:35:28', '2026-08-01 19:35:44', '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/150.0.0.0 Safari/537.36', 'Desktop'),
(151, 1006, NULL, '2026-08-01 19:35:50', NULL, '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/150.0.0.0 Safari/537.36', 'Desktop'),
(152, 1058, 5, '2026-08-01 19:37:30', NULL, '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/150.0.0.0 Safari/537.36 Edg/150.0.0.0', 'Desktop'),
(153, 1008, 5, '2026-08-01 19:38:35', '2026-08-01 19:56:15', '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/150.0.0.0 Safari/537.36', 'Desktop'),
(154, 1028, 5, '2026-08-01 19:48:17', '2026-08-01 19:48:54', '127.0.0.1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/150.0.0.0 Safari/537.36', 'Desktop'),
(155, 1023, 5, '2026-08-01 19:49:03', '2026-08-01 19:49:19', '127.0.0.1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/150.0.0.0 Safari/537.36', 'Desktop'),
(156, 1006, NULL, '2026-08-01 19:50:38', '2026-08-01 19:50:58', '127.0.0.1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/150.0.0.0 Safari/537.36', 'Desktop'),
(157, 1068, 5, '2026-08-01 19:51:10', NULL, '127.0.0.1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/150.0.0.0 Safari/537.36', 'Desktop'),
(158, 1008, 5, '2026-08-01 19:56:18', '2026-08-01 20:19:09', '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/150.0.0.0 Safari/537.36', 'Desktop'),
(159, 1068, 5, '2026-08-01 19:57:39', NULL, '127.0.0.1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/150.0.0.0 Safari/537.36', 'Desktop'),
(160, 1068, 5, '2026-08-01 19:59:17', NULL, '127.0.0.1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/150.0.0.0 Safari/537.36', 'Desktop'),
(161, 1006, NULL, '2026-08-01 20:00:51', '2026-08-01 20:03:51', '127.0.0.1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/150.0.0.0 Safari/537.36', 'Desktop'),
(162, 1068, 5, '2026-08-01 20:04:10', NULL, '127.0.0.1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/150.0.0.0 Safari/537.36', 'Desktop'),
(163, 1006, NULL, '2026-08-01 20:10:16', NULL, '127.0.0.1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/150.0.0.0 Safari/537.36', 'Desktop'),
(164, 1006, NULL, '2026-08-01 20:10:16', NULL, '127.0.0.1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/150.0.0.0 Safari/537.36', 'Desktop'),
(165, 1006, NULL, '2026-08-01 20:10:36', NULL, '127.0.0.1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/150.0.0.0 Safari/537.36', 'Desktop'),
(166, 1006, NULL, '2026-08-01 20:10:38', '2026-08-01 20:16:18', '127.0.0.1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/150.0.0.0 Safari/537.36', 'Desktop'),
(167, 1058, 5, '2026-08-01 20:16:24', '2026-08-01 20:19:06', '127.0.0.1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/150.0.0.0 Safari/537.36', 'Desktop'),
(168, 1068, 5, '2026-08-01 20:19:14', '2026-08-01 20:21:40', '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/150.0.0.0 Safari/537.36', 'Desktop'),
(169, 1058, 5, '2026-08-01 20:21:28', '2026-08-01 21:03:10', '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/150.0.0.0 Safari/537.36 Edg/150.0.0.0', 'Desktop'),
(170, 1008, 5, '2026-08-01 20:21:43', '2026-08-01 20:22:33', '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/150.0.0.0 Safari/537.36', 'Desktop'),
(171, 1068, 5, '2026-08-01 20:22:39', '2026-08-01 20:24:02', '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/150.0.0.0 Safari/537.36', 'Desktop'),
(172, 1028, 5, '2026-08-01 20:24:09', '2026-08-01 20:24:22', '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/150.0.0.0 Safari/537.36', 'Desktop'),
(173, 1068, 5, '2026-08-01 20:24:28', '2026-08-01 20:32:08', '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/150.0.0.0 Safari/537.36', 'Desktop'),
(174, 1008, 5, '2026-08-01 20:32:11', '2026-08-01 20:34:58', '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/150.0.0.0 Safari/537.36', 'Desktop'),
(175, 1072, 5, '2026-08-01 20:35:01', NULL, '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/150.0.0.0 Safari/537.36', 'Desktop'),
(176, 1072, 5, '2026-08-01 20:35:40', NULL, '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/150.0.0.0 Safari/537.36', 'Desktop'),
(177, 1072, 5, '2026-08-01 20:37:09', NULL, '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/150.0.0.0 Safari/537.36', 'Desktop'),
(178, 1072, 5, '2026-08-01 20:41:32', NULL, '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/150.0.0.0 Safari/537.36', 'Desktop'),
(179, 1072, 5, '2026-08-01 20:45:15', NULL, '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/150.0.0.0 Safari/537.36', 'Desktop'),
(180, 1072, 5, '2026-08-01 20:45:45', '2026-08-01 20:59:16', '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/150.0.0.0 Safari/537.36', 'Desktop'),
(181, 1072, 5, '2026-08-01 20:59:19', '2026-08-01 20:59:31', '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/150.0.0.0 Safari/537.36', 'Desktop'),
(182, 1068, 5, '2026-08-01 20:59:40', '2026-08-01 22:12:57', '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/150.0.0.0 Safari/537.36', 'Desktop'),
(183, 1072, 5, '2026-08-01 21:03:20', '2026-08-01 22:48:32', '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/150.0.0.0 Safari/537.36 Edg/150.0.0.0', 'Desktop'),
(184, 1040, 5, '2026-08-01 22:13:07', NULL, '127.0.0.1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/151.0.0.0 Safari/537.36 Edg/151.0.0.0', 'Desktop'),
(185, 1040, 5, '2026-08-01 22:18:21', NULL, '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/150.0.0.0 Safari/537.36', 'Desktop'),
(186, 1040, 5, '2026-08-01 22:21:36', NULL, '127.0.0.1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/151.0.0.0 Safari/537.36 Edg/151.0.0.0', 'Desktop'),
(187, 1040, 5, '2026-08-01 22:24:23', '2026-08-01 22:30:24', '127.0.0.1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/151.0.0.0 Safari/537.36 Edg/151.0.0.0', 'Desktop'),
(188, 1068, 5, '2026-08-01 22:30:50', '2026-08-01 22:40:04', '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/150.0.0.0 Safari/537.36', 'Desktop'),
(189, 1008, 5, '2026-08-01 22:33:18', NULL, '127.0.0.1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/151.0.0.0 Safari/537.36 Edg/151.0.0.0', 'Desktop'),
(190, 1008, 5, '2026-08-01 22:34:52', NULL, '127.0.0.1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/150.0.0.0 Safari/537.36', 'Desktop'),
(191, 1006, NULL, '2026-08-01 22:35:09', NULL, '127.0.0.1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/150.0.0.0 Safari/537.36', 'Desktop'),
(192, 1006, NULL, '2026-08-01 22:35:26', NULL, '127.0.0.1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/150.0.0.0 Safari/537.36', 'Desktop'),
(193, 1006, NULL, '2026-08-01 22:35:33', NULL, '127.0.0.1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/150.0.0.0 Safari/537.36', 'Desktop'),
(194, 1008, 5, '2026-08-01 22:40:08', '2026-08-01 23:09:10', '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/150.0.0.0 Safari/537.36', 'Desktop'),
(195, 1068, 5, '2026-08-01 22:48:36', '2026-08-01 22:54:56', '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/150.0.0.0 Safari/537.36 Edg/150.0.0.0', 'Desktop'),
(196, 1028, 5, '2026-08-01 22:58:36', NULL, '127.0.0.1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/151.0.0.0 Safari/537.36 Edg/151.0.0.0', 'Desktop'),
(197, 1072, 5, '2026-08-01 23:06:53', NULL, '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/150.0.0.0 Safari/537.36 Edg/150.0.0.0', 'Desktop'),
(198, 1068, 5, '2026-08-01 23:09:57', '2026-08-01 23:25:09', '127.0.0.1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/150.0.0.0 Safari/537.36', 'Desktop'),
(199, 1040, 5, '2026-08-01 23:17:07', NULL, '127.0.0.1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/151.0.0.0 Safari/537.36 Edg/151.0.0.0', 'Desktop'),
(200, 1008, 5, '2026-08-01 23:25:28', '2026-08-01 23:32:05', '127.0.0.1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/150.0.0.0 Safari/537.36', 'Desktop'),
(201, 1040, 5, '2026-08-01 23:32:26', '2026-08-01 23:33:44', '127.0.0.1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/150.0.0.0 Safari/537.36', 'Desktop'),
(202, 1008, 5, '2026-08-01 23:33:57', '2026-08-01 23:42:24', '127.0.0.1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/150.0.0.0 Safari/537.36', 'Desktop'),
(203, 1028, 5, '2026-08-01 23:42:45', '2026-08-02 00:20:26', '127.0.0.1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/150.0.0.0 Safari/537.36', 'Desktop'),
(204, 1068, 5, '2026-08-02 00:20:54', '2026-08-02 00:25:03', '127.0.0.1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/150.0.0.0 Safari/537.36', 'Desktop'),
(205, 1040, 5, '2026-08-02 00:25:29', NULL, '127.0.0.1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/150.0.0.0 Safari/537.36', 'Desktop'),
(206, 1068, 5, '2026-08-02 15:41:02', '2026-08-02 16:07:07', '127.0.0.1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/150.0.0.0 Safari/537.36', 'Desktop'),
(207, 1008, 5, '2026-08-02 16:07:22', '2026-08-02 16:22:19', '127.0.0.1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/150.0.0.0 Safari/537.36', 'Desktop'),
(208, 1006, NULL, '2026-08-02 16:22:27', NULL, '127.0.0.1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/150.0.0.0 Safari/537.36', 'Desktop'),
(209, 1040, 5, '2026-08-03 11:17:41', '2026-08-03 12:01:16', '127.0.0.1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/150.0.0.0 Safari/537.36', 'Desktop'),
(210, 1072, 5, '2026-08-03 11:20:11', '2026-08-03 12:45:24', '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/150.0.0.0 Safari/537.36', 'Desktop'),
(211, 1006, NULL, '2026-08-03 11:24:58', '2026-08-03 11:27:15', '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/151.0.0.0 Safari/537.36 Edg/151.0.0.0', 'Desktop'),
(212, 1008, 5, '2026-08-03 11:27:27', NULL, '127.0.0.1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/150.0.0.0 Safari/537.36', 'Desktop'),
(213, 1008, 5, '2026-08-03 12:01:27', NULL, '127.0.0.1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/150.0.0.0 Safari/537.36', 'Desktop'),
(214, 1006, NULL, '2026-08-03 12:16:06', '2026-08-03 13:16:19', '127.0.0.1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/150.0.0.0 Safari/537.36', 'Desktop'),
(215, 1012, 6, '2026-08-03 12:21:52', NULL, '127.0.0.1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/150.0.0.0 Safari/537.36', 'Desktop'),
(216, 1012, 6, '2026-08-03 12:25:13', NULL, '127.0.0.1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/150.0.0.0 Safari/537.36', 'Desktop'),
(217, 1012, 6, '2026-08-03 12:25:56', NULL, '127.0.0.1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/150.0.0.0 Safari/537.36', 'Desktop'),
(218, 1012, 6, '2026-08-03 12:31:48', NULL, '127.0.0.1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/150.0.0.0 Safari/537.36', 'Desktop'),
(219, 1012, 6, '2026-08-03 12:33:53', '2026-08-03 13:03:19', '127.0.0.1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/150.0.0.0 Safari/537.36', 'Desktop'),
(220, 1072, 5, '2026-08-03 12:45:29', '2026-08-03 12:54:20', '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/150.0.0.0 Safari/537.36', 'Desktop'),
(221, 1072, 5, '2026-08-03 12:54:23', '2026-08-03 12:57:16', '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/150.0.0.0 Safari/537.36', 'Desktop'),
(222, 1072, 5, '2026-08-03 12:57:19', '2026-08-03 13:12:43', '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/150.0.0.0 Safari/537.36', 'Desktop'),
(223, 1012, 6, '2026-08-03 13:03:28', NULL, '127.0.0.1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/150.0.0.0 Safari/537.36', 'Desktop'),
(224, 1072, 5, '2026-08-03 13:12:47', '2026-08-03 13:25:06', '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/150.0.0.0 Safari/537.36', 'Desktop'),
(225, 1006, NULL, '2026-08-03 13:16:21', '2026-08-03 15:56:35', '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/151.0.0.0 Safari/537.36 Edg/151.0.0.0', 'Desktop'),
(226, 1072, 5, '2026-08-03 13:25:08', '2026-08-03 14:35:40', '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/150.0.0.0 Safari/537.36', 'Desktop'),
(227, 1072, 5, '2026-08-03 14:35:42', '2026-08-03 14:46:55', '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/150.0.0.0 Safari/537.36', 'Desktop'),
(228, 1012, 6, '2026-08-03 14:38:38', '2026-08-03 15:33:56', '127.0.0.1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/150.0.0.0 Safari/537.36', 'Desktop'),
(229, 1072, 5, '2026-08-03 14:46:57', '2026-08-03 14:47:01', '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/150.0.0.0 Safari/537.36', 'Desktop'),
(230, 1008, 5, '2026-08-03 14:47:05', '2026-08-03 15:28:12', '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/150.0.0.0 Safari/537.36', 'Desktop'),
(231, 1008, 5, '2026-08-03 15:28:16', '2026-08-03 15:51:18', '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/150.0.0.0 Safari/537.36', 'Desktop'),
(232, 1012, 6, '2026-08-03 15:34:20', NULL, '127.0.0.1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/150.0.0.0 Safari/537.36', 'Desktop'),
(233, 1072, 5, '2026-08-03 15:51:25', NULL, '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/150.0.0.0 Safari/537.36', 'Desktop'),
(234, 1072, 5, '2026-08-03 15:51:26', NULL, '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/150.0.0.0 Safari/537.36', 'Desktop'),
(235, 1006, NULL, '2026-08-03 15:56:37', '2026-08-03 16:41:52', '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/151.0.0.0 Safari/537.36 Edg/151.0.0.0', 'Desktop'),
(236, 1012, 6, '2026-08-03 16:12:03', NULL, '127.0.0.1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/150.0.0.0 Safari/537.36', 'Desktop'),
(237, 1072, 5, '2026-08-03 16:22:43', NULL, '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/150.0.0.0 Safari/537.36', 'Desktop'),
(238, 1008, 5, '2026-08-03 16:23:07', '2026-08-03 17:07:08', '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/150.0.0.0 Safari/537.36', 'Desktop'),
(239, 1008, 5, '2026-08-03 16:24:15', '2026-08-03 16:44:14', '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/150.0.0.0 Safari/537.36', 'Desktop'),
(240, 1012, 6, '2026-08-03 16:27:34', NULL, '127.0.0.1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/150.0.0.0 Safari/537.36', 'Desktop'),
(241, 1006, NULL, '2026-08-03 16:41:58', '2026-08-03 17:22:31', '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/151.0.0.0 Safari/537.36 Edg/151.0.0.0', 'Desktop'),
(242, 1072, 5, '2026-08-03 16:44:21', '2026-08-03 17:06:22', '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/150.0.0.0 Safari/537.36', 'Desktop'),
(243, 1072, 5, '2026-08-03 17:06:25', NULL, '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/150.0.0.0 Safari/537.36', 'Desktop'),
(244, 1072, 5, '2026-08-03 17:21:26', NULL, '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/150.0.0.0 Safari/537.36', 'Desktop'),
(245, 1073, 5, '2026-08-03 17:22:56', '2026-08-03 17:25:02', '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/151.0.0.0 Safari/537.36 Edg/151.0.0.0', 'Desktop'),
(246, 1073, 5, '2026-08-03 17:25:16', '2026-08-03 17:25:46', '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/151.0.0.0 Safari/537.36 Edg/151.0.0.0', 'Desktop'),
(247, 1072, 5, '2026-08-03 17:26:41', NULL, '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/151.0.0.0 Safari/537.36 Edg/151.0.0.0', 'Desktop'),
(248, 1006, NULL, '2026-08-03 17:27:06', NULL, '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/151.0.0.0 Safari/537.36 Edg/151.0.0.0', 'Desktop'),
(249, 1006, NULL, '2026-08-03 17:27:15', NULL, '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/151.0.0.0 Safari/537.36 Edg/151.0.0.0', 'Desktop'),
...
(6, 1023, 8, 'Niraj Bhute', 'documents/patients/images/1785593338_abc.jpg', '2026-07-10', 23, 'A+', 'Male', 'Jakatwadi, Satara', '7523452345', 'Cough, Fever', 'Smoke, Running', 'Active', 'nirajbhute3@gmail.com', '911234567890', '2026-07-21 06:00:52', '2026-08-01 14:29:28', 0, 5, 'Call', NULL, NULL, NULL, NULL, NULL, NULL),
...
(36, 6, 5, 'Allergy', 'Smoke, Running', 'Medium', 'Active', 'Admin', '2026-08-01 14:29:28', '2026-08-01 14:29:28', 0),
(37, 6, 5, 'Medical History', 'Cough, Fever', 'Medium', 'Active', 'Admin', '2026-08-01 14:29:28', '2026-08-01 14:29:28', 0);
...
INSERT INTO `patient_vitals` (`vital_id`, `patient_id`, `hospital_id`, `nurse_id`, `bp`, `pulse`, `temperature`, `respiration_rate`, `spo2`, `height`, `weight`, `blood_sugar`, `pain_score`, `remarks`, `recorded_at`, `modified_at`, `delete_flag`) VALUES
(2, 6, 5, 1068, '120/80', 78, 98.6, 16, 99, 170.50, 68.20, NULL, NULL, 'Patient stable', '2026-08-01 15:42:53', NULL, 0);
...
(208, 'Payments', NULL, 'Payments View', 'payments-view', 'fa-hand-holding-usd', 0, 1, 1, '', 0, 0, '2026-08-03 06:30:03', '2026-08-03 06:30:03', 0),
(209, 'Payments', NULL, 'Payments Create', 'payments-create', 'fa-plus-circle', 0, 1, 1, '', 0, 0, '2026-08-03 06:31:00', '2026-08-03 06:31:00', 0),
(210, 'Payments', NULL, 'Payments Edit', 'payments-edit', 'fa-edit', 0, 0, 0, '', 0, 0, '2026-08-03 06:31:56', '2026-08-03 06:31:56', 0),
(211, 'Payments', NULL, 'Payments Delete', 'payments-delete', 'fa-trash-alt', 0, 0, 0, '', 0, 0, '2026-08-03 06:32:16', '2026-08-03 06:32:16', 0),
(214, 'HR', NULL, 'Employee Management View', 'employee-management-view', 'fa-users', 0, 1, 1, '', 0, 0, '2026-08-03 06:51:31', '2026-08-03 06:51:31', 0),
(215, 'HR', NULL, 'Employee Management Create', 'employee-management-create', 'fa-user-plus', 0, 1, 1, '', 0, 0, '2026-08-03 06:52:04', '2026-08-03 06:52:04', 0),
(216, 'HR', NULL, 'Employee Management Edit', 'employee-management-edit', 'fa-user-edit', 0, 0, 0, '', 0, 0, '2026-08-03 06:52:35', '2026-08-03 06:52:35', 0),
(217, 'HR', NULL, 'Employee Management Delete', 'employee-management-delete', 'fa-user-times', 0, 0, 0, '', 0, 0, '2026-08-03 06:54:51', '2026-08-03 06:54:51', 0),
(218, 'HR', NULL, 'Attendance View', 'attendance-view', 'fa-clock', 0, 1, 1, '', 0, 0, '2026-08-03 06:56:25', '2026-08-03 06:56:25', 0),
(219, 'HR', NULL, 'Attendance Create', 'attendance-create', 'fa-circle', 0, 1, 1, '', 0, 0, '2026-08-03 06:57:23', '2026-08-03 06:57:23', 0),
(220, 'HR', NULL, 'Attendance Edit', 'attendance-edit', 'fa-edit', 0, 0, 0, '', 0, 0, '2026-08-03 06:57:41', '2026-08-03 06:57:41', 0),
(221, 'HR', NULL, 'Attendance Delete', 'attendance-delete', 'fa-trash-alt', 0, 0, 0, '', 0, 0, '2026-08-03 06:58:03', '2026-08-03 06:58:03', 0),
(222, 'HR', NULL, 'Leave Management View', 'leave-management-view', 'fa-calendar-check', 0, 1, 1, '', 0, 0, '2026-08-03 07:00:13', '2026-08-03 07:00:13', 0),
(223, 'HR', NULL, 'Leave Management Create', 'leave-management-create', 'fa-plus-circle', 0, 0, 0, '', 0, 0, '2026-08-03 07:00:52', '2026-08-03 07:00:52', 0),
(224, 'HR', NULL, 'Leave Management Edit', 'leave-management-edit', 'fa-edit', 0, 0, 0, '', 0, 0, '2026-08-03 07:01:06', '2026-08-03 07:01:06', 0),
(225, 'HR', NULL, 'Leave Management Delete', 'leave-management-delete', 'fa-trash-alt', 0, 0, 0, '', 0, 0, '2026-08-03 07:01:28', '2026-08-03 07:01:28', 0),
(226, 'HR', NULL, 'Payroll View', 'payroll-view', 'fa-money-bill-wave', 0, 1, 1, '', 0, 0, '2026-08-03 07:01:55', '2026-08-03 07:01:55', 0),
(227, 'HR', NULL, 'Payroll Process', 'payroll-process', 'fa-cogs', 0, 0, 0, '', 0, 0, '2026-08-03 07:02:36', '2026-08-03 07:02:36', 0),
(228, 'HR', NULL, 'Payroll Edit', 'payroll-edit', 'fa-edit', 0, 0, 0, '', 0, 0, '2026-08-03 07:02:52', '2026-08-03 07:02:52', 0),
(229, 'HR', NULL, 'Payroll Delete', 'payroll-delete', 'fa-trash-alt', 0, 0, 0, '', 0, 0, '2026-08-03 07:03:08', '2026-08-03 07:03:08', 0),
(230, 'HR', NULL, 'Salary Slip View', 'salary-slip-view', 'fa-file-invoice', 0, 1, 1, '', 0, 0, '2026-08-03 07:03:50', '2026-08-03 07:03:50', 0),
(231, 'HR', NULL, 'Salary Slip Generate', 'salary-slip-generate', 'fa-file-pdf', 0, 0, 0, '', 0, 0, '2026-08-03 07:04:28', '2026-08-03 07:04:28', 0),
(232, 'HR', NULL, 'HR Reports View', 'hr-reports-view', 'fa-chart-bar', 0, 1, 1, '', 0, 0, '2026-08-03 07:05:06', '2026-08-03 07:05:06', 0),
(233, 'HR', NULL, 'Employee Document Upload', 'employee-document-upload', 'fa-upload', 0, 0, 0, '', 0, 0, '2026-08-03 07:05:33', '2026-08-03 07:05:33', 0),
(234, 'HR', NULL, 'Employee Document View', 'employee-document-view', 'fa-file-alt', 0, 1, 1, '', 0, 0, '2026-08-03 07:07:10', '2026-08-03 07:07:10', 0),
(238, 'IPD Billing', NULL, 'IPD Billing View', 'ipd-billing-view', 'fa-procedures', 0, 1, 1, '', 0, 0, '2026-08-03 07:09:51', '2026-08-03 07:09:51', 0),
(239, 'IPD Billing', NULL, 'IPD Billing Create', 'ipd-billing-create', 'fa-plus-circle', 0, 0, 0, '', 0, 0, '2026-08-03 07:10:09', '2026-08-03 07:10:09', 0),
(240, 'IPD Billing', NULL, 'IPD Billing Edit', 'ipd-billing-edit', 'fa-edit', 0, 0, 0, '', 0, 0, '2026-08-03 07:10:27', '2026-08-03 07:10:27', 0),
(241, 'IPD Billing', NULL, 'IPD Billing Delete', 'ipd-billing-delete', 'fa-trash-alt', 0, 0, 0, '', 0, 0, '2026-08-03 07:10:44', '2026-08-03 07:10:44', 0),
(242, 'OPD Billing', NULL, 'OPD Billing View', 'opd-billing-view', 'fa-file-invoice', 0, 1, 1, '', 0, 0, '2026-08-03 07:13:39', '2026-08-03 07:13:39', 0),
(243, 'OPD Billing', NULL, 'OPD Billing Create', 'opd-billing-create', 'fa-plus-circle', 0, 0, 0, '', 0, 0, '2026-08-03 07:14:02', '2026-08-03 07:14:02', 0),
(244, 'OPD Billing', NULL, 'OPD Billing Edit', 'opd-billing-edit', 'fa-edit', 0, 0, 0, '', 0, 0, '2026-08-03 07:14:19', '2026-08-03 07:14:19', 0),
(245, 'OPD Billing', NULL, 'OPD Billing Delete', 'opd-billing-delete', 'fa-trash-alt', 0, 0, 0, '', 0, 0, '2026-08-03 07:14:35', '2026-08-03 07:14:35', 0),
(246, 'HR', NULL, 'HR Dashboard View', 'hr-dashboard-view', 'fa-tachometer-alt', 0, 1, 1, '', 0, 0, '2026-08-03 10:09:52', '2026-08-03 10:13:43', 1),
(247, 'HR', NULL, 'HR Attendance View', 'hr-attendance-view', 'fa-clock', 0, 1, 1, '', 0, 0, '2026-08-03 10:09:52', '2026-08-03 10:09:52', 0),
(248, 'HR', NULL, 'HR Leave View', 'hr-leave-view', 'fa-calendar-minus', 0, 1, 1, '', 0, 0, '2026-08-03 10:09:52', '2026-08-03 10:09:52', 0),
(249, 'HR', NULL, 'HR Payroll View', 'hr-payroll-view', 'fa-money-bill-wave', 0, 1, 1, '', 0, 0, '2026-08-03 10:09:52', '2026-08-03 10:09:52', 0),
(250, 'HR', NULL, 'HR Recruitment View', 'hr-recruitment-view', 'fa-user-plus', 0, 1, 1, '', 0, 0, '2026-08-03 10:09:52', '2026-08-03 10:09:52', 0),
(251, 'Accountant', NULL, 'Accountant Dashboard View', 'accountant-dashboard-view', 'fa-calculator', 0, 1, 1, '', 0, 0, '2026-08-03 10:09:52', '2026-08-03 10:14:38', 1),
(252, 'Accountant', NULL, 'Accountant Salary View', 'accountant-salary-view', 'fa-money-bill-wave', 0, 1, 1, '', 0, 0, '2026-08-03 10:09:52', '2026-08-03 10:09:52', 0),
(253, 'Accountant', NULL, 'Accountant Expense View', 'accountant-expense-view', 'fa-receipt', 0, 1, 1, '', 0, 0, '2026-08-03 10:09:52', '2026-08-03 10:09:52', 0),
(254, 'Accountant', NULL, 'Accountant Payment View', 'accountant-payment-view', 'fa-credit-card', 0, 1, 1, '', 0, 0, '2026-08-03 10:09:52', '2026-08-03 10:09:52', 0),
(255, 'Accountant', NULL, 'Accountant Invoice View', 'accountant-invoice-view', 'fa-file-invoice-dollar', 0, 1, 1, '', 0, 0, '2026-08-03 10:09:52', '2026-08-03 10:09:52', 0),
(256, 'Accountant', NULL, 'Accountant Ledger View', 'accountant-ledger-view', 'fa-book', 0, 1, 1, '', 0, 0, '2026-08-03 10:09:52', '2026-08-03 10:09:52', 0),
(257, 'Pharmacist', NULL, 'Pharmacist Dashboard View', 'pharmacist-dashboard-view', 'fa-prescription-bottle-alt', 0, 1, 1, '', 0, 0, '2026-08-03 10:09:52', '2026-08-03 10:14:10', 1),
(258, 'Pharmacist', NULL, 'Pharmacist Medicine View', 'pharmacist-medicine-view', 'fa-capsules', 0, 1, 1, '', 0, 0, '2026-08-03 10:09:52', '2026-08-03 10:09:52', 0),
(259, 'Pharmacist', NULL, 'Pharmacist Prescription View', 'pharmacist-prescription-view', 'fa-prescription', 0, 1, 1, '', 0, 0, '2026-08-03 10:09:52', '2026-08-03 10:09:52', 0),
(260, 'Pharmacist', NULL, 'Pharmacist Supplier View', 'pharmacist-supplier-view', 'fa-truck', 0, 1, 1, '', 0, 0, '2026-08-03 10:09:52', '2026-08-03 10:09:52', 0),
(261, 'Pharmacist', NULL, 'Pharmacist Expiry View', 'pharmacist-expiry-view', 'fa-exclamation-triangle', 0, 1, 1, '', 0, 0, '2026-08-03 10:09:52', '2026-08-03 10:09:52', 0),
(262, 'Dashboard', NULL, 'Dashboard Edit', 'dashboard-edit', 'fa-edit', 0, 0, 0, '', 0, 2, '2026-08-03 11:12:22', '2026-08-03 11:12:22', 0),
(263, 'Referral', NULL, 'Referral Create', 'referral-create', 'fa-plus-circle', 0, 0, 0, '', 0, 16, '2026-08-03 11:12:22', '2026-08-03 11:12:22', 0),
(264, 'Call Patient', NULL, 'Call Patient Create', 'call-patient-create', 'fa-plus-circle', 0, 0, 0, '', 0, 18, '2026-08-03 11:12:22', '2026-08-03 11:12:22', 0),
(265, 'Laboratory', NULL, 'Lab Master Create', 'lab-master-create', 'fa-plus-circle', 0, 0, 0, '', 0, 32, '2026-08-03 11:12:22', '2026-08-03 11:12:22', 0),
(266, 'Billing', NULL, 'Billing View', 'billing-view', 'fa-file-invoice-dollar', 0, 1, 1, '', 0, 62, '2026-08-03 11:12:22', '2026-08-03 11:12:22', 0),
(267, 'Billing', NULL, 'Billing Create', 'billing-create', 'fa-plus-circle', 0, 0, 0, '', 0, 63, '2026-08-03 11:12:22', '2026-08-03 11:12:22', 0),
(268, 'Billing', NULL, 'Billing Edit', 'billing-edit', 'fa-edit', 0, 0, 0, '', 0, 64, '2026-08-03 11:12:22', '2026-08-03 11:12:22', 0),
(269, 'Billing', NULL, 'Billing Delete', 'billing-delete', 'fa-trash', 0, 0, 0, '', 0, 65, '2026-08-03 11:12:22', '2026-08-03 11:12:22', 0),
(270, 'Advance Deposit', NULL, 'Advance Deposit View', 'advance-deposit-view', 'fa-wallet', 0, 1, 1, '', 0, 66, '2026-08-03 11:12:22', '2026-08-03 11:12:22', 0),
(271, 'Advance Deposit', NULL, 'Advance Deposit Create', 'advance-deposit-create', 'fa-plus-circle', 0, 0, 0, '', 0, 67, '2026-08-03 11:12:22', '2026-08-03 11:12:22', 0),
(272, 'Role Management', NULL, 'Role View', 'role-view', 'fa-user-tag', 0, 1, 1, '', 0, 68, '2026-08-03 11:12:22', '2026-08-03 11:12:22', 0),
(273, 'Role Management', NULL, 'Role Create', 'role-create', 'fa-plus-circle', 0, 0, 0, '', 0, 69, '2026-08-03 11:12:22', '2026-08-03 11:12:22', 0),
(274, 'Role Management', NULL, 'Role Edit', 'role-edit', 'fa-edit', 0, 0, 0, '', 0, 70, '2026-08-03 11:12:22', '2026-08-03 11:12:22', 0),
(275, 'Role Management', NULL, 'Role Delete', 'role-delete', 'fa-trash', 0, 0, 0, '', 0, 71, '2026-08-03 11:12:22', '2026-08-03 11:12:22', 0),
(276, 'Permission Management', NULL, 'Permission View', 'permission-view', 'fa-lock', 0, 1, 1, '', 0, 72, '2026-08-03 11:12:22', '2026-08-03 11:12:22', 0),
(277, 'Permission Management', NULL, 'Permission Manage', 'permission-manage', 'fa-key', 0, 0, 0, '', 0, 73, '2026-08-03 11:12:22', '2026-08-03 11:12:22', 0),
(278, 'Audit Logs', NULL, 'Audit Log View', 'audit-log-view', 'fa-clipboard-list', 0, 1, 1, '', 0, 74, '2026-08-03 11:12:22', '2026-08-03 11:12:22', 0),
(279, 'Reports', NULL, 'Report View', 'report-view', 'fa-chart-bar', 0, 1, 1, '', 0, 75, '2026-08-03 11:12:22', '2026-08-03 11:12:22', 0),
(280, 'Reports', NULL, 'Report Export', 'report-export', 'fa-download', 0, 0, 0, '', 0, 76, '2026-08-03 11:12:22', '2026-08-03 11:12:22', 0),
(281, 'Settings', NULL, 'Settings View', 'settings-view', 'fa-cog', 0, 1, 1, '', 0, 77, '2026-08-03 11:12:22', '2026-08-03 11:12:22', 0),
(282, 'Settings', NULL, 'Settings Edit', 'settings-edit', 'fa-cogs', 0, 0, 0, '', 0, 78, '2026-08-03 11:12:22', '2026-08-03 11:12:22', 0),
(283, 'Events', NULL, 'Events View', 'events-view', 'fa-calendar', 0, 1, 1, '', 0, 79, '2026-08-03 11:12:22', '2026-08-03 11:12:22', 0),
(284, 'Events', NULL, 'Events Create', 'events-create', 'fa-plus-circle', 0, 0, 0, '', 0, 80, '2026-08-03 11:12:22', '2026-08-03 11:12:22', 0),
(285, 'Profile', NULL, 'Profile View', 'profile-view', 'fa-user-circle', 0, 1, 1, '', 0, 81, '2026-08-03 11:12:22', '2026-08-03 11:12:22', 0),
(286, 'Profile', NULL, 'Profile Edit', 'profile-edit', 'fa-edit', 0, 0, 0, '', 0, 82, '2026-08-03 11:12:22', '2026-08-03 11:12:22', 0),
(296, 'HR', NULL, 'Employee View', 'hr-employee-view', 'fa-user-md', 0, 1, 1, '', 0, 0, '2026-08-03 11:49:17', '2026-08-03 11:49:17', 0),
(297, 'HR', NULL, 'Department View', 'hr-department-view', 'fa-hospital', 0, 1, 1, '', 0, 0, '2026-08-03 11:50:24', '2026-08-03 11:50:24', 0),
(298, 'HR', NULL, 'Designation View', 'hr-designation-view', 'fa-stethoscope', 0, 1, 1, '', 0, 0, '2026-08-03 11:51:09', '2026-08-03 11:51:09', 0);
...
CREATE TABLE `register` (
  ...
  `role` enum('Super Admin','Admin','HR','Doctor','Nurse','Ward Boy','Lab Technician','Patient','Billing Staff','Accountant','Pharmacist','Receptionist') DEFAULT NULL,
  `hospital_id` int(11) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
(1012, 19, 'Shiva Tevar', 'shiv@gmail.com', '12345678', 'Admin', 'Admin', 0, '2026-07-20 11:55:05', 'HR', 6),
...
(1023, 8, 'Niraj Bhute', 'nirajbhute3@gmail.com', '$2y$10$ZuSEWjWWvbaVVldpvcIxT.FnoFLyc69TUWKhryKEViis8i8JJO5bi', 'Admin', 'Admin', 0, '2026-07-21 06:00:52', 'Patient', 5),
(1028, 3, 'Ayush Nipane', 'ayushhnipane@gmail.com', 'Roh@1234', 'Admin', 'admin', 0, '2026-07-21 06:45:02', 'Doctor', 5),
...
(1058, 13, 'abhishek mandhare', 'rohankurn@gmail.com', '$2y$10$2hU0ssCV8jcBCXxqajsOieKv9fYLuByAF2483nTxnPF/3pKrB3IDu', 'Admin', '1058', 0, '2026-08-01 14:42:11', 'Receptionist', 5),
...
(1068, 4, 'Priya Joshi', 'priya@gmail.com', 'Roh@1234', 'Admin', 'Admin', 0, '2026-07-30 17:24:32', 'Nurse', 5),
...
(1072, 10, 'Hrugwed More', 'apurva@gmail.com', '$2y$10$gj7HICfdlD8R3kkxumXoseKXo6iHrvquNc77fbv63nT8IYoHTEqzu', 'Admin', '1072', 0, '2026-08-03 07:50:18', 'Accountant', 5),
(1073, 4, 'Abhi Jagtap', 'jagtap@gmail.com', '$2y$10$3q6T0kpbmIF1QFLI68H6yOGd0YLYC7r62SYNhOGg6RpBfv4l2imli', 'Admin', 'Admin', 0, '2026-08-03 06:03:23', 'Nurse', 5);
...
(19, NULL, 'HR', 'hr', '', 1, 1006, '2026-08-03 06:47:12', '2026-08-03 07:23:57', 0);
...
(14809, 13, 5, 48, '2026-08-01 06:22:40'),
(14810, 13, 5, 49, '2026-08-01 06:22:40'),
(14811, 13, 5, 47, '2026-08-01 06:22:40'),
(14815, 13, 5, 2, '2026-08-01 06:22:40'),
(14816, 13, 5, 1, '2026-08-01 06:22:40'),
(14817, 13, 5, 68, '2026-08-01 06:22:40'),
(14818, 13, 5, 70, '2026-08-01 06:22:40'),
(14819, 13, 5, 69, '2026-08-01 06:22:40'),
(14820, 13, 5, 67, '2026-08-01 06:22:40'),
(14821, 13, 5, 60, '2026-08-01 06:22:40'),
(14822, 13, 5, 62, '2026-08-01 06:22:40'),
(14823, 13, 5, 61, '2026-08-01 06:22:40'),
(14824, 13, 5, 59, '2026-08-01 06:22:40'),
(14829, 13, 5, 64, '2026-08-01 06:22:40'),
(14830, 13, 5, 66, '2026-08-01 06:22:40'),
(14831, 13, 5, 65, '2026-08-01 06:22:40'),
(14832, 13, 5, 63, '2026-08-01 06:22:40'),
(14833, 13, 5, 14, '2026-08-01 06:22:40'),
(14838, 13, 5, 52, '2026-08-01 06:22:40'),
(14839, 13, 5, 54, '2026-08-01 06:22:40'),
(14840, 13, 5, 53, '2026-08-01 06:22:40'),
(14841, 13, 5, 51, '2026-08-01 06:22:40'),
(14842, 13, 5, 202, '2026-08-01 06:22:40'),
(14843, 13, 5, 43, '2026-08-01 06:22:40'),
(14844, 13, 5, 45, '2026-08-01 06:22:40'),
(14845, 13, 5, 44, '2026-08-01 06:22:40'),
(14846, 13, 5, 46, '2026-08-01 06:22:40'),
(14847, 13, 5, 42, '2026-08-01 06:22:40'),
(14848, 13, 5, 201, '2026-08-01 06:22:40'),
(14849, 13, 5, 57, '2026-08-01 06:22:40'),
(14850, 13, 5, 55, '2026-08-01 06:22:40'),
(14851, 13, 5, 99, '2026-08-01 06:22:40'),
(14852, 13, 6, 48, '2026-08-01 06:22:40'),
(14853, 13, 6, 49, '2026-08-01 06:22:40'),
(14854, 13, 6, 47, '2026-08-01 06:22:40'),
(14858, 13, 6, 2, '2026-08-01 06:22:40'),
(14859, 13, 6, 1, '2026-08-01 06:22:40'),
(14860, 13, 6, 68, '2026-08-01 06:22:40'),
(14861, 13, 6, 70, '2026-08-01 06:22:40'),
(14862, 13, 6, 69, '2026-08-01 06:22:40'),
(14863, 13, 6, 67, '2026-08-01 06:22:40'),
(14864, 13, 6, 60, '2026-08-01 06:22:40'),
(14865, 13, 6, 62, '2026-08-01 06:22:40'),
(14866, 13, 6, 61, '2026-08-01 06:22:40'),
(14867, 13, 6, 59, '2026-08-01 06:22:40'),
(14872, 13, 6, 64, '2026-08-01 06:22:40'),
(14873, 13, 6, 66, '2026-08-01 06:22:40'),
(14874, 13, 6, 65, '2026-08-01 06:22:40'),
(14875, 13, 6, 63, '2026-08-01 06:22:40'),
(14876, 13, 6, 14, '2026-08-01 06:22:40'),
(14881, 13, 6, 52, '2026-08-01 06:22:40'),
(14882, 13, 6, 54, '2026-08-01 06:22:40'),
(14883, 13, 6, 53, '2026-08-01 06:22:40'),
(14884, 13, 6, 51, '2026-08-01 06:22:40'),
(14885, 13, 6, 202, '2026-08-01 06:22:40'),
(14886, 13, 6, 43, '2026-08-01 06:22:40'),
(14887, 13, 6, 45, '2026-08-01 06:22:40'),
(14888, 13, 6, 44, '2026-08-01 06:22:40'),
(14889, 13, 6, 46, '2026-08-01 06:22:40'),
(14890, 13, 6, 42, '2026-08-01 06:22:40'),
(14891, 13, 6, 201, '2026-08-01 06:22:40'),
(14892, 13, 6, 57, '2026-08-01 06:22:40'),
(14893, 13, 6, 55, '2026-08-01 06:22:40'),
(14894, 13, 6, 99, '2026-08-01 06:22:40'),
(14895, 13, 7, 48, '2026-08-01 06:22:40'),
(14896, 13, 7, 49, '2026-08-01 06:22:40'),
(14897, 13, 7, 47, '2026-08-01 06:22:40'),
(14901, 13, 7, 2, '2026-08-01 06:22:40'),
(14902, 13, 7, 1, '2026-08-01 06:22:40'),
(14903, 13, 7, 68, '2026-08-01 06:22:40'),
(14904, 13, 7, 70, '2026-08-01 06:22:40'),
(14905, 13, 7, 69, '2026-08-01 06:22:40'),
(14906, 13, 7, 67, '2026-08-01 06:22:40'),
(14907, 13, 7, 60, '2026-08-01 06:22:40'),
(14908, 13, 7, 62, '2026-08-01 06:22:40'),
(14909, 13, 7, 61, '2026-08-01 06:22:40'),
(14910, 13, 7, 59, '2026-08-01 06:22:40'),
(14915, 13, 7, 64, '2026-08-01 06:22:40'),
(14916, 13, 7, 66, '2026-08-01 06:22:40'),
(14917, 13, 7, 65, '2026-08-01 06:22:40'),
(14918, 13, 7, 63, '2026-08-01 06:22:40'),
(14919, 13, 7, 14, '2026-08-01 06:22:40'),
(14924, 13, 7, 52, '2026-08-01 06:22:40'),
(14925, 13, 7, 54, '2026-08-01 06:22:40'),
(14926, 13, 7, 53, '2026-08-01 06:22:40'),
(14927, 13, 7, 51, '2026-08-01 06:22:40'),
(14928, 13, 7, 202, '2026-08-01 06:22:40'),
(14929, 13, 7, 43, '2026-08-01 06:22:40'),
(14930, 13, 7, 45, '2026-08-01 06:22:40'),
(14931, 13, 7, 44, '2026-08-01 06:22:40'),
(14932, 13, 7, 46, '2026-08-01 06:22:40'),
(14933, 13, 7, 42, '2026-08-01 06:22:40'),
(14934, 13, 7, 201, '2026-08-01 06:22:40'),
(14935, 13, 7, 57, '2026-08-01 06:22:40'),
(14936, 13, 7, 55, '2026-08-01 06:22:40'),
(14937, 13, 7, 99, '2026-08-01 06:22:40'),
(14938, 13, 9, 48, '2026-08-01 06:22:40'),
(14939, 13, 9, 49, '2026-08-01 06:22:40'),
(14940, 13, 9, 47, '2026-08-01 06:22:40'),
(14944, 13, 9, 2, '2026-08-01 06:22:40'),
(14945, 13, 9, 1, '2026-08-01 06:22:40'),
(14946, 13, 9, 68, '2026-08-01 06:22:40'),
(14947, 13, 9, 70, '2026-08-01 06:22:40'),
(14948, 13, 9, 69, '2026-08-01 06:22:40'),
(14949, 13, 9, 67, '2026-08-01 06:22:40'),
(14950, 13, 9, 60, '2026-08-01 06:22:40'),
(14951, 13, 9, 62, '2026-08-01 06:22:40'),
(14952, 13, 9, 61, '2026-08-01 06:22:40'),
(14953, 13, 9, 59, '2026-08-01 06:22:40'),
(14958, 13, 9, 64, '2026-08-01 06:22:40'),
(14959, 13, 9, 66, '2026-08-01 06:22:40'),
(14960, 13, 9, 65, '2026-08-01 06:22:40'),
(14961, 13, 9, 63, '2026-08-01 06:22:40'),
(14962, 13, 9, 14, '2026-08-01 06:22:40'),
(14967, 13, 9, 52, '2026-08-01 06:22:40'),
(14968, 13, 9, 54, '2026-08-01 06:22:40'),
(14969, 13, 9, 53, '2026-08-01 06:22:40'),
(14970, 13, 9, 51, '2026-08-01 06:22:40'),
(14971, 13, 9, 202, '2026-08-01 06:22:40'),
(14972, 13, 9, 43, '2026-08-01 06:22:40'),
(14973, 13, 9, 45, '2026-08-01 06:22:40'),
(14974, 13, 9, 44, '2026-08-01 06:22:40'),
(14975, 13, 9, 46, '2026-08-01 06:22:40'),
(14976, 13, 9, 42, '2026-08-01 06:22:40'),
(14977, 13, 9, 201, '2026-08-01 06:22:40'),
(14978, 13, 9, 57, '2026-08-01 06:22:40'),
(14979, 13, 9, 55, '2026-08-01 06:22:40'),
(14980, 13, 9, 99, '2026-08-01 06:22:40'),
(15321, 4, 5, 47, '2026-08-01 17:06:05'),
(15322, 4, 5, 2, '2026-08-01 17:06:05'),
(15323, 4, 5, 1, '2026-08-01 17:06:05'),
(15324, 4, 5, 63, '2026-08-01 17:06:05'),
(15325, 4, 5, 75, '2026-08-01 17:06:05'),
(15326, 4, 5, 34, '2026-08-01 17:06:05'),
(15327, 4, 5, 204, '2026-08-01 17:06:05'),
(15328, 4, 5, 42, '2026-08-01 17:06:05'),
(15329, 4, 5, 55, '2026-08-01 17:06:05'),
(15330, 4, 5, 99, '2026-08-01 17:06:05'),
(15331, 4, 6, 47, '2026-08-01 17:06:05'),
(15332, 4, 6, 2, '2026-08-01 17:06:05'),
(15333, 4, 6, 1, '2026-08-01 17:06:05'),
(15334, 4, 6, 63, '2026-08-01 17:06:05'),
(15335, 4, 6, 75, '2026-08-01 17:06:05'),
(15336, 4, 6, 34, '2026-08-01 17:06:05'),
(15337, 4, 6, 204, '2026-08-01 17:06:05'),
(15338, 4, 6, 42, '2026-08-01 17:06:05'),
(15339, 4, 6, 55, '2026-08-01 17:06:05'),
(15340, 4, 6, 99, '2026-08-01 17:06:05'),
(15341, 4, 7, 47, '2026-08-01 17:06:05'),
(15342, 4, 7, 2, '2026-08-01 17:06:05'),
(15343, 4, 7, 1, '2026-08-01 17:06:05'),
(15344, 4, 7, 63, '2026-08-01 17:06:05'),
(15345, 4, 7, 75, '2026-08-01 17:06:05'),
(15346, 4, 7, 34, '2026-08-01 17:06:05'),
(15347, 4, 7, 204, '2026-08-01 17:06:05'),
(15348, 4, 7, 42, '2026-08-01 17:06:05'),
(15349, 4, 7, 55, '2026-08-01 17:06:05'),
(15350, 4, 7, 99, '2026-08-01 17:06:05'),
(15351, 4, 9, 47, '2026-08-01 17:06:05'),
(15352, 4, 9, 2, '2026-08-01 17:06:05'),
(15353, 4, 9, 1, '2026-08-01 17:06:05'),
(15354, 4, 9, 63, '2026-08-01 17:06:05'),
(15355, 4, 9, 75, '2026-08-01 17:06:05'),
(15356, 4, 9, 34, '2026-08-01 17:06:05'),
(15357, 4, 9, 204, '2026-08-01 17:06:05'),
(15358, 4, 9, 42, '2026-08-01 17:06:05'),
(15359, 4, 9, 55, '2026-08-01 17:06:05'),
(15360, 4, 9, 99, '2026-08-01 17:06:05'),
(31535, 19, 5, 1, '2026-08-03 10:42:25'),
(31536, 19, 5, 2, '2026-08-03 10:42:25'),
(31537, 19, 5, 219, '2026-08-03 10:42:25'),
(31538, 19, 5, 221, '2026-08-03 10:42:25'),
(31539, 19, 5, 220, '2026-08-03 10:42:25'),
(31540, 19, 5, 218, '2026-08-03 10:42:25'),
(31541, 19, 5, 233, '2026-08-03 10:42:25'),
(31542, 19, 5, 234, '2026-08-03 10:42:25'),
(31543, 19, 5, 215, '2026-08-03 10:42:25'),
(31544, 19, 5, 217, '2026-08-03 10:42:25'),
(31545, 19, 5, 216, '2026-08-03 10:42:25'),
(31546, 19, 5, 214, '2026-08-03 10:42:25'),
(31547, 19, 5, 247, '2026-08-03 10:42:25'),
(31548, 19, 5, 248, '2026-08-03 10:42:25'),
(31549, 19, 5, 249, '2026-08-03 10:42:25'),
(31550, 19, 5, 250, '2026-08-03 10:42:25'),
(31551, 19, 5, 232, '2026-08-03 10:42:25'),
(31552, 19, 5, 223, '2026-08-03 10:42:25'),
(31553, 19, 5, 225, '2026-08-03 10:42:25'),
(31554, 19, 5, 224, '2026-08-03 10:42:25'),
(31555, 19, 5, 222, '2026-08-03 10:42:25'),
(31556, 19, 5, 229, '2026-08-03 10:42:25'),
(31557, 19, 5, 228, '2026-08-03 10:42:25'),
(31558, 19, 5, 227, '2026-08-03 10:42:25'),
(31559, 19, 5, 226, '2026-08-03 10:42:25'),
(31560, 19, 5, 231, '2026-08-03 10:42:25'),
(31561, 19, 5, 230, '2026-08-03 10:42:25'),
(31562, 19, 6, 1, '2026-08-03 10:42:25'),
(31563, 19, 6, 2, '2026-08-03 10:42:25'),
(31564, 19, 6, 219, '2026-08-03 10:42:25'),
(31565, 19, 6, 221, '2026-08-03 10:42:25'),
(31566, 19, 6, 220, '2026-08-03 10:42:25'),
(31567, 19, 6, 218, '2026-08-03 10:42:25'),
(31568, 19, 6, 233, '2026-08-03 10:42:25'),
(31569, 19, 6, 234, '2026-08-03 10:42:25'),
(31570, 19, 6, 215, '2026-08-03 10:42:25'),
(31571, 19, 6, 217, '2026-08-03 10:42:25'),
(31572, 19, 6, 216, '2026-08-03 10:42:25'),
(31573, 19, 6, 214, '2026-08-03 10:42:25'),
(31574, 19, 6, 247, '2026-08-03 10:42:25'),
(31575, 19, 6, 248, '2026-08-03 10:42:25'),
(31576, 19, 6, 249, '2026-08-03 10:42:25'),
(31577, 19, 6, 250, '2026-08-03 10:42:25'),
(31578, 19, 6, 232, '2026-08-03 10:42:25'),
(31579, 19, 6, 223, '2026-08-03 10:42:25'),
(31580, 19, 6, 225, '2026-08-03 10:42:25'),
(31581, 19, 6, 224, '2026-08-03 10:42:25'),
(31582, 19, 6, 222, '2026-08-03 10:42:25'),
(31583, 19, 6, 229, '2026-08-03 10:42:25'),
(31584, 19, 6, 228, '2026-08-03 10:42:25'),
(31585, 19, 6, 227, '2026-08-03 10:42:25'),
(31586, 19, 6, 226, '2026-08-03 10:42:25'),
(31587, 19, 6, 231, '2026-08-03 10:42:25'),
(31588, 19, 6, 230, '2026-08-03 10:42:25'),
(31589, 19, 7, 1, '2026-08-03 10:42:25'),
(31590, 19, 7, 2, '2026-08-03 10:42:25'),
(31591, 19, 7, 219, '2026-08-03 10:42:25'),
(31592, 19, 7, 221, '2026-08-03 10:42:25'),
(31593, 19, 7, 220, '2026-08-03 10:42:25'),
(31594, 19, 7, 218, '2026-08-03 10:42:25'),
(31595, 19, 7, 233, '2026-08-03 10:42:25'),
(31596, 19, 7, 234, '2026-08-03 10:42:25'),
(31597, 19, 7, 215, '2026-08-03 10:42:25'),
(31598, 19, 7, 217, '2026-08-03 10:42:25'),
(31599, 19, 7, 216, '2026-08-03 10:42:25'),
(31600, 19, 7, 214, '2026-08-03 10:42:25'),
(31601, 19, 7, 247, '2026-08-03 10:42:25'),
(31602, 19, 7, 248, '2026-08-03 10:42:25'),
(31603, 19, 7, 249, '2026-08-03 10:42:25'),
(31604, 19, 7, 250, '2026-08-03 10:42:25'),
(31605, 19, 7, 232, '2026-08-03 10:42:25'),
(31606, 19, 7, 223, '2026-08-03 10:42:25'),
(31607, 19, 7, 225, '2026-08-03 10:42:25'),
(31608, 19, 7, 224, '2026-08-03 10:42:25'),
(31609, 19, 7, 222, '2026-08-03 10:42:25'),
(31610, 19, 7, 229, '2026-08-03 10:42:25'),
(31611, 19, 7, 228, '2026-08-03 10:42:25'),
(31612, 19, 7, 227, '2026-08-03 10:42:25'),
(31613, 19, 7, 226, '2026-08-03 10:42:25'),
(31614, 19, 7, 231, '2026-08-03 10:42:25'),
(31615, 19, 7, 230, '2026-08-03 10:42:25'),
(31616, 19, 9, 1, '2026-08-03 10:42:25'),
(31617, 19, 9, 2, '2026-08-03 10:42:25'),
(31618, 19, 9, 219, '2026-08-03 10:42:25'),
(31619, 19, 9, 221, '2026-08-03 10:42:25'),
(31620, 19, 9, 220, '2026-08-03 10:42:25'),
(31621, 19, 9, 218, '2026-08-03 10:42:25'),
(31622, 19, 9, 233, '2026-08-03 10:42:25'),
(31623, 19, 9, 234, '2026-08-03 10:42:25'),
(31624, 19, 9, 215, '2026-08-03 10:42:25'),
(31625, 19, 9, 217, '2026-08-03 10:42:25'),
(31626, 19, 9, 216, '2026-08-03 10:42:25'),
(31627, 19, 9, 214, '2026-08-03 10:42:25'),
(31628, 19, 9, 247, '2026-08-03 10:42:25'),
(31629, 19, 9, 248, '2026-08-03 10:42:25'),
(31630, 19, 9, 249, '2026-08-03 10:42:25'),
(31631, 19, 9, 250, '2026-08-03 10:42:25'),
(31632, 19, 9, 232, '2026-08-03 10:42:25'),
(31633, 19, 9, 223, '2026-08-03 10:42:25'),
(31634, 19, 9, 225, '2026-08-03 10:42:25'),
(31635, 19, 9, 224, '2026-08-03 10:42:25'),
(31636, 19, 9, 222, '2026-08-03 10:42:25'),
(31637, 19, 9, 229, '2026-08-03 10:42:25'),
(31638, 19, 9, 228, '2026-08-03 10:42:25'),
(31639, 19, 9, 227, '2026-08-03 10:42:25'),
(31640, 19, 9, 226, '2026-08-03 10:42:25'),
(31641, 19, 9, 231, '2026-08-03 10:42:25'),
(31642, 19, 9, 230, '2026-08-03 10:42:25'),
(32195, 2, 5, 253, '2026-08-03 10:54:23'),
(32196, 2, 5, 255, '2026-08-03 10:54:23'),
(32197, 2, 5, 256, '2026-08-03 10:54:23'),
(32198, 2, 5, 254, '2026-08-03 10:54:23'),
(32199, 2, 5, 252, '2026-08-03 10:54:23'),
(32200, 2, 5, 47, '2026-08-03 10:54:23'),
(32201, 2, 5, 48, '2026-08-03 10:54:23'),
(32202, 2, 5, 49, '2026-08-03 10:54:23'),
(32203, 2, 5, 50, '2026-08-03 10:54:23'),
(32204, 2, 5, 1, '2026-08-03 10:54:23'),
(32205, 2, 5, 2, '2026-08-03 10:54:23'),
(32206, 2, 5, 5, '2026-08-03 10:54:23'),
(32207, 2, 5, 6, '2026-08-03 10:54:23'),
(32208, 2, 5, 7, '2026-08-03 10:54:23'),
(32209, 2, 5, 8, '2026-08-03 10:54:23'),
(32210, 2, 5, 9, '2026-08-03 10:54:23'),
(32211, 2, 5, 219, '2026-08-03 10:54:23'),
(32212, 2, 5, 221, '2026-08-03 10:54:23'),
(32213, 2, 5, 220, '2026-08-03 10:54:23'),
(32214, 2, 5, 218, '2026-08-03 10:54:23'),
(32215, 2, 5, 233, '2026-08-03 10:54:23'),
(32216, 2, 5, 234, '2026-08-03 10:54:23'),
(32217, 2, 5, 215, '2026-08-03 10:54:23'),
(32218, 2, 5, 217, '2026-08-03 10:54:23'),
(32219, 2, 5, 216, '2026-08-03 10:54:23'),
(32220, 2, 5, 214, '2026-08-03 10:54:23'),
(32221, 2, 5, 247, '2026-08-03 10:54:23'),
(32222, 2, 5, 248, '2026-08-03 10:54:23'),
(32223, 2, 5, 249, '2026-08-03 10:54:23'),
(32224, 2, 5, 250, '2026-08-03 10:54:23'),
(32225, 2, 5, 232, '2026-08-03 10:54:23'),
(32226, 2, 5, 223, '2026-08-03 10:54:23'),
(32227, 2, 5, 225, '2026-08-03 10:54:23'),
(32228, 2, 5, 224, '2026-08-03 10:54:23'),
(32229, 2, 5, 222, '2026-08-03 10:54:23'),
(32230, 2, 5, 229, '2026-08-03 10:54:23'),
(32231, 2, 5, 228, '2026-08-03 10:54:23'),
(32232, 2, 5, 227, '2026-08-03 10:54:23'),
(32233, 2, 5, 226, '2026-08-03 10:54:23'),
(32234, 2, 5, 231, '2026-08-03 10:54:23'),
(32235, 2, 5, 230, '2026-08-03 10:54:23'),
(32236, 2, 5, 59, '2026-08-03 10:54:23'),
(32237, 2, 5, 60, '2026-08-03 10:54:23'),
(32238, 2, 5, 61, '2026-08-03 10:54:23'),
(32239, 2, 5, 62, '2026-08-03 10:54:23'),
(32240, 2, 5, 63, '2026-08-03 10:54:23'),
(32241, 2, 5, 64, '2026-08-03 10:54:23'),
(32242, 2, 5, 65, '2026-08-03 10:54:23'),
(32243, 2, 5, 66, '2026-08-03 10:54:23'),
(32244, 2, 5, 67, '2026-08-03 10:54:23'),
(32245, 2, 5, 68, '2026-08-03 10:54:23'),
(32246, 2, 5, 69, '2026-08-03 10:54:23'),
(32247, 2, 5, 70, '2026-08-03 10:54:23'),
(32248, 2, 5, 239, '2026-08-03 10:54:23'),
(32249, 2, 5, 241, '2026-08-03 10:54:23'),
(32250, 2, 5, 240, '2026-08-03 10:54:23'),
(32251, 2, 5, 238, '2026-08-03 10:54:23'),
(32252, 2, 5, 203, '2026-08-03 10:54:23'),
(32253, 2, 5, 34, '2026-08-03 10:54:23'),
(32254, 2, 5, 35, '2026-08-03 10:54:23'),
(32255, 2, 5, 36, '2026-08-03 10:54:23'),
(32256, 2, 5, 37, '2026-08-03 10:54:23'),
(32257, 2, 5, 71, '2026-08-03 10:54:23'),
(32258, 2, 5, 72, '2026-08-03 10:54:23'),
(32259, 2, 5, 73, '2026-08-03 10:54:23'),
(32260, 2, 5, 74, '2026-08-03 10:54:23'),
(32261, 2, 5, 75, '2026-08-03 10:54:23'),
(32262, 2, 5, 76, '2026-08-03 10:54:23'),
(32263, 2, 5, 77, '2026-08-03 10:54:23'),
(32264, 2, 5, 78, '2026-08-03 10:54:23'),
(32265, 2, 5, 10, '2026-08-03 10:54:23'),
(32266, 2, 5, 11, '2026-08-03 10:54:23'),
(32267, 2, 5, 12, '2026-08-03 10:54:23'),
(32268, 2, 5, 13, '2026-08-03 10:54:23'),
(32269, 2, 5, 14, '2026-08-03 10:54:23'),
(32270, 2, 5, 15, '2026-08-03 10:54:23'),
(32271, 2, 5, 16, '2026-08-03 10:54:23'),
(32272, 2, 5, 17, '2026-08-03 10:54:23'),
(32273, 2, 5, 18, '2026-08-03 10:54:23'),
(32274, 2, 5, 19, '2026-08-03 10:54:23'),
(32275, 2, 5, 20, '2026-08-03 10:54:23'),
(32276, 2, 5, 21, '2026-08-03 10:54:23'),
(32277, 2, 5, 22, '2026-08-03 10:54:23'),
(32278, 2, 5, 23, '2026-08-03 10:54:23'),
(32279, 2, 5, 24, '2026-08-03 10:54:23'),
(32280, 2, 5, 25, '2026-08-03 10:54:23'),
(32281, 2, 5, 26, '2026-08-03 10:54:23'),
(32282, 2, 5, 27, '2026-08-03 10:54:23'),
(32283, 2, 5, 28, '2026-08-03 10:54:23'),
(32284, 2, 5, 29, '2026-08-03 10:54:23'),
(32285, 2, 5, 30, '2026-08-03 10:54:23'),
(32286, 2, 5, 31, '2026-08-03 10:54:23'),
(32287, 2, 5, 32, '2026-08-03 10:54:23'),
(32288, 2, 5, 33, '2026-08-03 10:54:23'),
(32289, 2, 5, 38, '2026-08-03 10:54:23'),
(32290, 2, 5, 39, '2026-08-03 10:54:23'),
(32291, 2, 5, 40, '2026-08-03 10:54:23'),
(32292, 2, 5, 41, '2026-08-03 10:54:23'),
(32293, 2, 5, 51, '2026-08-03 10:54:23'),
(32294, 2, 5, 52, '2026-08-03 10:54:23'),
(32295, 2, 5, 53, '2026-08-03 10:54:23'),
(32296, 2, 5, 54, '2026-08-03 10:54:23'),
(32297, 2, 5, 243, '2026-08-03 10:54:23'),
(32298, 2, 5, 245, '2026-08-03 10:54:23'),
(32299, 2, 5, 244, '2026-08-03 10:54:23'),
(32300, 2, 5, 242, '2026-08-03 10:54:23'),
(32301, 2, 5, 205, '2026-08-03 10:54:23'),
(32302, 2, 5, 207, '2026-08-03 10:54:23'),
(32303, 2, 5, 206, '2026-08-03 10:54:23'),
(32304, 2, 5, 204, '2026-08-03 10:54:23'),
(32305, 2, 5, 202, '2026-08-03 10:54:23'),
(32306, 2, 5, 201, '2026-08-03 10:54:23'),
(32307, 2, 5, 42, '2026-08-03 10:54:23'),
(32308, 2, 5, 43, '2026-08-03 10:54:23'),
(32309, 2, 5, 44, '2026-08-03 10:54:23'),
(32310, 2, 5, 45, '2026-08-03 10:54:23'),
(32311, 2, 5, 46, '2026-08-03 10:54:23'),
(32312, 2, 5, 209, '2026-08-03 10:54:23'),
(32313, 2, 5, 211, '2026-08-03 10:54:23'),
(32314, 2, 5, 210, '2026-08-03 10:54:23'),
(32315, 2, 5, 208, '2026-08-03 10:54:23'),
(32316, 2, 5, 261, '2026-08-03 10:54:23'),
(32317, 2, 5, 258, '2026-08-03 10:54:23'),
(32318, 2, 5, 259, '2026-08-03 10:54:23'),
(32319, 2, 5, 260, '2026-08-03 10:54:23'),
(32320, 2, 5, 79, '2026-08-03 10:54:23'),
(32321, 2, 5, 80, '2026-08-03 10:54:23'),
(32322, 2, 5, 81, '2026-08-03 10:54:23'),
(32323, 2, 5, 82, '2026-08-03 10:54:23'),
(32324, 2, 5, 83, '2026-08-03 10:54:23'),
(32325, 2, 5, 84, '2026-08-03 10:54:23'),
(32326, 2, 5, 85, '2026-08-03 10:54:23'),
(32327, 2, 5, 86, '2026-08-03 10:54:23'),
(32328, 2, 5, 55, '2026-08-03 10:54:23'),
(32329, 2, 5, 56, '2026-08-03 10:54:23'),
(32330, 2, 5, 57, '2026-08-03 10:54:23'),
(32331, 2, 5, 58, '2026-08-03 10:54:23'),
(32332, 2, 5, 99, '2026-08-03 10:54:23'),
(32333, 2, 6, 253, '2026-08-03 10:54:23'),
(32334, 2, 6, 255, '2026-08-03 10:54:23'),
(32335, 2, 6, 256, '2026-08-03 10:54:23'),
(32336, 2, 6, 254, '2026-08-03 10:54:23'),
(32337, 2, 6, 252, '2026-08-03 10:54:23'),
(32338, 2, 6, 47, '2026-08-03 10:54:23'),
(32339, 2, 6, 48, '2026-08-03 10:54:23'),
(32340, 2, 6, 49, '2026-08-03 10:54:23'),
(32341, 2, 6, 50, '2026-08-03 10:54:23'),
(32342, 2, 6, 1, '2026-08-03 10:54:23'),
(32343, 2, 6, 2, '2026-08-03 10:54:23'),
(32344, 2, 6, 5, '2026-08-03 10:54:23'),
(32345, 2, 6, 6, '2026-08-03 10:54:23'),
(32346, 2, 6, 7, '2026-08-03 10:54:23'),
(32347, 2, 6, 8, '2026-08-03 10:54:23'),
(32348, 2, 6, 9, '2026-08-03 10:54:23'),
(32349, 2, 6, 219, '2026-08-03 10:54:23'),
(32350, 2, 6, 221, '2026-08-03 10:54:23'),
(32351, 2, 6, 220, '2026-08-03 10:54:23'),
(32352, 2, 6, 218, '2026-08-03 10:54:23'),
(32353, 2, 6, 233, '2026-08-03 10:54:23'),
(32354, 2, 6, 234, '2026-08-03 10:54:23'),
(32355, 2, 6, 215, '2026-08-03 10:54:23'),
(32356, 2, 6, 217, '2026-08-03 10:54:23'),
(32357, 2, 6, 216, '2026-08-03 10:54:23'),
(32358, 2, 6, 214, '2026-08-03 10:54:23'),
(32359, 2, 6, 247, '2026-08-03 10:54:23'),
(32360, 2, 6, 248, '2026-08-03 10:54:23'),
(32361, 2, 6, 249, '2026-08-03 10:54:23'),
(32362, 2, 6, 250, '2026-08-03 10:54:23'),
(32363, 2, 6, 232, '2026-08-03 10:54:23'),
(32364, 2, 6, 223, '2026-08-03 10:54:23'),
(32365, 2, 6, 225, '2026-08-03 10:54:23'),
(32366, 2, 6, 224, '2026-08-03 10:54:23'),
(32367, 2, 6, 222, '2026-08-03 10:54:23'),
(32368, 2, 6, 229, '2026-08-03 10:54:23'),
(32369, 2, 6, 228, '2026-08-03 10:54:23'),
(32370, 2, 6, 227, '2026-08-03 10:54:23'),
(32371, 2, 6, 226, '2026-08-03 10:54:23'),
(32372, 2, 6, 231, '2026-08-03 10:54:23'),
(32373, 2, 6, 230, '2026-08-03 10:54:23'),
(32374, 2, 6, 59, '2026-08-03 10:54:23'),
(32375, 2, 6, 60, '2026-08-03 10:54:23'),
(32376, 2, 6, 61, '2026-08-03 10:54:23'),
(32377, 2, 6, 62, '2026-08-03 10:54:23'),
(32378, 2, 6, 63, '2026-08-03 10:54:23'),
(32379, 2, 6, 64, '2026-08-03 10:54:23'),
(32380, 2, 6, 65, '2026-08-03 10:54:23'),
(32381, 2, 6, 66, '2026-08-03 10:54:23'),
(32382, 2, 6, 67, '2026-08-03 10:54:23'),
(32383, 2, 6, 68, '2026-08-03 10:54:23'),
(32384, 2, 6, 69, '2026-08-03 10:54:23'),
(32385, 2, 6, 70, '2026-08-03 10:54:23'),
(32386, 2, 6, 239, '2026-08-03 10:54:23'),
(32387, 2, 6, 241, '2026-08-03 10:54:23'),
(32388, 2, 6, 240, '2026-08-03 10:54:23'),
(32389, 2, 6, 238, '2026-08-03 10:54:23'),
(32390, 2, 6, 203, '2026-08-03 10:54:23'),
(32391, 2, 6, 34, '2026-08-03 10:54:23'),
(32392, 2, 6, 35, '2026-08-03 10:54:23'),
(32393, 2, 6, 36, '2026-08-03 10:54:23'),
(32394, 2, 6, 37, '2026-08-03 10:54:23'),
(32395, 2, 6, 71, '2026-08-03 10:54:23'),
(32396, 2, 6, 72, '2026-08-03 10:54:23'),
(32397, 2, 6, 73, '2026-08-03 10:54:23'),
(32398, 2, 6, 74, '2026-08-03 10:54:23'),
(32399, 2, 6, 75, '2026-08-03 10:54:23'),
(32400, 2, 6, 76, '2026-08-03 10:54:23'),
(32401, 2, 6, 77, '2026-08-03 10:54:23'),
(32402, 2, 6, 78, '2026-08-03 10:54:23'),
(32403, 2, 6, 10, '2026-08-03 10:54:23'),
(32404, 2, 6, 11, '2026-08-03 10:54:23'),
(32405, 2, 6, 12, '2026-08-03 10:54:23'),
(32406, 2, 6, 13, '2026-08-03 10:54:23'),
(32407, 2, 6, 14, '2026-08-03 10:54:23'),
(32408, 2, 6, 15, '2026-08-03 10:54:23'),
(32409, 2, 6, 16, '2026-08-03 10:54:23'),
(32410, 2, 6, 17, '2026-08-03 10:54:23'),
(32411, 2, 6, 18, '2026-08-03 10:54:23'),
(32412, 2, 6, 19, '2026-08-03 10:54:23'),
(32413, 2, 6, 20, '2026-08-03 10:54:23'),
(32414, 2, 6, 21, '2026-08-03 10:54:23'),
(32415, 2, 6, 22, '2026-08-03 10:54:23'),
(32416, 2, 6, 23, '2026-08-03 10:54:23'),
(32417, 2, 6, 24, '2026-08-03 10:54:23'),
(32418, 2, 6, 25, '2026-08-03 10:54:23'),
(32419, 2, 6, 26, '2026-08-03 10:54:23'),
(32420, 2, 6, 27, '2026-08-03 10:54:23'),
(32421, 2, 6, 28, '2026-08-03 10:54:23'),
(32422, 2, 6, 29, '2026-08-03 10:54:23'),
(32423, 2, 6, 30, '2026-08-03 10:54:23'),
(32424, 2, 6, 31, '2026-08-03 10:54:23'),
(32425, 2, 6, 32, '2026-08-03 10:54:23'),
(32426, 2, 6, 33, '2026-08-03 10:54:23'),
(32427, 2, 6, 38, '2026-08-03 10:54:23'),
(32428, 2, 6, 39, '2026-08-03 10:54:23'),
(32429, 2, 6, 40, '2026-08-03 10:54:23'),
(32430, 2, 6, 41, '2026-08-03 10:54:23'),
(32431, 2, 6, 51, '2026-08-03 10:54:23'),
(32432, 2, 6, 52, '2026-08-03 10:54:23'),
(32433, 2, 6, 53, '2026-08-03 10:54:23'),
(32434, 2, 6, 54, '2026-08-03 10:54:23'),
(32435, 2, 6, 243, '2026-08-03 10:54:23'),
(32436, 2, 6, 245, '2026-08-03 10:54:23'),
(32437, 2, 6, 244, '2026-08-03 10:54:23'),
(32438, 2, 6, 242, '2026-08-03 10:54:23'),
(32439, 2, 6, 205, '2026-08-03 10:54:23'),
(32440, 2, 6, 207, '2026-08-03 10:54:23'),
(32441, 2, 6, 206, '2026-08-03 10:54:23'),
(32442, 2, 6, 204, '2026-08-03 10:54:23'),
(32443, 2, 6, 202, '2026-08-03 10:54:23'),
(32444, 2, 6, 201, '2026-08-03 10:54:23'),
(32445, 2, 6, 42, '2026-08-03 10:54:23'),
(32446, 2, 6, 43, '2026-08-03 10:54:23'),
(32447, 2, 6, 44, '2026-08-03 10:54:23'),
(32448, 2, 6, 45, '2026-08-03 10:54:23'),
(32449, 2, 6, 46, '2026-08-03 10:54:23'),
(32450, 2, 6, 209, '2026-08-03 10:54:23'),
(32451, 2, 6, 211, '2026-08-03 10:54:23'),
(32452, 2, 6, 210, '2026-08-03 10:54:23'),
(32453, 2, 6, 208, '2026-08-03 10:54:23'),
(32454, 2, 6, 261, '2026-08-03 10:54:23'),
(32455, 2, 6, 258, '2026-08-03 10:54:23'),
(32456, 2, 6, 259, '2026-08-03 10:54:23'),
(32457, 2, 6, 260, '2026-08-03 10:54:23'),
(32458, 2, 6, 79, '2026-08-03 10:54:23'),
(32459, 2, 6, 80, '2026-08-03 10:54:23'),
(32460, 2, 6, 81, '2026-08-03 10:54:23'),
(32461, 2, 6, 82, '2026-08-03 10:54:23'),
(32462, 2, 6, 83, '2026-08-03 10:54:23'),
(32463, 2, 6, 84, '2026-08-03 10:54:23'),
(32464, 2, 6, 85, '2026-08-03 10:54:23'),
(32465, 2, 6, 86, '2026-08-03 10:54:23'),
(32466, 2, 6, 55, '2026-08-03 10:54:23'),
(32467, 2, 6, 56, '2026-08-03 10:54:23'),
(32468, 2, 6, 57, '2026-08-03 10:54:23'),
(32469, 2, 6, 58, '2026-08-03 10:54:23'),
(32470, 2, 6, 99, '2026-08-03 10:54:23'),
(32471, 2, 7, 253, '2026-08-03 10:54:23'),
(32472, 2, 7, 255, '2026-08-03 10:54:23'),
(32473, 2, 7, 256, '2026-08-03 10:54:23'),
(32474, 2, 7, 254, '2026-08-03 10:54:23'),
(32475, 2, 7, 252, '2026-08-03 10:54:23'),
(32476, 2, 7, 47, '2026-08-03 10:54:23'),
(32477, 2, 7, 48, '2026-08-03 10:54:23'),
(32478, 2, 7, 49, '2026-08-03 10:54:23'),
(32479, 2, 7, 50, '2026-08-03 10:54:23'),
(32480, 2, 7, 1, '2026-08-03 10:54:23'),
(32481, 2, 7, 2, '2026-08-03 10:54:23'),
(32482, 2, 7, 5, '2026-08-03 10:54:23'),
(32483, 2, 7, 6, '2026-08-03 10:54:23'),
(32484, 2, 7, 7, '2026-08-03 10:54:23'),
(32485, 2, 7, 8, '2026-08-03 10:54:23'),
(32486, 2, 7, 9, '2026-08-03 10:54:23'),
(32487, 2, 7, 219, '2026-08-03 10:54:23'),
(32488, 2, 7, 221, '2026-08-03 10:54:23'),
(32489, 2, 7, 220, '2026-08-03 10:54:23'),
(32490, 2, 7, 218, '2026-08-03 10:54:23'),
(32491, 2, 7, 233, '2026-08-03 10:54:23'),
(32492, 2, 7, 234, '2026-08-03 10:54:23'),
(32493, 2, 7, 215, '2026-08-03 10:54:23'),
(32494, 2, 7, 217, '2026-08-03 10:54:23'),
(32495, 2, 7, 216, '2026-08-03 10:54:23'),
(32496, 2, 7, 214, '2026-08-03 10:54:23'),
(32497, 2, 7, 247, '2026-08-03 10:54:23'),
(32498, 2, 7, 248, '2026-08-03 10:54:23'),
(32499, 2, 7, 249, '2026-08-03 10:54:23'),
(32500, 2, 7, 250, '2026-08-03 10:54:23'),
(32501, 2, 7, 232, '2026-08-03 10:54:23'),
(32502, 2, 7, 223, '2026-08-03 10:54:23'),
(32503, 2, 7, 225, '2026-08-03 10:54:23'),
(32504, 2, 7, 224, '2026-08-03 10:54:23'),
(32505, 2, 7, 222, '2026-08-03 10:54:23'),
(32506, 2, 7, 229, '2026-08-03 10:54:23'),
(32507, 2, 7, 228, '2026-08-03 10:54:23'),
(32508, 2, 7, 227, '2026-08-03 10:54:23'),
(32509, 2, 7, 226, '2026-08-03 10:54:23'),
(32510, 2, 7, 231, '2026-08-03 10:54:23'),
(32511, 2, 7, 230, '2026-08-03 10:54:23'),
(32512, 2, 7, 59, '2026-08-03 10:54:23'),
(32513, 2, 7, 60, '2026-08-03 10:54:23'),
(32514, 2, 7, 61, '2026-08-03 10:54:23'),
(32515, 2, 7, 62, '2026-08-03 10:54:23'),
(32516, 2, 7, 63, '2026-08-03 10:54:23'),
(32517, 2, 7, 64, '2026-08-03 10:54:23'),
(32518, 2, 7, 65, '2026-08-03 10:54:23'),
(32519, 2, 7, 66, '2026-08-03 10:54:23'),
(32520, 2, 7, 67, '2026-08-03 10:54:23'),
(32521, 2, 7, 68, '2026-08-03 10:54:23'),
(32522, 2, 7, 69, '2026-08-03 10:54:23'),
(32523, 2, 7, 70, '2026-08-03 10:54:23'),
(32524, 2, 7, 239, '2026-08-03 10:54:23'),
(32525, 2, 7, 241, '2026-08-03 10:54:23'),
(32526, 2, 7, 240, '2026-08-03 10:54:23'),
(32527, 2, 7, 238, '2026-08-03 10:54:23'),
(32528, 2, 7, 203, '2026-08-03 10:54:23'),
(32529, 2, 7, 34, '2026-08-03 10:54:23'),
(32530, 2, 7, 35, '2026-08-03 10:54:23'),
(32531, 2, 7, 36, '2026-08-03 10:54:23'),
(32532, 2, 7, 37, '2026-08-03 10:54:23'),
(32533, 2, 7, 71, '2026-08-03 10:54:23'),
(32534, 2, 7, 72, '2026-08-03 10:54:23'),
(32535, 2, 7, 73, '2026-08-03 10:54:23'),
(32536, 2, 7, 74, '2026-08-03 10:54:23'),
(32537, 2, 7, 75, '2026-08-03 10:54:23'),
(32538, 2, 7, 76, '2026-08-03 10:54:23'),
(32539, 2, 7, 77, '2026-08-03 10:54:23'),
(32540, 2, 7, 78, '2026-08-03 10:54:23'),
(32541, 2, 7, 10, '2026-08-03 10:54:23'),
(32542, 2, 7, 11, '2026-08-03 10:54:23'),
(32543, 2, 7, 12, '2026-08-03 10:54:23'),
(32544, 2, 7, 13, '2026-08-03 10:54:23'),
(32545, 2, 7, 14, '2026-08-03 10:54:23'),
(32546, 2, 7, 15, '2026-08-03 10:54:23'),
(32547, 2, 7, 16, '2026-08-03 10:54:23'),
(32548, 2, 7, 17, '2026-08-03 10:54:23'),
(32549, 2, 7, 18, '2026-08-03 10:54:23'),
(32550, 2, 7, 19, '2026-08-03 10:54:23'),
(32551, 2, 7, 20, '2026-08-03 10:54:23'),
(32552, 2, 7, 21, '2026-08-03 10:54:23'),
(32553, 2, 7, 22, '2026-08-03 10:54:23'),
(32554, 2, 7, 23, '2026-08-03 10:54:23'),
(32555, 2, 7, 24, '2026-08-03 10:54:23'),
(32556, 2, 7, 25, '2026-08-03 10:54:23'),
(32557, 2, 7, 26, '2026-08-03 10:54:23'),
(32558, 2, 7, 27, '2026-08-03 10:54:23'),
(32559, 2, 7, 28, '2026-08-03 10:54:23'),
(32560, 2, 7, 29, '2026-08-03 10:54:23'),
(32561, 2, 7, 30, '2026-08-03 10:54:23'),
(32562, 2, 7, 31, '2026-08-03 10:54:23'),
(32563, 2, 7, 32, '2026-08-03 10:54:23'),
(32564, 2, 7, 33, '2026-08-03 10:54:23'),
(32565, 2, 7, 38, '2026-08-03 10:54:23'),
(32566, 2, 7, 39, '2026-08-03 10:54:23'),
(32567, 2, 7, 40, '2026-08-03 10:54:23'),
(32568, 2, 7, 41, '2026-08-03 10:54:23'),
(32569, 2, 7, 51, '2026-08-03 10:54:23'),
(32570, 2, 7, 52, '2026-08-03 10:54:23'),
(32571, 2, 7, 53, '2026-08-03 10:54:23'),
(32572, 2, 7, 54, '2026-08-03 10:54:23'),
(32573, 2, 7, 243, '2026-08-03 10:54:23'),
(32574, 2, 7, 245, '2026-08-03 10:54:23'),
(32575, 2, 7, 244, '2026-08-03 10:54:23'),
(32576, 2, 7, 242, '2026-08-03 10:54:23'),
(32577, 2, 7, 205, '2026-08-03 10:54:23'),
(32578, 2, 7, 207, '2026-08-03 10:54:23'),
(32579, 2, 7, 206, '2026-08-03 10:54:23'),
(32580, 2, 7, 204, '2026-08-03 10:54:23'),
(32581, 2, 7, 202, '2026-08-03 10:54:23'),
(32582, 2, 7, 201, '2026-08-03 10:54:23'),
(32583, 2, 7, 42, '2026-08-03 10:54:23'),
(32584, 2, 7, 43, '2026-08-03 10:54:23'),
(32585, 2, 7, 44, '2026-08-03 10:54:23'),
(32586, 2, 7, 45, '2026-08-03 10:54:23'),
(32587, 2, 7, 46, '2026-08-03 10:54:23'),
(32588, 2, 7, 209, '2026-08-03 10:54:23'),
(32589, 2, 7, 211, '2026-08-03 10:54:23'),
(32590, 2, 7, 210, '2026-08-03 10:54:23'),
(32591, 2, 7, 208, '2026-08-03 10:54:23'),
(32592, 2, 7, 261, '2026-08-03 10:54:23'),
(32593, 2, 7, 258, '2026-08-03 10:54:23'),
(32594, 2, 7, 259, '2026-08-03 10:54:23'),
(32595, 2, 7, 260, '2026-08-03 10:54:23'),
(32596, 2, 7, 79, '2026-08-03 10:54:23'),
(32597, 2, 7, 80, '2026-08-03 10:54:23'),
(32598, 2, 7, 81, '2026-08-03 10:54:23'),
(32599, 2, 7, 82, '2026-08-03 10:54:23'),
(32600, 2, 7, 83, '2026-08-03 10:54:23'),
(32601, 2, 7, 84, '2026-08-03 10:54:23'),
(32602, 2, 7, 85, '2026-08-03 10:54:23'),
(32603, 2, 7, 86, '2026-08-03 10:54:23'),
(32604, 2, 7, 55, '2026-08-03 10:54:23'),
(32605, 2, 7, 56, '2026-08-03 10:54:23'),
(32606, 2, 7, 57, '2026-08-03 10:54:23'),
(32607, 2, 7, 58, '2026-08-03 10:54:23'),
(32608, 2, 7, 99, '2026-08-03 10:54:23'),
(32609, 2, 9, 253, '2026-08-03 10:54:23'),
(32610, 2, 9, 255, '2026-08-03 10:54:23'),
(32611, 2, 9, 256, '2026-08-03 10:54:23'),
(32612, 2, 9, 254, '2026-08-03 10:54:23'),
(32613, 2, 9, 252, '2026-08-03 10:54:23'),
(32614, 2, 9, 47, '2026-08-03 10:54:23'),
(32615, 2, 9, 48, '2026-08-03 10:54:23'),
(32616, 2, 9, 49, '2026-08-03 10:54:23'),
(32617, 2, 9, 50, '2026-08-03 10:54:23'),
(32618, 2, 9, 1, '2026-08-03 10:54:23'),
(32619, 2, 9, 2, '2026-08-03 10:54:23'),
(32620, 2, 9, 5, '2026-08-03 10:54:23'),
(32621, 2, 9, 6, '2026-08-03 10:54:23'),
(32622, 2, 9, 7, '2026-08-03 10:54:23'),
(32623, 2, 9, 8, '2026-08-03 10:54:23'),
(32624, 2, 9, 9, '2026-08-03 10:54:23'),
(32625, 2, 9, 219, '2026-08-03 10:54:23'),
(32626, 2, 9, 221, '2026-08-03 10:54:23'),
(32627, 2, 9, 220, '2026-08-03 10:54:23'),
(32628, 2, 9, 218, '2026-08-03 10:54:23'),
(32629, 2, 9, 233, '2026-08-03 10:54:23'),
(32630, 2, 9, 234, '2026-08-03 10:54:23'),
(32631, 2, 9, 215, '2026-08-03 10:54:23'),
(32632, 2, 9, 217, '2026-08-03 10:54:23'),
(32633, 2, 9, 216, '2026-08-03 10:54:23'),
(32634, 2, 9, 214, '2026-08-03 10:54:23'),
(32635, 2, 9, 247, '2026-08-03 10:54:23'),
(32636, 2, 9, 248, '2026-08-03 10:54:23'),
(32637, 2, 9, 249, '2026-08-03 10:54:23'),
(32638, 2, 9, 250, '2026-08-03 10:54:23'),
(32639, 2, 9, 232, '2026-08-03 10:54:23'),
(32640, 2, 9, 223, '2026-08-03 10:54:23'),
(32641, 2, 9, 225, '2026-08-03 10:54:23'),
(32642, 2, 9, 224, '2026-08-03 10:54:23'),
(32643, 2, 9, 222, '2026-08-03 10:54:23'),
(32644, 2, 9, 229, '2026-08-03 10:54:23'),
(32645, 2, 9, 228, '2026-08-03 10:54:23'),
(32646, 2, 9, 227, '2026-08-03 10:54:23'),
(32647, 2, 9, 226, '2026-08-03 10:54:23'),
(32648, 2, 9, 231, '2026-08-03 10:54:23'),
(32649, 2, 9, 230, '2026-08-03 10:54:23'),
(32650, 2, 9, 59, '2026-08-03 10:54:23'),
(32651, 2, 9, 60, '2026-08-03 10:54:23'),
(32652, 2, 9, 61, '2026-08-03 10:54:23'),
(32653, 2, 9, 62, '2026-08-03 10:54:23'),
(32654, 2, 9, 63, '2026-08-03 10:54:23'),
(32655, 2, 9, 64, '2026-08-03 10:54:23'),
(32656, 2, 9, 65, '2026-08-03 10:54:23'),
(32657, 2, 9, 66, '2026-08-03 10:54:23'),
(32658, 2, 9, 67, '2026-08-03 10:54:23'),
(32659, 2, 9, 68, '2026-08-03 10:54:23'),
(32660, 2, 9, 69, '2026-08-03 10:54:23'),
(32661, 2, 9, 70, '2026-08-03 10:54:23'),
(32662, 2, 9, 239, '2026-08-03 10:54:23'),
(32663, 2, 9, 241, '2026-08-03 10:54:23'),
(32664, 2, 9, 240, '2026-08-03 10:54:23'),
(32665, 2, 9, 238, '2026-08-03 10:54:23'),
(32666, 2, 9, 203, '2026-08-03 10:54:23'),
(32667, 2, 9, 34, '2026-08-03 10:54:23'),
(32668, 2, 9, 35, '2026-08-03 10:54:23'),
(32669, 2, 9, 36, '2026-08-03 10:54:23'),
(32670, 2, 9, 37, '2026-08-03 10:54:23'),
(32671, 2, 9, 71, '2026-08-03 10:54:23'),
(32672, 2, 9, 72, '2026-08-03 10:54:23'),
(32673, 2, 9, 73, '2026-08-03 10:54:23'),
(32674, 2, 9, 74, '2026-08-03 10:54:23'),
(32675, 2, 9, 75, '2026-08-03 10:54:23'),
(32676, 2, 9, 76, '2026-08-03 10:54:23'),
(32677, 2, 9, 77, '2026-08-03 10:54:23'),
(32678, 2, 9, 78, '2026-08-03 10:54:23'),
(32679, 2, 9, 10, '2026-08-03 10:54:23'),
(32680, 2, 9, 11, '2026-08-03 10:54:23'),
(32681, 2, 9, 12, '2026-08-03 10:54:23'),
(32682, 2, 9, 13, '2026-08-03 10:54:23'),
(32683, 2, 9, 14, '2026-08-03 10:54:23'),
(32684, 2, 9, 15, '2026-08-03 10:54:23'),
(32685, 2, 9, 16, '2026-08-03 10:54:23'),
(32686, 2, 9, 17, '2026-08-03 10:54:23'),
(32687, 2, 9, 18, '2026-08-03 10:54:23'),
(32688, 2, 9, 19, '2026-08-03 10:54:23'),
(32689, 2, 9, 20, '2026-08-03 10:54:23'),
(32690, 2, 9, 21, '2026-08-03 10:54:23'),
(32691, 2, 9, 22, '2026-08-03 10:54:23'),
(32692, 2, 9, 23, '2026-08-03 10:54:23'),
(32693, 2, 9, 24, '2026-08-03 10:54:23'),
(32694, 2, 9, 25, '2026-08-03 10:54:23'),
(32695, 2, 9, 26, '2026-08-03 10:54:23'),
(32696, 2, 9, 27, '2026-08-03 10:54:23'),
(32697, 2, 9, 28, '2026-08-03 10:54:23'),
(32698, 2, 9, 29, '2026-08-03 10:54:23'),
(32699, 2, 9, 30, '2026-08-03 10:54:23'),
(32700, 2, 9, 31, '2026-08-03 10:54:23'),
(32701, 2, 9, 32, '2026-08-03 10:54:23'),
(32702, 2, 9, 33, '2026-08-03 10:54:23'),
(32703, 2, 9, 38, '2026-08-03 10:54:23'),
(32704, 2, 9, 39, '2026-08-03 10:54:23'),
(32705, 2, 9, 40, '2026-08-03 10:54:23'),
(32706, 2, 9, 41, '2026-08-03 10:54:23'),
(32707, 2, 9, 51, '2026-08-03 10:54:23'),
(32708, 2, 9, 52, '2026-08-03 10:54:23'),
(32709, 2, 9, 53, '2026-08-03 10:54:23'),
(32710, 2, 9, 54, '2026-08-03 10:54:23'),
(32711, 2, 9, 243, '2026-08-03 10:54:23'),
(32712, 2, 9, 245, '2026-08-03 10:54:23'),
(32713, 2, 9, 244, '2026-08-03 10:54:23'),
(32714, 2, 9, 242, '2026-08-03 10:54:23'),
(32715, 2, 9, 205, '2026-08-03 10:54:23'),
(32716, 2, 9, 207, '2026-08-03 10:54:23'),
(32717, 2, 9, 206, '2026-08-03 10:54:23'),
(32718, 2, 9, 204, '2026-08-03 10:54:23'),
(32719, 2, 9, 202, '2026-08-03 10:54:23'),
(32720, 2, 9, 201, '2026-08-03 10:54:23'),
(32721, 2, 9, 42, '2026-08-03 10:54:23'),
(32722, 2, 9, 43, '2026-08-03 10:54:23'),
(32723, 2, 9, 44, '2026-08-03 10:54:23'),
(32724, 2, 9, 45, '2026-08-03 10:54:23'),
(32725, 2, 9, 46, '2026-08-03 10:54:23'),
(32726, 2, 9, 209, '2026-08-03 10:54:23'),
(32727, 2, 9, 211, '2026-08-03 10:54:23'),
(32728, 2, 9, 210, '2026-08-03 10:54:23'),
(32729, 2, 9, 208, '2026-08-03 10:54:23'),
(32730, 2, 9, 261, '2026-08-03 10:54:23'),
(32731, 2, 9, 258, '2026-08-03 10:54:23'),
(32732, 2, 9, 259, '2026-08-03 10:54:23'),
(32733, 2, 9, 260, '2026-08-03 10:54:23'),
(32734, 2, 9, 79, '2026-08-03 10:54:23'),
(32735, 2, 9, 80, '2026-08-03 10:54:23'),
(32736, 2, 9, 81, '2026-08-03 10:54:23'),
(32737, 2, 9, 82, '2026-08-03 10:54:23'),
(32738, 2, 9, 83, '2026-08-03 10:54:24'),
(32739, 2, 9, 84, '2026-08-03 10:54:24'),
(32740, 2, 9, 85, '2026-08-03 10:54:24'),
(32741, 2, 9, 86, '2026-08-03 10:54:24'),
(32742, 2, 9, 55, '2026-08-03 10:54:24'),
(32743, 2, 9, 56, '2026-08-03 10:54:24'),
(32744, 2, 9, 57, '2026-08-03 10:54:24'),
(32745, 2, 9, 58, '2026-08-03 10:54:24'),
(32746, 2, 9, 99, '2026-08-03 10:54:24'),
(32752, 10, 0, 253, '2026-08-03 10:59:24'),
(32753, 10, 0, 255, '2026-08-03 10:59:24'),
(32754, 10, 0, 256, '2026-08-03 10:59:24'),
(32755, 10, 0, 254, '2026-08-03 10:59:24'),
(32756, 10, 0, 252, '2026-08-03 10:59:24'),
(32757, 10, 0, 1, '2026-08-03 10:59:24'),
(32758, 10, 0, 2, '2026-08-03 10:59:24'),
(32759, 10, 0, 239, '2026-08-03 10:59:24'),
(32760, 10, 0, 241, '2026-08-03 10:59:24'),
(32761, 10, 0, 240, '2026-08-03 10:59:24'),
(32762, 10, 0, 238, '2026-08-03 10:59:24'),
(32763, 10, 0, 243, '2026-08-03 10:59:24'),
(32764, 10, 0, 245, '2026-08-03 10:59:24'),
(32765, 10, 0, 244, '2026-08-03 10:59:24'),
(32766, 10, 0, 242, '2026-08-03 10:59:24'),
(32767, 10, 0, 209, '2026-08-03 10:59:24'),
(32768, 10, 0, 211, '2026-08-03 10:59:24'),
(32769, 10, 0, 210, '2026-08-03 10:59:24'),
(32770, 10, 0, 208, '2026-08-03 10:59:24'),
(32909, 2, 0, 253, '2026-08-03 11:13:22'),
(32910, 2, 0, 255, '2026-08-03 11:13:22'),
(32911, 2, 0, 256, '2026-08-03 11:13:22'),
(32912, 2, 0, 254, '2026-08-03 11:13:22'),
(32913, 2, 0, 252, '2026-08-03 11:13:22'),
(32914, 2, 0, 270, '2026-08-03 11:13:22'),
(32915, 2, 0, 271, '2026-08-03 11:13:22'),
(32916, 2, 0, 47, '2026-08-03 11:13:22'),
(32917, 2, 0, 48, '2026-08-03 11:13:22'),
(32918, 2, 0, 49, '2026-08-03 11:13:22'),
(32919, 2, 0, 50, '2026-08-03 11:13:22'),
(32920, 2, 0, 278, '2026-08-03 11:13:22'),
(32921, 2, 0, 266, '2026-08-03 11:13:22'),
(32922, 2, 0, 267, '2026-08-03 11:13:22'),
(32923, 2, 0, 268, '2026-08-03 11:13:22'),
(32924, 2, 0, 269, '2026-08-03 11:13:22'),
(32925, 2, 0, 264, '2026-08-03 11:13:22'),
(32926, 2, 0, 1, '2026-08-03 11:13:22'),
(32927, 2, 0, 2, '2026-08-03 11:13:22'),
(32928, 2, 0, 262, '2026-08-03 11:13:22'),
(32929, 2, 0, 283, '2026-08-03 11:13:22'),
(32930, 2, 0, 284, '2026-08-03 11:13:22'),
(32931, 2, 0, 5, '2026-08-03 11:13:22'),
(32932, 2, 0, 6, '2026-08-03 11:13:22'),
(32933, 2, 0, 7, '2026-08-03 11:13:22'),
(32934, 2, 0, 8, '2026-08-03 11:13:22'),
(32935, 2, 0, 9, '2026-08-03 11:13:22'),
(32936, 2, 0, 219, '2026-08-03 11:13:22'),
(32937, 2, 0, 221, '2026-08-03 11:13:22'),
(32938, 2, 0, 220, '2026-08-03 11:13:22'),
(32939, 2, 0, 218, '2026-08-03 11:13:22'),
(32940, 2, 0, 233, '2026-08-03 11:13:22'),
(32941, 2, 0, 234, '2026-08-03 11:13:22'),
(32942, 2, 0, 215, '2026-08-03 11:13:22'),
(32943, 2, 0, 217, '2026-08-03 11:13:22'),
(32944, 2, 0, 216, '2026-08-03 11:13:22'),
(32945, 2, 0, 214, '2026-08-03 11:13:22'),
(32946, 2, 0, 247, '2026-08-03 11:13:22'),
(32947, 2, 0, 248, '2026-08-03 11:13:22'),
(32948, 2, 0, 249, '2026-08-03 11:13:22'),
(32949, 2, 0, 250, '2026-08-03 11:13:22'),
(32950, 2, 0, 232, '2026-08-03 11:13:22'),
(32951, 2, 0, 223, '2026-08-03 11:13:22'),
(32952, 2, 0, 225, '2026-08-03 11:13:23'),
(32953, 2, 0, 224, '2026-08-03 11:13:23'),
(32954, 2, 0, 222, '2026-08-03 11:13:23'),
(32955, 2, 0, 229, '2026-08-03 11:13:23'),
(32956, 2, 0, 228, '2026-08-03 11:13:23'),
(32957, 2, 0, 227, '2026-08-03 11:13:23'),
(32958, 2, 0, 226, '2026-08-03 11:13:23'),
(32959, 2, 0, 231, '2026-08-03 11:13:23'),
(32960, 2, 0, 230, '2026-08-03 11:13:23'),
(32961, 2, 0, 59, '2026-08-03 11:13:23'),
(32962, 2, 0, 60, '2026-08-03 11:13:23'),
(32963, 2, 0, 61, '2026-08-03 11:13:23'),
(32964, 2, 0, 62, '2026-08-03 11:13:23'),
(32965, 2, 0, 63, '2026-08-03 11:13:23'),
(32966, 2, 0, 64, '2026-08-03 11:13:23'),
(32967, 2, 0, 65, '2026-08-03 11:13:23'),
(32968, 2, 0, 66, '2026-08-03 11:13:23'),
(32969, 2, 0, 67, '2026-08-03 11:13:23'),
(32970, 2, 0, 68, '2026-08-03 11:13:23'),
(32971, 2, 0, 69, '2026-08-03 11:13:23'),
(32972, 2, 0, 70, '2026-08-03 11:13:23'),
(32973, 2, 0, 239, '2026-08-03 11:13:23'),
(32974, 2, 0, 241, '2026-08-03 11:13:23'),
(32975, 2, 0, 240, '2026-08-03 11:13:23'),
(32976, 2, 0, 238, '2026-08-03 11:13:23'),
(32977, 2, 0, 203, '2026-08-03 11:13:23'),
(32978, 2, 0, 265, '2026-08-03 11:13:23'),
(32979, 2, 0, 34, '2026-08-03 11:13:23'),
(32980, 2, 0, 35, '2026-08-03 11:13:23'),
(32981, 2, 0, 36, '2026-08-03 11:13:23'),
(32982, 2, 0, 37, '2026-08-03 11:13:23'),
(32983, 2, 0, 71, '2026-08-03 11:13:23'),
(32984, 2, 0, 72, '2026-08-03 11:13:23'),
(32985, 2, 0, 73, '2026-08-03 11:13:23'),
(32986, 2, 0, 74, '2026-08-03 11:13:23'),
(32987, 2, 0, 75, '2026-08-03 11:13:23'),
(32988, 2, 0, 76, '2026-08-03 11:13:23'),
(32989, 2, 0, 77, '2026-08-03 11:13:23'),
(32990, 2, 0, 78, '2026-08-03 11:13:23'),
(32991, 2, 0, 10, '2026-08-03 11:13:23'),
(32992, 2, 0, 11, '2026-08-03 11:13:23'),
(32993, 2, 0, 12, '2026-08-03 11:13:23'),
(32994, 2, 0, 13, '2026-08-03 11:13:23'),
(32995, 2, 0, 14, '2026-08-03 11:13:23'),
(32996, 2, 0, 15, '2026-08-03 11:13:23'),
(32997, 2, 0, 16, '2026-08-03 11:13:23'),
(32998, 2, 0, 17, '2026-08-03 11:13:23'),
(32999, 2, 0, 18, '2026-08-03 11:13:23'),
(33000, 2, 0, 19, '2026-08-03 11:13:23'),
(33001, 2, 0, 20, '2026-08-03 11:13:23'),
(33002, 2, 0, 21, '2026-08-03 11:13:23'),
(33003, 2, 0, 22, '2026-08-03 11:13:23'),
(33004, 2, 0, 23, '2026-08-03 11:13:23'),
(33005, 2, 0, 24, '2026-08-03 11:13:23'),
(33006, 2, 0, 25, '2026-08-03 11:13:23'),
(33007, 2, 0, 26, '2026-08-03 11:13:23'),
(33008, 2, 0, 27, '2026-08-03 11:13:23'),
(33009, 2, 0, 28, '2026-08-03 11:13:23'),
(33010, 2, 0, 29, '2026-08-03 11:13:23'),
(33011, 2, 0, 30, '2026-08-03 11:13:23'),
(33012, 2, 0, 31, '2026-08-03 11:13:23'),
(33013, 2, 0, 32, '2026-08-03 11:13:23'),
(33014, 2, 0, 33, '2026-08-03 11:13:23'),
(33015, 2, 0, 38, '2026-08-03 11:13:23'),
(33016, 2, 0, 39, '2026-08-03 11:13:23'),
(33017, 2, 0, 40, '2026-08-03 11:13:23'),
(33018, 2, 0, 41, '2026-08-03 11:13:23'),
(33019, 2, 0, 51, '2026-08-03 11:13:23'),
(33020, 2, 0, 52, '2026-08-03 11:13:23'),
(33021, 2, 0, 53, '2026-08-03 11:13:23'),
(33022, 2, 0, 54, '2026-08-03 11:13:23'),
(33023, 2, 0, 243, '2026-08-03 11:13:23'),
(33024, 2, 0, 245, '2026-08-03 11:13:23'),
(33025, 2, 0, 244, '2026-08-03 11:13:23'),
(33026, 2, 0, 242, '2026-08-03 11:13:23'),
(33027, 2, 0, 205, '2026-08-03 11:13:23'),
(33028, 2, 0, 207, '2026-08-03 11:13:23'),
(33029, 2, 0, 206, '2026-08-03 11:13:23'),
(33030, 2, 0, 204, '2026-08-03 11:13:23'),
(33031, 2, 0, 202, '2026-08-03 11:13:23'),
(33032, 2, 0, 201, '2026-08-03 11:13:23'),
(33033, 2, 0, 42, '2026-08-03 11:13:23'),
(33034, 2, 0, 43, '2026-08-03 11:13:23'),
(33035, 2, 0, 44, '2026-08-03 11:13:23'),
(33036, 2, 0, 45, '2026-08-03 11:13:23'),
(33037, 2, 0, 46, '2026-08-03 11:13:23'),
(33038, 2, 0, 209, '2026-08-03 11:13:23'),
(33039, 2, 0, 211, '2026-08-03 11:13:23'),
(33040, 2, 0, 210, '2026-08-03 11:13:23'),
(33041, 2, 0, 208, '2026-08-03 11:13:23'),
(33042, 2, 0, 276, '2026-08-03 11:13:23'),
(33043, 2, 0, 277, '2026-08-03 11:13:23'),
(33044, 2, 0, 261, '2026-08-03 11:13:23'),
(33045, 2, 0, 258, '2026-08-03 11:13:23'),
(33046, 2, 0, 259, '2026-08-03 11:13:23'),
(33047, 2, 0, 260, '2026-08-03 11:13:23'),
(33048, 2, 0, 79, '2026-08-03 11:13:23'),
(33049, 2, 0, 80, '2026-08-03 11:13:23'),
(33050, 2, 0, 81, '2026-08-03 11:13:23'),
(33051, 2, 0, 82, '2026-08-03 11:13:23'),
(33052, 2, 0, 83, '2026-08-03 11:13:23'),
(33053, 2, 0, 84, '2026-08-03 11:13:23'),
(33054, 2, 0, 85, '2026-08-03 11:13:23'),
(33055, 2, 0, 86, '2026-08-03 11:13:23'),
(33056, 2, 0, 55, '2026-08-03 11:13:23'),
(33057, 2, 0, 56, '2026-08-03 11:13:23'),
(33058, 2, 0, 57, '2026-08-03 11:13:23'),
(33059, 2, 0, 58, '2026-08-03 11:13:23'),
(33060, 2, 0, 285, '2026-08-03 11:13:23'),
(33061, 2, 0, 286, '2026-08-03 11:13:23'),
(33062, 2, 0, 263, '2026-08-03 11:13:23'),
(33063, 2, 0, 279, '2026-08-03 11:13:23'),
(33064, 2, 0, 280, '2026-08-03 11:13:23'),
(33065, 2, 0, 99, '2026-08-03 11:13:23'),
(33066, 2, 0, 272, '2026-08-03 11:13:23'),
(33067, 2, 0, 273, '2026-08-03 11:13:23'),
(33068, 2, 0, 274, '2026-08-03 11:13:23'),
(33069, 2, 0, 275, '2026-08-03 11:13:23'),
(33070, 2, 0, 281, '2026-08-03 11:13:23'),
(33071, 2, 0, 282, '2026-08-03 11:13:23'),
(33098, 19, 0, 219, '2026-08-03 11:50:31'),
(33099, 19, 0, 221, '2026-08-03 11:50:31'),
(33100, 19, 0, 220, '2026-08-03 11:50:31'),
(33101, 19, 0, 218, '2026-08-03 11:50:31'),
(33102, 19, 0, 297, '2026-08-03 11:50:31'),
(33103, 19, 0, 233, '2026-08-03 11:50:31'),
(33104, 19, 0, 234, '2026-08-03 11:50:31'),
(33105, 19, 0, 215, '2026-08-03 11:50:31'),
(33106, 19, 0, 217, '2026-08-03 11:50:31'),
(33107, 19, 0, 216, '2026-08-03 11:50:31'),
(33108, 19, 0, 214, '2026-08-03 11:50:31'),
(33109, 19, 0, 296, '2026-08-03 11:50:31'),
(33110, 19, 0, 247, '2026-08-03 11:50:31'),
(33111, 19, 0, 248, '2026-08-03 11:50:31'),
(33112, 19, 0, 249, '2026-08-03 11:50:31'),
(33113, 19, 0, 250, '2026-08-03 11:50:31'),
(33114, 19, 0, 232, '2026-08-03 11:50:31'),
(33115, 19, 0, 223, '2026-08-03 11:50:31'),
(33116, 19, 0, 225, '2026-08-03 11:50:31'),
(33117, 19, 0, 224, '2026-08-03 11:50:31'),
(33118, 19, 0, 222, '2026-08-03 11:50:31'),
(33119, 19, 0, 229, '2026-08-03 11:50:31'),
(33120, 19, 0, 228, '2026-08-03 11:50:31'),
(33121, 19, 0, 227, '2026-08-03 11:50:31'),
(33122, 19, 0, 226, '2026-08-03 11:50:31'),
(33123, 19, 0, 231, '2026-08-03 11:50:31'),
(33124, 19, 0, 230, '2026-08-03 11:50:31'),
(33125, 3, 0, 47, '2026-08-05 06:36:33'),
(33126, 3, 0, 48, '2026-08-05 06:36:33'),
(33127, 3, 0, 49, '2026-08-05 06:36:33'),
(33128, 3, 0, 50, '2026-08-05 06:36:33'),
(33129, 3, 0, 1, '2026-08-05 06:36:33'),
(33130, 3, 0, 2, '2026-08-05 06:36:33'),
(33131, 3, 0, 68, '2026-08-05 06:36:33'),
(33132, 3, 0, 34, '2026-08-05 06:36:33'),
(33133, 3, 0, 71, '2026-08-05 06:36:33'),
(33134, 3, 0, 72, '2026-08-05 06:36:33'),
(33135, 3, 0, 75, '2026-08-05 06:36:33'),
(33136, 3, 0, 205, '2026-08-05 06:36:33'),
(33137, 3, 0, 207, '2026-08-05 06:36:33'),
(33138, 3, 0, 206, '2026-08-05 06:36:33'),
(33139, 3, 0, 204, '2026-08-05 06:36:33'),
(33140, 3, 0, 202, '2026-08-05 06:36:33'),
(33141, 3, 0, 201, '2026-08-05 06:36:33'),
(33142, 3, 0, 42, '2026-08-05 06:36:33'),
(33143, 3, 0, 43, '2026-08-05 06:36:33'),
(33144, 3, 0, 44, '2026-08-05 06:36:33'),
(33145, 3, 0, 45, '2026-08-05 06:36:33'),
(33146, 3, 0, 46, '2026-08-05 06:36:33'),
(33147, 3, 0, 55, '2026-08-05 06:36:33'),
(33148, 3, 0, 56, '2026-08-05 06:36:33'),
(33149, 3, 0, 57, '2026-08-05 06:36:33'),
(33150, 3, 0, 58, '2026-08-05 06:36:33'),
(33151, 3, 0, 99, '2026-08-05 06:36:33');
...
INSERT INTO `staff` (`staff_id`, `register_id`, `name`, `mobile`, `email`, `role`, `address`, `date_of_birth`, `age`, `gender`, `blood_group`, `qualification`, `specialization`, `department`, `experience`, `shift_timing`, `emergency_contact`, `profile_image`, `status`, `created_at`, `updated_at`, `delete_flag`, `hospital_id`) VALUES
(11, 1040, 'Rahul Namya', '7894562144', 'rahul@gmail.com', 'Lab Technician', '', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'documents/staff/images/Department Master.png', 'Active', '2026-07-21 10:08:13', '2026-07-31 10:42:25', 0, 5),
(16, 1058, 'abhishek mandhare', '', 'rohankurn@gmail.com', 'Nurse', '', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, '', 'Active', '2026-07-29 10:37:28', '2026-07-31 10:41:46', 0, 5),
(21, 1071, 'Shiva Tevarrr', '', 'shivvv@gmail.com', 'Receptionist', '', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, '', 'Active', '2026-07-30 17:49:36', '2026-07-31 10:40:36', 0, 5),
(22, 1072, 'Hrugwed More', '7845125987', 'apurva@gmail.com', 'Accountant', '', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'documents/staff/images/acc.jpg', 'Active', '2026-08-01 15:02:55', '2026-08-01 15:04:46', 0, 5),
(23, 1073, 'Abhi Jagtap', '1234567890', 'jagtap@gmail.com', 'Nurse', 'Godoli', '2004-09-16', 21, 'Male', 'A-', 'MSC Nursing', 'Neural Specialist', NULL, 3, 'Evening', '1234567890', '', 'Active', '2026-08-03 06:03:23', '2026-08-03 06:03:23', 0, 5);
...
(1, 5, 0.00, '2026-07-29 09:21:14', '2026-08-03 06:03:14', 0, 2, 4, 9),
(2, 9, 0.00, '2026-07-31 09:52:14', '2026-07-31 11:22:44', 0, 2, 4, 4),
(3, 6, 0.00, '2026-07-31 09:52:29', '2026-07-31 11:22:44', 0, 2, 4, 4),
(4, 7, 0.00, '2026-07-31 09:52:29', '2026-07-31 11:22:44', 0, 2, 4, 4);
...
--
-- Indexes for table `advance_deposits`
--
...
--
-- Indexes for table `doctor_instructions`
--
ALTER TABLE `doctor_instructions`
  ADD PRIMARY KEY (`instruction_id`),
  ADD KEY `fk_instruction_prescription` (`prescription_id`),
  ADD KEY `fk_instruction_patient` (`patient_id`),
  ADD KEY `fk_instruction_doctor` (`doctor_id`),
  ADD KEY `fk_instruction_hospital` (`hospital_id`);
...
ALTER TABLE `patient_vitals`
  ...
  ADD KEY `fk_vitals_hospital` (`hospital_id`),
  ADD KEY `fk_vitals_nurse` (`nurse_id`);
...
--
-- AUTO_INCREMENT for table `advance_deposits`
--
ALTER TABLE `advance_deposits`
...
--
-- AUTO_INCREMENT for table `doctor_instructions`
--
ALTER TABLE `doctor_instructions`
...
--
ALTER TABLE `permissions`
  MODIFY `permission_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=299;
...
--
ALTER TABLE `role_permissions`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=33152;
...
--
-- Constraints for table `doctor_instructions`
--
ALTER TABLE `doctor_instructions`
  ADD CONSTRAINT `fk_instruction_doctor` FOREIGN KEY (`doctor_id`) REFERENCES `doctor` (`doctor_id`),
  ADD CONSTRAINT `fk_instruction_hospital` FOREIGN KEY (`hospital_id`) REFERENCES `hospital_master` (`hospital_id`),
  ADD CONSTRAINT `fk_instruction_patient` FOREIGN KEY (`patient_id`) REFERENCES `patients` (`patient_id`),
  ADD CONSTRAINT `fk_instruction_prescription` FOREIGN KEY (`prescription_id`) REFERENCES `prescription_master` (`prescription_id`);
...
--
ALTER TABLE `nursing_notes`
  ADD CONSTRAINT `nursing_notes_ibfk_1` FOREIGN KEY (`patient_id`) REFERENCES `patients` (`patient_id`),
  ADD CONSTRAINT `nursing_notes_ibfk_2` FOREIGN KEY (`nurse_id`) REFERENCES `register` (`id`),
  ADD CONSTRAINT `nursing_notes_ibfk_3` FOREIGN KEY (`hospital_id`) REFERENCES `hospital_master` (`hospital_id`);
...
--
ALTER TABLE `patient_vitals`
  ADD CONSTRAINT `fk_vitals_hospital` FOREIGN KEY (`hospital_id`) REFERENCES `hospital_master` (`hospital_id`),
  ADD CONSTRAINT `fk_vitals_nurse` FOREIGN KEY (`nurse_id`) REFERENCES `register` (`id`),
  ADD CONSTRAINT `fk_vitals_patient` FOREIGN KEY (`patient_id`) REFERENCES `patients` (`patient_id`);
