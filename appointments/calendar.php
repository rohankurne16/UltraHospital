...
<html lang="en">
<!-- Mirrored from medixpro-one.vercel.app/appointments/calendar by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 26 Jun 2026 11:10:22 GMT -->
<!-- Added by HTTrack -->
...
<head>
    ...
    <script src="../_next/static/chunks/62808651f0b733e8.js" async=""></script>
...
<body class="inter_5972bc34-module__OU16Qa__className">
        ...
        <div class="flex flex-1 items-start">
            ...
            <main class="flex-1 overflow-auto duration-300 p-4 xl:p-6 xl:ml-64">
                <section aria-label="Notifications alt+T" tabindex="-1" aria-live="polite"
                    aria-relevant="additions text" aria-atomic="false"></section><!--$--><!--$?--><template
                    id="B:0"></template><!--/$--><!--/$-->
            </main>
        </div>
    </div>
    ...
    <div hidden id="S:0">
        <div class="flex flex-col gap-5">
            <div class="flex items-center gap-4 flex-wrap"><a
                    ...
                    href="../appointments.html"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                        viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"
                        stroke-linejoin="round" class="lucide lucide-arrow-left h-4 w-4">
                        <path d="m12 19-7-7 7-7"></path>
                        <path d="M19 12H5"></path>
                    </svg><span class="sr-only">Back</span></a>
                <div>
                    <h2 class="text-2xl lg:text-3xl font-bold tracking-tight mb-2">Appointment Calendar</h2>
                    <p class="text-muted-foreground">View and manage appointments in calendar view.</p>
                </div>
            </div>
            <div class="rounded-lg border bg-card text-card-foreground shadow-sm">
                <div
                    class="space-y-1.5 p-3 md:p-4 xxl:p-6 flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4 pb-2">
                    <h2 class="text-xl xl:text-2xl font-semibold leading-tight mb-2 tracking-tight">Calendar</h2>
                    <div class="flex items-center gap-2 flex-wrap"><button
                            class="inline-flex items-center justify-center shrink-0 gap-2 whitespace-nowrap text-sm font-medium ring-offset-background transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&amp;_svg]:pointer-events-none [&amp;_svg]:size-4 [&amp;_svg]:shrink-0 border border-input bg-background hover:bg-accent hover:text-accent-foreground h-9 rounded-md px-3">Today</button><button
                            class="inline-flex items-center justify-center shrink-0 gap-2 whitespace-nowrap rounded-md text-sm font-medium ring-offset-background transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&amp;_svg]:pointer-events-none [&amp;_svg]:size-4 [&amp;_svg]:shrink-0 border border-input bg-background hover:bg-accent hover:text-accent-foreground size-10"><svg
                            ...
                            </svg></button><span class="text-sm font-medium">February 14, 2026</span></div>
                </div>
                <div class="p-3 md:p-4 xxl:p-6">
                    <div class="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4 mb-4">
                        <div dir="ltr" data-orientation="horizontal" class="w-full sm:w-auto">
                            <div role="tablist" aria-orientation="horizontal"
                                class="inline-flex flex-wrap items-center rounded-md bg-muted p-1 text-muted-foreground"
                                tabindex="-1" data-orientation="horizontal" style="outline:none"><button type="button"
                                    role="tab" aria-selected="true" aria-controls="radix-_R_16inpfivaivb_-content-day"
                                    data-state="active" id="radix-_R_16inpfivaivb_-trigger-day"
                                    class="inline-flex items-center justify-center whitespace-nowrap rounded-sm px-3 py-1.5 text-sm font-medium ring-offset-background transition-all focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 data-[state=active]:bg-background data-[state=active]:text-foreground data-[state=active]:shadow-sm"
                                    tabindex="-1" data-orientation="horizontal"
                                    data-radix-collection-item="">Day</button><button type="button" role="tab"
                                    aria-selected="false" aria-controls="radix-_R_16inpfivaivb_-content-week"
                                    data-state="inactive" id="radix-_R_16inpfivaivb_-trigger-week"
                                    class="inline-flex items-center justify-center whitespace-nowrap rounded-sm px-3 py-1.5 text-sm font-medium ring-offset-background transition-all focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 data-[state=active]:bg-background data-[state=active]:text-foreground data-[state=active]:shadow-sm"
                                    tabindex="-1" data-orientation="horizontal"
                                    data-radix-collection-item="">Week</button><button type="button" role="tab"
                                    aria-selected="false" aria-controls="radix-_R_16inpfivaivb_-content-month"
                                    data-state="inactive" id="radix-_R_16inpfivaivb_-trigger-month"
                                    class="inline-flex items-center justify-center whitespace-nowrap rounded-sm px-3 py-1.5 text-sm font-medium ring-offset-background transition-all focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 data-[state=active]:bg-background data-[state=active]:text-foreground data-[state=active]:shadow-sm"
                                    tabindex="-1" data-orientation="horizontal"
                                    data-radix-collection-item="">Month</button></div>
                        </div>
                        <div class="flex items-center gap-2 w-full sm:w-auto"><button type="button" role="combobox"
                                aria-controls="radix-_R_66inpfivaivb_" aria-expanded="false" aria-autocomplete="none"
                                dir="ltr" data-state="closed"
                                class="flex h-10 items-center justify-between rounded-md border border-input bg-background px-3 py-2 text-sm ring-offset-background placeholder:text-muted-foreground focus:outline-none focus:ring-2 focus:ring-ring focus:ring-offset-2 disabled:cursor-not-allowed disabled:opacity-50 [&amp;&gt;span]:line-clamp-1 w-full sm:w-[200px]"><span
                                    style="pointer-events:none"></span><svg xmlns="http://www.w3.org/2000/svg"
                                ...
                                style="position:absolute;border:0;width:1px;height:1px;padding:0;margin:-1px;overflow:hidden;clip:rect(0, 0, 0, 0);white-space:nowrap;word-wrap:normal"></select><a
                                ...
                                href="add.html"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                    ...
                    <div class="space-y-4">
                        <div class="grid grid-cols-1 gap-4">
                            <div class="flex border rounded-md overflow-hidden">
                                <div class="md:w-20 p-1 md:p-2 bg-muted flex items-center justify-center border-r"><span
                                        class="text-xs md:text-sm font-medium">08:00 AM</span></div>
                                <div class="flex-1 p-1 md:p-2 min-h-[80px]"></div>
                            </div>
                            <div class="flex border rounded-md overflow-hidden">
                                <div class="md:w-20 p-1 md:p-2 bg-muted flex items-center justify-center border-r"><span
                                        class="text-xs md:text-sm font-medium">09:00 AM</span></div>
                                <div class="flex-1 p-1 md:p-2 min-h-[80px]"></div>
                            </div>
                            <div class="flex border rounded-md overflow-hidden">
                                <div class="md:w-20 p-1 md:p-2 bg-muted flex items-center justify-center border-r"><span
                                        class="text-xs md:text-sm font-medium">10:00 AM</span></div>
                                <div class="flex-1 p-1 md:p-2 min-h-[80px]">
                                    <div class="p-2 mb-1 rounded-md bg-blue-500/10 border border-blue-300">
                                        <div class="flex items-center justify-between">
                                            <div class="flex items-center"><span
                                                    class="relative flex shrink-0 overflow-hidden rounded-full h-6 w-6 mr-2"><span
                                                        class="flex h-full w-full items-center justify-center rounded-full bg-muted">J</span></span><span
                                                    class="font-medium text-sm">John Smith</span></div>
                                            <div
                                                class="inline-flex items-center rounded-full border px-1.5 whitespace-nowrap md:px-2.5 py-0.5 text-xs font-semibold transition-colors focus:outline-none focus:ring-2 focus:ring-ring focus:ring-offset-2 border-blue-500 text-blue-500">
                                                Confirmed</div>
                                        </div>
                                        <div class="mt-1 text-xs text-muted-foreground max-sm:hidden">
                                            <div class="flex justify-between"><span>10:00 AM<!-- --> - <!-- -->10:30
                                                    AM</span><span>Check-up</span></div>
                            ...
                            <div class="flex border rounded-md overflow-hidden">
                                <div class="md:w-20 p-1 md:p-2 bg-muted flex items-center justify-center border-r"><span
                                        class="text-xs md:text-sm font-medium">11:00 AM</span></div>
                                <div class="flex-1 p-1 md:p-2 min-h-[80px]">
                                    <div class="p-2 mb-1 rounded-md bg-amber-500/10 border border-amber-300">
                                        <div class="flex items-center justify-between">
                                            <div class="flex items-center"><span
                                                    class="relative flex shrink-0 overflow-hidden rounded-full h-6 w-6 mr-2"><span
                                                        class="flex h-full w-full items-center justify-center rounded-full bg-muted">E</span></span><span
                                                    class="font-medium text-sm">Emily Davis</span></div>
                                            <div
                                                class="inline-flex items-center rounded-full border px-1.5 whitespace-nowrap md:px-2.5 py-0.5 text-xs font-semibold transition-colors focus:outline-none focus:ring-2 focus:ring-ring focus:ring-offset-2 border-transparent text-primary-foreground hover:bg-primary/80 bg-amber-500">
                                                In Progress</div>
                                        </div>
                                        <div class="mt-1 text-xs text-muted-foreground max-sm:hidden">
                                            <div class="flex justify-between"><span>11:30 AM<!-- --> - <!-- -->12:15
                                                    PM</span><span>Consultation</span></div>
                            ...
                            <div class="flex border rounded-md overflow-hidden">
                                <div class="md:w-20 p-1 md:p-2 bg-muted flex items-center justify-center border-r"><span
                                        class="text-xs md:text-sm font-medium">12:00 PM</span></div>
                                <div class="flex-1 p-1 md:p-2 min-h-[80px]"></div>
                            </div>
                            <div class="flex border rounded-md overflow-hidden">
                                <div class="md:w-20 p-1 md:p-2 bg-muted flex items-center justify-center border-r"><span
                                        class="text-xs md:text-sm font-medium">01:00 PM</span></div>
                                <div class="flex-1 p-1 md:p-2 min-h-[80px]"></div>
                            </div>
                            <div class="flex border rounded-md overflow-hidden">
                                <div class="md:w-20 p-1 md:p-2 bg-muted flex items-center justify-center border-r"><span
                                        class="text-xs md:text-sm font-medium">02:00 PM</span></div>
                                <div class="flex-1 p-1 md:p-2 min-h-[80px]">
                                    <div class="p-2 mb-1 rounded-md bg-green-500/10 border border-green-300">
                                        <div class="flex items-center justify-between">
                                            <div class="flex items-center"><span
                                                    class="relative flex shrink-0 overflow-hidden rounded-full h-6 w-6 mr-2"><span
                                                        class="flex h-full w-full items-center justify-center rounded-full bg-muted">R</span></span><span
                                                    class="font-medium text-sm">Robert Wilson</span></div>
                                            <div
                                                class="inline-flex items-center rounded-full border px-1.5 whitespace-nowrap md:px-2.5 py-0.5 text-xs font-semibold transition-colors focus:outline-none focus:ring-2 focus:ring-ring focus:ring-offset-2 border-transparent text-primary-foreground hover:bg-primary/80 bg-green-500">
                                                Completed</div>
                                        </div>
                                        <div class="mt-1 text-xs text-muted-foreground max-sm:hidden">
                                            <div class="flex justify-between"><span>02:15 PM<!-- --> - <!-- -->02:35
                                                    PM</span><span>Follow-up</span></div>
                                            <div>Dr. Lisa Patel</div>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div class="flex border rounded-md overflow-hidden">
                                <div class="md:w-20 p-1 md:p-2 bg-muted flex items-center justify-center border-r"><span
                                        class="text-xs md:text-sm font-medium">03:00 PM</span></div>
                                <div class="flex-1 p-1 md:p-2 min-h-[80px]"></div>
                            </div>
                            <div class="flex border rounded-md overflow-hidden">
                                <div class="md:w-20 p-1 md:p-2 bg-muted flex items-center justify-center border-r"><span
                                        class="text-xs md:text-sm font-medium">04:00 PM</span></div>
                                <div class="flex-1 p-1 md:p-2 min-h-[80px]"></div>
                            </div>
                            <div class="flex border rounded-md overflow-hidden">
                                <div class="md:w-20 p-1 md:p-2 bg-muted flex items-center justify-center border-r"><span
                                        class="text-xs md:text-sm font-medium">05:00 PM</span></div>
                                <div class="flex-1 p-1 md:p-2 min-h-[80px]"></div>
                            </div>
                        </div>
                    </div>
