        ...
        if ($result->num_rows > 0) {
            ...
            if ($messageType != "error") {
                ...
                try {
                    ...
                    $admin_user = "Admin";
                    $stmt_reg->bind_param("sssssss", $name, $email, $hashed_password, $selectrole, $admin_user, $admin_user,$hid);
                    ...
                    $stmt_staff->bind_param("issssssss", $register_id, $name, $mobile, $email, $selectrole, $address, $status, $image_path,$hid);
...
<head>
    ...
    <style>
        ...
        .field-group input, .field-group select, .field-group textarea { padding: 12px 16px; border-radius: 12px; border: 1.5px solid #e2e8f0; background: #fcfdfe; font-size: 14px; outline: none; transition: 0.2s; width: 100%; }
                            ...
                            <div class="form-section active" id="section1">
                                ...
                                <div class="form-grid">
                                    <div class="field-group">
                                        ...
                                        <input type="text" name="name" value="<?php echo isset($form_data['name']) ? htmlspecialchars($form_data['name']) : ''; ?>" required />
                                    </div>

                                    <div class="field-group">
                                        <label><i class="fas fa-phone"></i> Mobile Number</label>
                                        <input type="text" name="mobile" value="<?php echo isset($form_data['mobile']) ? htmlspecialchars($form_data['mobile']) : ''; ?>" />
                                    </div>
                                    ...
                                    <div class="field-group">
                                        ...
                                        <select name="selectrole" required>
                                    ...
                                    <div class="field-group full-width">
                                        ...
                                        <textarea name="address" rows="2"><?php echo isset($form_data['address']) ? htmlspecialchars($form_data['address']) : ''; ?></textarea>
                                    </div>
                                </div>
