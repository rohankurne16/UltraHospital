<?php
// ============================================================
// DYNAMIC SIDEBAR (Sidebar.php) - AUTO-PERMISSION SIDEBAR
// ============================================================
...
// ============================================================
// HELPER: Check if user has ANY permission with given prefix(es)
// ============================================================
function hasAnyPermPrefix($prefixes) {
...
// Determine if the user is an Accountant
 $is_accountant = (strtolower(trim($user_role)) === 'accountant');
?>
<style>
/* ============================================================
    ...
    <aside class="sidebar" id="mainSidebar">
        ...
        <nav class="sidebar-nav">
            ...
            <?php if ($is_accountant): ?>
                <!-- ============================================================ -->
                <!-- ===== DEDICATED ACCOUNTANT SIDEBAR LAYOUT ===== -->
                <!-- ============================================================ -->
                ...
                <?php if (hasPerm('billing-view') || hasAnyPermPrefix('billing')): ?>
                <a href="billing.php" class="sidebar-link <?php echo $current_page == 'billing.php' || $current_page == 'create_bill.php' ? 'active' : ''; ?>">
                    <i class="fas fa-file-invoice-dollar"></i> Billing
                </a>
                <?php endif; ?>
                <?php if (hasPerm('accountant-payment-view') || hasAnyPermPrefix('accountant-payment') || hasPerm('payment-view')): ?>
                <a href="payments.php" class="sidebar-link <?php echo $current_page == 'payments.php' ? 'active' : ''; ?>">
                    <i class="fas fa-credit-card"></i> Payments
                </a>
                <?php endif; ?>
                <?php if (hasPerm('report-view') || hasAnyPermPrefix('report') || hasPerm('accountant-report-view')): ?>
                ...
                <!-- ==================== FINANCE ==================== -->
                <?php if (hasPerm('accountant-ledger-view') || hasPerm('accountant-expense-view') || hasPerm('accountant-invoice-view') || hasPerm('insurance-claim-view') || hasAnyPermPrefix(['accountant-ledger', 'accountant-expense', 'accountant-invoice', 'insurance'])): ?>
                <div class="sidebar-section-label">Finance</div>
                
                <?php if (hasPerm('accountant-ledger-view') || hasAnyPermPrefix('accountant-ledger')): ?>
                <a href="ledger.php" class="sidebar-link <?php echo $current_page == 'ledger.php' ? 'active' : ''; ?>">
                    <i class="fas fa-book"></i> Ledger
                </a>
                <?php endif; ?>
                
                <?php if (hasPerm('accountant-expense-view') || hasAnyPermPrefix('accountant-expense')): ?>
                <a href="expenses.php" class="sidebar-link <?php echo $current_page == 'expenses.php' ? 'active' : ''; ?>">
                    <i class="fas fa-receipt"></i> Expenses
                </a>
                <?php endif; ?>

                <?php if (hasPerm('accountant-invoice-view') || hasAnyPermPrefix('accountant-invoice')): ?>
                <a href="invoices.php" class="sidebar-link <?php echo $current_page == 'invoices.php' ? 'active' : ''; ?>">
                    <i class="fas fa-file-invoice"></i> Invoices
                </a>
                <?php endif; ?>

                <?php if (hasPerm('insurance-claim-view') || hasAnyPermPrefix('insurance')): ?>
                <a href="insurance_claims.php" class="sidebar-link <?php echo $current_page == 'insurance_claims.php' ? 'active' : ''; ?>">
                ...
                <!-- ==================== ADMIN ==================== -->
                <?php if (hasPerm('staff-view') || hasPerm('settings-view') || hasAnyPermPrefix(['staff', 'settings'])): ?>
                <div class="sidebar-section-label">Admin</div>
                
                <?php if (hasPerm('staff-view') || hasAnyPermPrefix('staff')): ?>
                <a href="staff.php" class="sidebar-link <?php echo $current_page == 'staff.php' ? 'active' : ''; ?>">
                    <i class="fas fa-users-cog"></i> Staff
                </a>
                <?php endif; ?>

                <?php if (hasPerm('settings-view') || hasAnyPermPrefix('settings')): ?>
            ...
            <?php else: ?>
                <!-- ============================================================ -->
                <!-- ===== DEFAULT SIDEBAR LAYOUT FOR OTHER ROLES ===== -->
                <!-- ============================================================ -->

                <!-- ==================== MAIN ==================== -->
                <?php if (hasPerm('dashboard-view') || hasAnyPermPrefix('dashboard')): ?>
                <div class="sidebar-section-label">Main</div>
                <a href="dashboard.php" class="sidebar-link <?php echo $current_page == 'dashboard.php' ? 'active' : ''; ?>">
                    <i class="fas fa-chart-pie"></i> Dashboard
                </a>
                ...
                <!-- ==================== PATIENT ==================== -->
                <?php if (hasAnyPerm(['patient-view', 'patient-create', 'opd-visit-view', 'ipd-admission-view', 'referral-view', 'call-patient-view']) || hasAnyPermPrefix(['patient', 'opd', 'ipd', 'referral', 'call'])): ?>
                ...
                <!-- ==================== APPOINTMENTS ==================== -->
                <?php if (hasPerm('appointment-view') || hasAnyPermPrefix('appointment')): ?>
                ...
                <!-- ==================== PRESCRIPTIONS ==================== -->
                <?php if (hasPerm('prescription-view') || hasAnyPermPrefix('prescription')): ?>
                ...
                <!-- ==================== OPERATION THEATRE ==================== -->
                <?php if (hasAnyPerm(['surgery-view', 'surgery-create']) || hasAnyPermPrefix('surgery')): ?>
                ...
                <!-- ==================== SERVICES ==================== -->
                <?php if (hasAnyPerm(['lab-orders-view', 'lab-reports-view', 'lab-master-view', 'stock-view', 'medicine-sales-view']) || hasAnyPermPrefix(['lab', 'stock', 'medicine-sales'])): ?>
                <div class="sidebar-section-label">Services</div>

                <?php if (hasAnyPerm(['lab-orders-view', 'lab-reports-view', 'lab-master-view']) || hasAnyPermPrefix('lab')): ?>
                <div class="sidebar-dropdown">
                ...
                <?php if (hasAnyPerm(['stock-view', 'medicine-sales-view']) || hasAnyPermPrefix(['stock', 'medicine-sales'])): ?>
                <div class="sidebar-dropdown">
                ...
                <!-- ==================== BILLING ==================== -->
                <?php if (hasAnyPerm(['billing-view', 'billing-create', 'advance-deposit-view']) || hasAnyPermPrefix(['billing', 'advance-deposit'])): ?>
                <div class="sidebar-section-label">Finance</div>
                <div class="sidebar-dropdown">
                ...
                <!-- ==================== MANAGEMENT ==================== -->
                <?php if (hasAnyPerm(['doctor-view', 'staff-view', 'department-view', 'hospital-view', 'ward-view', 'ward-create', 'ward-edit', 'ward-delete']) || hasAnyPermPrefix(['doctor', 'staff', 'department', 'ward', 'hospital'])): ?>
                <div class="sidebar-section-label">Management</div>
                
                <?php if (hasPerm('doctor-view') || hasAnyPermPrefix('doctor')): ?>
                ...
                <?php if (hasPerm('department-view') || hasAnyPermPrefix('department')): ?>
                ...
                <?php if (hasAnyPerm(['ward-view', 'ward-create', 'ward-edit', 'ward-delete']) || hasAnyPermPrefix('ward')): ?>
                <a href="ward_master.php" class="sidebar-link <?php echo $current_page == 'ward_master.php' ? 'active' : ''; ?>">
                    <i class="fas fa-bed"></i> Ward Master
                </a>
                <?php endif; ?>

                <?php if (hasPerm('hospital-view') || hasAnyPermPrefix('hospital')): ?>
                ...
                <!-- ==================== ADMIN ==================== -->
                <?php if (hasAnyPerm(['role-view', 'permission-view', 'audit-log-view']) || hasAnyPermPrefix(['role', 'permission', 'audit-log'])): ?>
                <div class="sidebar-section-label">Admin</div>

                <?php if (hasPerm('role-view') || hasAnyPermPrefix('role')): ?>
                <a href="roles.php" class="sidebar-link <?php echo $current_page == 'roles.php' ? 'active' : ''; ?>">
                    <i class="fas fa-user-tag"></i> Roles
                </a>
                <?php endif; ?>

                <?php if (hasPerm('permission-view') || hasAnyPermPrefix('permission')): ?>
                <a href="permissions.php" class="sidebar-link <?php echo $current_page == 'permissions.php' ? 'active' : ''; ?>">
                    <i class="fas fa-lock"></i> Permissions
                </a>
                <?php endif; ?>

                <?php if (hasPerm('audit-log-view') || hasAnyPermPrefix('audit-log')): ?>
                ...
                <!-- ==================== REPORTS ==================== -->
                <?php if (hasPerm('report-view') || hasAnyPermPrefix('report')): ?>
                ...
                $pending_count = 0;
                if (isset($conn) && isset($hid) && $hid > 0) {
                    $pending_sql = "SELECT COUNT(*) as count FROM leave_requests WHERE hospital_id = $hid AND status = 'Pending' AND delete_flag = 0";
                ...
                if (hasAnyPerm(['hr-dashboard-view', 'hr-attendance-view', 'hr-leave-view', 'hr-payroll-view', 'hr-recruitment-view', 'hr-employee-view', 'hr-department-view', 'hr-designation-view', 'hr-shift-view', 'hr-holiday-view', 'hr-performance-view', 'hr-training-view', 'hr-report-view']) || hasAnyPermPrefix('hr')): 
                ?>
                <div class="sidebar-section-label">Human Resources</div>

                <!-- ========== 1. HR DASHBOARD ========== -->
                <?php if (hasPerm('hr-dashboard-view') || hasAnyPermPrefix('hr-dashboard')): ?>
                ...
                <?php if (hasPerm('hr-employee-view') || hasAnyPermPrefix('hr-employee')): ?>
                <div class="sidebar-dropdown">
                    <button class="dropdown-toggle" onclick="toggleMenu('employeeMenu')">
                        <span><i class="fas fa-user-tie"></i>Employee Manage</span>
                        <i class="fas fa-chevron-down dropdown-arrow"></i>
                    </button>
                ...
                <!-- ========== 3. DEPARTMENT MASTER ========== -->
                <?php if (hasPerm('hr-department-view') || hasAnyPermPrefix('hr-department')): ?>
                ...
                <?php if (hasPerm('hr-designation-view') || hasAnyPermPrefix('hr-designation')): ?>
                ...
                <!-- ========== 5. SHIFT MASTER ========== -->
                <?php if (hasPerm('hr-shift-view') || hasAnyPermPrefix('hr-shift')): ?>
                ...
                <div class="sidebar-dropdown">
                    ...
                    <div id="attendanceMenu" class="dropdown-menu">
                        <?php if (hasPerm('hr-attendance-view') || hasAnyPermPrefix('hr-attendance')): ?>
                ...
                <div class="sidebar-dropdown">
                    ...
                    <div id="leaveMenu" class="dropdown-menu">
                        <?php if (hasPerm('hr-leave-view') || hasAnyPermPrefix('hr-leave')): ?>
                ...
                <!-- ========== 8. HOLIDAY MASTER ========== -->
                <?php if (hasPerm('hr-holiday-view') || hasAnyPermPrefix('hr-holiday')): ?>
                ...
                <!-- ========== 9. PAYROLL ========== -->
                <?php if (hasPerm('hr-payroll-view') || hasAnyPermPrefix('hr-payroll')): ?>
                <div class="sidebar-dropdown">
                ...
                <!-- ========== 10. PERFORMANCE ========== -->
                <?php if (hasPerm('hr-performance-view') || hasAnyPermPrefix('hr-performance')): ?>
                <div class="sidebar-dropdown">
                ...
                <!-- ========== 11. RECRUITMENT ========== -->
                <?php if (hasPerm('hr-recruitment-view') || hasAnyPermPrefix('hr-recruitment')): ?>
                <div class="sidebar-dropdown">
                ...
                <!-- ========== 12. TRAINING ========== -->
                <?php if (hasPerm('hr-training-view') || hasAnyPermPrefix('hr-training')): ?>
                <div class="sidebar-dropdown">
                ...
                <!-- ========== 13. REPORTS ========== -->
                <?php if (hasPerm('hr-report-view') || hasAnyPermPrefix('hr-report')): ?>
                <div class="sidebar-dropdown">
                ...
                <?php endif; ?> <!-- End HR section -->

                <!-- ============================================================ -->
                <!-- ===== ACCOUNTANT SECTION (Nested for Non-Accountants) ===== -->
                <!-- ============================================================ -->
                <?php if (hasAnyPerm(['accountant-dashboard-view', 'accountant-salary-view', 'accountant-expense-view', 'accountant-payment-view', 'accountant-invoice-view', 'accountant-ledger-view']) || hasAnyPermPrefix('accountant')): ?>
                ...
                <div class="sidebar-dropdown">
                    ...
                    <div id="accountantMenu" class="dropdown-menu">
                        <?php if (hasPerm('accountant-salary-view') || hasAnyPermPrefix('accountant-salary')): ?>
                        ...
                        <?php if (hasPerm('accountant-payment-view') || hasAnyPermPrefix('accountant-payment')): ?>
                        ...
                        <?php if (hasPerm('advance-deposit-view') || hasAnyPermPrefix('advance-deposit')): ?>
                        <a href="advance_deposits.php" class="sidebar-link sub-link">
                            <i class="fas fa-wallet"></i> Advance Deposits
                        </a>
                        <?php endif; ?>
                ...
                <!-- ===== PHARMACIST SECTION ===== -->
                <!-- ============================================================ -->
                <?php if (hasAnyPermPrefix('pharmacist') || hasAnyPermPrefix('medicine') || hasAnyPermPrefix('pharmacy') || hasAnyPermPrefix('purchase') || hasAnyPermPrefix('stock') || hasAnyPermPrefix('supplier')): ?>
                <div class="sidebar-section-label">Pharmacy</div>

                <!-- ===== DASHBOARD ===== -->
                <?php if (hasPerm('pharmacist-dashboard-view') || hasAnyPermPrefix('pharmacist-dashboard')): ?>
                <a href="pharmacist/dashboard.php" class="sidebar-link <?php echo $current_page == 'dashboard.php' && strpos($_SERVER['PHP_SELF'], '/pharmacy/') !== false ? 'active' : ''; ?>">
                ...
                <!-- ===== MEDICINE MASTER ===== -->
                <div class="sidebar-dropdown">
                    <button class="dropdown-toggle" onclick="toggleMenu('medicineMasterMenu')">
                        <span><i class="fas fa-pills"></i> Medicine Master</span>
                        <i class="fas fa-chevron-down dropdown-arrow"></i>
                    </button>
                    <div id="medicineMasterMenu" class="dropdown-menu">
                        <?php if (hasPerm('pharmacist-medicine-view') || hasAnyPermPrefix('pharmacist-medicine')): ?>
                        <a href="pharmacist/medicines.php" class="sidebar-link sub-link">
                            <i class="fas fa-capsules"></i> Medicine List
                        </a>
                        <?php endif; ?>
                        <a href="add_medicine.php" class="sidebar-link sub-link">
                            <i class="fas fa-plus-circle"></i> Add Medicine
                        </a>
                        <a href="categories.php" class="sidebar-link sub-link">
                            <i class="fas fa-layer-group"></i> Categories
                        </a>
                        <a href="generic_medicine.php" class="sidebar-link sub-link">
                            <i class="fas fa-flask"></i> Generic Medicine
                        </a>
                        <a href="manufacturers.php" class="sidebar-link sub-link">
                ...
                <!-- ===== PURCHASE MANAGEMENT ===== -->
                <div class="sidebar-dropdown">
                    <button class="dropdown-toggle" onclick="toggleMenu('purchaseMenu')">
                        <span><i class="fas fa-shopping-cart"></i> Purchase Management</span>
                        <i class="fas fa-chevron-down dropdown-arrow"></i>
                    </button>
                    <div id="purchaseMenu" class="dropdown-menu">
                        <a href="purchases.php" class="sidebar-link sub-link">
                            <i class="fas fa-list"></i> Purchase List
                        </a>
                        <a href="add_purchase.php" class="sidebar-link sub-link">
                            <i class="fas fa-cart-plus"></i> New Purchase
                        </a>
                        <a href="suppliers.php" class="sidebar-link sub-link">
                            <i class="fas fa-truck"></i> Suppliers
                        </a>
                        <a href="purchase_return.php" class="sidebar-link sub-link">
                ...
                <!-- ===== STOCK MANAGEMENT ===== -->
                <div class="sidebar-dropdown">
                    <button class="dropdown-toggle" onclick="toggleMenu('stockMenu')">
                        <span><i class="fas fa-boxes"></i> Stock Management</span>
                        <i class="fas fa-chevron-down dropdown-arrow"></i>
                    </button>
                    <div id="stockMenu" class="dropdown-menu">
                        <a href="stock.php" class="sidebar-link sub-link">
                            <i class="fas fa-box"></i> Current Stock
                        </a>
                        <a href="stock_in.php" class="sidebar-link sub-link">
                            <i class="fas fa-arrow-circle-down"></i> Stock In
                        </a>
                        <a href="stock_out.php" class="sidebar-link sub-link">
                            <i class="fas fa-arrow-circle-up"></i> Stock Out
                        </a>
                        <a href="low_stock.php" class="sidebar-link sub-link">
                            <i class="fas fa-exclamation-circle"></i> Low Stock
                        </a>
                        <a href="expiry_tracking.php" class="sidebar-link sub-link">
                            <i class="fas fa-exclamation-triangle"></i> Expiry Stock
                        </a>
                        <a href="stock_adjustment.php" class="sidebar-link sub-link">
                            <i class="fas fa-sliders-h"></i> Stock Adjustment
                        </a>
                        <a href="stock_history.php" class="sidebar-link sub-link">
                ...
                <!-- ===== PRESCRIPTION ===== -->
                <div class="sidebar-dropdown">
                    <button class="dropdown-toggle" onclick="toggleMenu('prescriptionMenu')">
                        <span><i class="fas fa-prescription"></i> Prescription</span>
                        <i class="fas fa-chevron-down dropdown-arrow"></i>
                    </button>
                    <div id="prescriptionMenu" class="dropdown-menu">
                        <a href="prescriptions.php" class="sidebar-link sub-link">
                            <i class="fas fa-file-medical"></i> Prescription List
                        </a>
                        <a href="pending_prescriptions.php" class="sidebar-link sub-link">
                            <i class="fas fa-clock"></i> Pending Prescriptions
                        </a>
                        <a href="prescription_details.php" class="sidebar-link sub-link">
                            <i class="fas fa-info-circle"></i> Prescription Details
                        </a>
                        <a href="dispense.php" class="sidebar-link sub-link">
                            <i class="fas fa-prescription-bottle"></i> Dispense Medicine
                        </a>
                        <a href="dispensed_history.php" class="sidebar-link sub-link">
                            <i class="fas fa-history"></i> Dispensed History
                        </a>
                    </div>
                </div>
                ...
                <!-- ===== MEDICINE SALE ===== -->
                <div class="sidebar-dropdown">
                    <button class="dropdown-toggle" onclick="toggleMenu('medicineSaleMenu')">
                        <span><i class="fas fa-cash-register"></i> Medicine Sale</span>
                        <i class="fas fa-chevron-down dropdown-arrow"></i>
                    </button>
                    <div id="medicineSaleMenu" class="dropdown-menu">
                        <a href="pharmacist/new_sale.php" class="sidebar-link sub-link">
                            <i class="fas fa-plus-circle"></i> New Sale
                        </a>
                        <a href="pharmacist/sales.php" class="sidebar-link sub-link">
                            <i class="fas fa-list"></i> Sales List
                        </a>
                        <a href="pharmacist/sales_return.php" class="sidebar-link sub-link">
                            <i class="fas fa-undo"></i> Sales Return
                        </a>
                        <a href="pharmacist/sales_history.php" class="sidebar-link sub-link">
                ...
                <!-- ===== BILLING & PAYMENT ===== -->
                <div class="sidebar-dropdown">
                    <button class="dropdown-toggle" onclick="toggleMenu('pharmacyBillingMenu')">
                        <span><i class="fas fa-file-invoice-dollar"></i> Billing & Payment</span>
                        <i class="fas fa-chevron-down dropdown-arrow"></i>
                    </button>
                    <div id="pharmacyBillingMenu" class="dropdown-menu">
                        <a href="pharmacist/bills.php" class="sidebar-link sub-link">
                            <i class="fas fa-file-invoice"></i> Pharmacy Bills
                        </a>
                        <a href="pharmacist/payments.php" class="sidebar-link sub-link">
                            <i class="fas fa-money-bill-wave"></i> Payments
                        </a>
                        <a href="pharmacist/pending_payments.php" class="sidebar-link sub-link">
                            <i class="fas fa-hourglass-half"></i> Pending Payments
                        </a>
                        <a href="pharmacist/refund.php" class="sidebar-link sub-link">
                            <i class="fas fa-undo-alt"></i> Refund
                        </a>
                        <a href="pharmacist/print_invoice.php" class="sidebar-link sub-link">
                ...
                <!-- ===== SUPPLIER MANAGEMENT ===== -->
                <div class="sidebar-dropdown">
                    <button class="dropdown-toggle" onclick="toggleMenu('supplierManagementMenu')">
                        <span><i class="fas fa-truck"></i> Supplier Management</span>
                        <i class="fas fa-chevron-down dropdown-arrow"></i>
                    </button>
                    <div id="supplierManagementMenu" class="dropdown-menu">
                        <a href="pharmacist/suppliers.php" class="sidebar-link sub-link">
                            <i class="fas fa-users"></i> Supplier List
                        </a>
                        <a href="pharmacist/add_supplier.php" class="sidebar-link sub-link">
                            <i class="fas fa-user-plus"></i> Add Supplier
                        </a>
                        <a href="pharmacist/supplier_purchase_history.php" class="sidebar-link sub-link">
                            <i class="fas fa-history"></i> Purchase History
                        </a>
                        <a href="pharmacist/supplier_outstanding.php" class="sidebar-link sub-link">
                            <i class="fas fa-money-check-alt"></i> Outstanding
                        </a>
                    </div>
                </div>
                ...
                <!-- ===== ALERTS ===== -->
                <div class="sidebar-dropdown">
                    <button class="dropdown-toggle" onclick="toggleMenu('pharmacyAlertsMenu')">
                        <span><i class="fas fa-bell"></i> Alerts</span>
                        <i class="fas fa-chevron-down dropdown-arrow"></i>
                    </button>
                    <div id="pharmacyAlertsMenu" class="dropdown-menu">
                        <a href="pharmacist/low_stock.php" class="sidebar-link sub-link">
                            <i class="fas fa-exclamation-circle"></i> Low Stock
                        </a>
                        <a href="pharmacist/expiry_alert.php" class="sidebar-link sub-link">
                            <i class="fas fa-calendar-times"></i> Expiry Alert
                        </a>
                        <a href="pharmacist/out_of_stock.php" class="sidebar-link sub-link">
                ...
                <!-- ===== REPORTS ===== -->
                <div class="sidebar-dropdown">
                    <button class="dropdown-toggle" onclick="toggleMenu('pharmacyReportsMenu')">
                        <span><i class="fas fa-chart-bar"></i> Reports</span>
                        <i class="fas fa-chevron-down dropdown-arrow"></i>
                    </button>
                    <div id="pharmacyReportsMenu" class="dropdown-menu">
                        <a href="pharmacist/sales_report.php" class="sidebar-link sub-link">
                            <i class="fas fa-chart-line"></i> Sales Report
                        </a>
                        <a href="pharmacist/purchase_report.php" class="sidebar-link sub-link">
                            <i class="fas fa-shopping-cart"></i> Purchase Report
                        </a>
                        <a href="pharmacist/stock_report.php" class="sidebar-link sub-link">
                            <i class="fas fa-boxes"></i> Stock Report
                        </a>
                        <a href="pharmacist/expiry_report.php" class="sidebar-link sub-link">
                            <i class="fas fa-calendar-alt"></i> Expiry Report
                        </a>
                        <a href="pharmacist/payment_report.php" class="sidebar-link sub-link">
                            <i class="fas fa-money-bill"></i> Payment Report
                        </a>
                        <a href="pharmacist/profit_loss.php" class="sidebar-link sub-link">
                ...
                <!-- ===== SETTINGS ===== -->
                <div class="sidebar-dropdown">
                    <button class="dropdown-toggle" onclick="toggleMenu('pharmacySettingsMenu')">
                        <span><i class="fas fa-cog"></i> Settings</span>
                        <i class="fas fa-chevron-down dropdown-arrow"></i>
                    </button>
                    <div id="pharmacySettingsMenu" class="dropdown-menu">
                        <a href="pharmacist/profile.php" class="sidebar-link sub-link">
                            <i class="fas fa-store"></i> Pharmacy Profile
                        </a>
                        <a href="pharmacist/invoice_settings.php" class="sidebar-link sub-link">
                            <i class="fas fa-file-invoice"></i> Invoice Settings
                        </a>
                        <a href="pharmacist/tax_settings.php" class="sidebar-link sub-link">
                            <i class="fas fa-percent"></i> Tax Settings
                        </a>
                        <a href="pharmacist/numbering_settings.php" class="sidebar-link sub-link">
                            <i class="fas fa-sort-numeric-up"></i> Numbering Settings
                        </a>
                    </div>
                </div>

                <?php endif; ?> <!-- End Pharmacist Section -->

                <!-- ==================== NURSE SECTION ==================== -->
                <?php if (hasAnyPerm(['vitals-view', 'vitals-add', 'vitals-update']) || hasAnyPermPrefix('vitals')): ?>
                <div class="sidebar-section-label">Nursing</div>

                <!-- Vitals Management -->
                <div class="sidebar-dropdown">
                    <button class="dropdown-toggle" onclick="toggleMenu('nurseMenu')">
                        <span><i class="fas fa-heartbeat"></i> Vitals Management</span>
                        <i class="fas fa-chevron-down dropdown-arrow"></i>
                    </button>
                    <div id="nurseMenu" class="dropdown-menu">
                        <?php if (hasPerm('vitals-view') || hasAnyPermPrefix('vitals-view')): ?>
                        <a href="vitals.php" class="sidebar-link sub-link">
                            <i class="fas fa-eye"></i> View Vitals
                        </a>
                        <?php endif; ?>
                        <?php if (hasPerm('vitals-add') || hasAnyPermPrefix('vitals-add')): ?>
                ...
                <?php if (hasAnyPerm(['nursing-notes-view', 'nursing-notes-add', 'nursing-notes-edit']) || hasAnyPermPrefix('nursing-notes')): ?>
                <div class="sidebar-dropdown">
                    <button class="dropdown-toggle" onclick="toggleMenu('nursingNotesMenu')">
                        <span><i class="fas fa-notes-medical"></i> Nursing Notes</span>
                        <i class="fas fa-chevron-down dropdown-arrow"></i>
                    </button>
                    <div id="nursingNotesMenu" class="dropdown-menu">
                        <?php if (hasPerm('nursing-notes-view') || hasAnyPermPrefix('nursing-notes-view')): ?>
                        <a href="nursing_notes.php" class="sidebar-link sub-link">
                            <i class="fas fa-eye"></i> View Nursing Notes
                        </a>
                        <?php endif; ?>
                        <?php if (hasPerm('nursing-notes-add') || hasAnyPermPrefix('nursing-notes-add')): ?>
            ...
            <?php endif; // End IF $is_accountant ?>
            ...
            switch ($role_lower) {
                ...
                case 'pharmacist': $profilePage = "pharmacy/update_profile.php"; break;
