...
<head>
    ...
    <style>
        ...
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .clickable-room { cursor: pointer; }
        .clickable-room:hover { background: #f8fafc; }
...
<body>
                    ...
                    <div class="card">
                        <div class="card-header">
                            <div class="flex flex-col w-full gap-2">
                                ...
                                <!-- ===== NEW TAB BAR ===== -->
                                <div class="tab-bar">
                                    <button class="tab-btn active" data-filter="all" onclick="filterRooms('all', this)">All</button>
                                    <button class="tab-btn" data-filter="Available" onclick="filterRooms('Available', this)">Available</button>
                                    <button class="tab-btn" data-filter="Occupied" onclick="filterRooms('Occupied', this)">Occupied</button>
                                    <button class="tab-btn" data-filter="Maintenance" onclick="filterRooms('Maintenance', this)">Maintenance</button>
                                </div>
                            </div>
                        </div>
    ...
    <script>
        ...
        // ===== UPDATED filterRooms FUNCTION (supports both stat cards & tabs) =====
