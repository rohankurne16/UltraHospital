<?php
// ============================================================
// UPDATE ADMIN PROFILE (Converted for Superadmin Folder)
// ============================================================

session_start();
include "../config/hospital.php"; // Updated path to go up one level

// Check if user is logged in
if (!isset($_SESSION['id'])) {
    header('Location: ../../index.php'); // Updated path to root login page
    exit();
}
...
if(isset($_POST['update_profile'])) {
    ...
    if(isset($_FILES['profile_image']) && $_FILES['profile_image']['error'] == 0){
        ...
        if(empty($errors['profile_image'])) {
            // Updated folder path to point to the root documents folder
    ...
    if(empty($errors)) {
        ...
        try{
            ...
            echo "<script>
                    ...
                    window.location='profile.php'; // Updated redirect to self
                  </script>";
...
if(isset($_POST['update_password'])) {
    ...
    if(empty($password_errors)) {
        ...
        // Note: Your script uses plain text comparison here. 
        // For better security, use password_verify() and password_hash() if you upgrade your login system.
...
<body>
    ...
    <?php include 'sidebar.php'; ?> <!-- Updated path to match superadmin sidebar -->
    ...
    <div class="main-wrapper">
        <main class="main-content" id="mainContent">
           ...
           <?php include 'header.php'; ?> <!-- Updated path to match superadmin header -->
            ...
            <div class="profile-container">
                ...
                <div class="form-card">
                    ...
                    <!-- Changed action to post to same file -->
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        function checkPermissions() {
            // Note: Ensure 'check_permissions.php' exists in the superadmin folder, 
            // otherwise this will console error and ignore the check.
            ...
            xhr.onerror = function() {
                // Silence error if check_permissions.php is missing
