...
$page_title = 'Hospital Staff';
$page_subtitle = 'Manage staff at ' . htmlspecialchars($hospital['hospital_name']);
?>
<!DOCTYPE html>
<html lang="en">
<head>
    ...
    <title>Staff - <?php echo htmlspecialchars($hospital['hospital_name']); ?></title>
        ...
        <div style="display:flex;align-items:center;gap:1rem;margin-bottom:1.5rem;">
            ...
            <div>
                ...
                <p style="color:#94a3b8;font-size:0.85rem;margin:0;">
                    <?php echo mysqli_num_rows($result); ?> staff member(s) found
                </p>
            </div>
        </div>
                    ...
                    <?php if (mysqli_num_rows($result) > 0): ?>
                        <?php while($row = mysqli_fetch_assoc($result)): ?>
                            <tr class="table-row">
                                ...
                                <td>
                                    <span style="padding:0.2rem 0.7rem;border-radius:12px;font-size:0.75rem;font-weight:500;background:rgba(59,130,246,0.1);color:#3b82f6;">
                    ...
                    <?php else: ?>
                        <tr>
                            <td colspan="6" style="padding:3rem;text-align:center;color:#94a3b8;">
                                <i class="fas fa-users" style="font-size:3rem;display:block;margin-bottom:1rem;color:#2a2a2a;"></i>
                                No staff members found
                                <br>
                                <span style="font-size:0.85rem;">Click "Add Staff" to add the first staff member</span>
                            </td>
                        </tr>
                    <?php endif; ?>
                </tbody>
