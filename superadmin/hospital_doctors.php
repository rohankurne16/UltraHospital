...
$page_subtitle = 'Manage doctors at ' . htmlspecialchars($hospital['hospital_name']);
?>
<!DOCTYPE html>
<html lang="en">
<head>
    ...
    <title>Doctors - <?php echo htmlspecialchars($hospital['hospital_name']); ?></title>
        ...
        <div style="display:flex;align-items:center;gap:1rem;margin-bottom:1.5rem;">
            ...
            <div>
                ...
                <p style="color:#94a3b8;font-size:0.85rem;margin:0;">
                    <?php echo mysqli_num_rows($result); ?> doctor(s) found
                </p>
            </div>
        </div>
                    ...
                    <?php else: ?>
                        <tr>
                            <td colspan="6" style="padding:3rem;text-align:center;color:#94a3b8;">
                                <i class="fas fa-user-md" style="font-size:3rem;display:block;margin-bottom:1rem;color:#2a2a2a;"></i>
                                No doctors found
                                <br>
                                <span style="font-size:0.85rem;">Click "Add Doctor" to add the first doctor</span>
                            </td>
                        </tr>
                    <?php endif; ?>
                </tbody>
