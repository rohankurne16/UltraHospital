...
$query = "SELECT r.*, h.hospital_name, roles.role_name as role_display_name 
          FROM register r 
...
<div class="main-content" id="mainContent" style="margin-left: 18%; margin-top:2%;">
    ...
    <!-- Filters -->
    <div class="content-card" style="margin-bottom:1.5rem; margin-top:2%;">
                            ...
                            <tr class="table-row">
                                <td>
                                    <div style="display:flex;align-items:center;gap:0.75rem;">
                                        <div style="width:40px;height:40px;border-radius:50%;background:rgba(59,130,246,0.1);display:flex;align-items:center;justify-content:center;color:#3b82f6;font-weight:700;font-size:0.8rem;">
                                ...
                                <td style="text-align:right;">
                                    <a href="edit_user.php?id=<?php echo $row['id']; ?>" class="btn-secondary" style="padding:0.3rem 0.8rem;font-size:0.8rem;">
