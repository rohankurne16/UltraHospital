...
$page_subtitle = 'Manage departments at ' . htmlspecialchars($hospital['hospital_name']);
?>
<!DOCTYPE html>
<html lang="en">
<head>
    ...
    <title>Departments - <?php echo htmlspecialchars($hospital['hospital_name']); ?></title>
        ...
        <div style="display:flex;align-items:center;gap:1rem;margin-bottom:1.5rem;">
            ...
            <div>
                ...
                <p style="color:#94a3b8;font-size:0.85rem;margin:0;">
                    <?php echo mysqli_num_rows($result); ?> department(s) found
                </p>
            </div>
        </div>
                            ...
                            <tr class="table-row">
                                ...
                                <td>
                                    <div style="display:flex;align-items:center;gap:0.75rem;">
                                        <div class="department-icon" style="background:rgba(59,130,246,0.1);color:#3b82f6;">
                                            <i class="fas fa-building"></i>
                                        </div>
                                        <div>
                                ...
                                <td>
                                    <span class="desc-text" style="color:<?php echo $theme == 'dark' ? '#d1d5db' : '#475569'; ?>;" title="<?php echo htmlspecialchars($row['description'] ?? ''); ?>">
                    ...
                    <?php else: ?>
                        <tr>
                            <td colspan="4" style="padding:3rem;text-align:center;color:#94a3b8;">
                                <i class="fas fa-building" style="font-size:3rem;display:block;margin-bottom:1rem;color:#2a2a2a;"></i>
                                No departments found
                                <br>
                                <span style="font-size:0.85rem;">Click "Add Department" to add the first department</span>
                            </td>
                        </tr>
                    <?php endif; ?>
                </tbody>
