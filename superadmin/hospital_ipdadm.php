...
$page_title = 'Hospital IPD Admissions';
$page_subtitle = 'Manage IPD admissions at ' . htmlspecialchars($hospital['hospital_name']);
?>
<!DOCTYPE html>
<html lang="en">
<head>
    ...
    <title>IPD Admissions - <?php echo htmlspecialchars($hospital['hospital_name']); ?></title>
    ...
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .status-admitted { background: rgba(34, 197, 94, 0.15); color: #22c55e; }
        .status-discharged { background: rgba(239, 68, 68, 0.15); color: #ef4444; }
        ...
        <div style="display:flex;align-items:center;gap:1rem;margin-bottom:1.5rem;">
            ...
            <div>
                ...
                <p style="color:#94a3b8;font-size:0.85rem;margin:0;">
                    <?php echo mysqli_num_rows($result); ?> admission(s) found
                </p>
            </div>
        </div>
                    ...
                    <?php if (mysqli_num_rows($result) > 0): ?>
                        <?php while($row = mysqli_fetch_assoc($result)): ?>
                            <tr class="table-row">
                                ...
                                <td style="color:<?php echo $theme == 'dark' ? '#d1d5db' : '#475569'; ?>;">
                                    <?php echo htmlspecialchars($row['bed_no']); ?>
                                </td>
                                <td style="color:<?php echo $theme == 'dark' ? '#d1d5db' : '#475569'; ?>;font-size:0.85rem;">
                                    <?php echo date('d-m-Y', strtotime($row['admission_date'])); ?>
                                </td>
                                <td>
                                    <span class="status-badge <?php echo ($row['status'] == 'Admitted') ? 'status-admitted' : 'status-discharged'; ?>">
                    ...
                    <?php else: ?>
                        <tr>
                            <td colspan="9" style="padding:3rem;text-align:center;color:#94a3b8;">
                                <i class="fas fa-procedures" style="font-size:3rem;display:block;margin-bottom:1rem;color:#2a2a2a;"></i>
                                No IPD admissions found
                                <br>
                                <span style="font-size:0.85rem;">Click "Add IPD Admission" to add the first admission</span>
                            </td>
                        </tr>
                    <?php endif; ?>
                </tbody>
