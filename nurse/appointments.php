...
// Get nurse name
$nurseName = '';
$nurseQuery = "SELECT name FROM register WHERE id = $register_id AND (delete_flag = 0 OR delete_flag IS NULL)";
...
$page_title = ($hospital['hospital_name'] ?? 'Hospital') . " - Nurse Appointments";
...
<body>
                        ...
                        <div class="flex flex-col md:flex-row items-start md:items-center justify-between gap-4">
                            <div class="flex items-center gap-4">
                                ...
                                <div>
                                    ...
                                    <p class="text-gray-500 text-sm mt-1">Welcome, <?php echo htmlspecialchars($nurseName ?: 'Nurse'); ?> - view all hospital appointments and schedules.</p>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="bg-white rounded-xl border border-gray-200 shadow-sm overflow-hidden">
                        <div class="tabs-wrapper">
                            <div class="flex flex-wrap gap-2" style="flex-wrap: nowrap;">
                                ...
                                <div class="tab-btn tab-inactive" id="tab-completed" onclick="filterAppointments('completed')">
                                    Completed <span class="badge-count"><?php echo $completedCount; ?></span>
                                </div>
                        ...
                        <div class="p-4 border-b border-gray-200 flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                            <div>
                                ...
                                <p class="text-sm text-gray-500" id="table-subtitle">View and manage all hospital appointments.</p>
                            </div>
                            ...
                            <table class="w-full text-sm">
                                ...
                                <?php if ($re && mysqli_num_rows($re) > 0) { 
                                    while ($row = mysqli_fetch_assoc($re)) { 
                                        ...
                                        $doctorName = !empty($row['doctor_name']) ? htmlspecialchars($row['doctor_name']) : 'Not Assigned';
                                    ...
                                    <tr class="appointment-row border-b border-gray-100 hover:bg-gray-50 transition-all fade-in"
                                        ...
                                        <td class="px-4 py-3">
                                            <div class="font-medium text-gray-900"><?php echo $patientName; ?></div>
                                            <div class="text-xs text-gray-500">#<?php echo str_pad($row['patient_id'] ?? 0, 4, '0', STR_PAD_LEFT); ?></div>
                                        </td>
                                        <td class="px-4 py-3">
                                            <div class="font-medium text-gray-900"><?php echo $doctorName; ?></div>
                                            <div class="doctor-dept"><?php echo $department; ?></div>
                                        </td>
                                        <td class="px-4 py-3">
                                    ...
                                    <tr>
                                        <td colspan="6" class="text-center py-8 text-gray-500">
                                            <i class="fas fa-calendar-times text-4xl block mb-3 text-gray-300"></i>
                                            <p class="font-medium">No Appointments Found</p>
                                            <p class="text-sm text-gray-400">No appointments have been scheduled yet.</p>
                                        </td>
                                    </tr>
                                <?php } ?>
                                </tbody>
    ...
    <script>
        ...
        function filterAppointments(filter) {
            ...
            const titles = {
                'all': ['All Appointments', 'View all hospital appointments'],
                'today': ['Today\'s Appointments', 'View today\'s appointments'],
