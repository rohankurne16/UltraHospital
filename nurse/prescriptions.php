                        ...
                        <div class="flex flex-col md:flex-row items-start md:items-center justify-between gap-4">
                            <div class="flex items-center gap-4">
                                ...
                                <div>
                                    ...
                                    <p class="text-gray-500 text-xs md:text-sm">Welcome, <?php echo htmlspecialchars($nurseName ?: 'Nurse'); ?> - View all hospital prescriptions.</p>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="bg-white rounded-xl border shadow-sm p-4 mb-5">
                        <div class="flex flex-wrap items-center justify-between gap-4">
                            <div class="flex items-center gap-2 flex-wrap">
                                <a href="prescriptions.php?view=<?php echo $view; ?>&date=<?php echo $prevDate; ?>&filter=<?php echo $filter; ?>"
                                   class="p-2 border rounded-lg hover:bg-gray-100 transition-colors">
                                    <i data-lucide="chevron-left" class="w-5 h-5"></i>
                                </a>
                                <a href="prescriptions.php?view=<?php echo $view; ?>&date=<?php echo date('Y-m-d'); ?>&filter=<?php echo $filter; ?>"
                                   class="px-4 py-2 border rounded-lg hover:bg-gray-100 font-medium text-sm transition-colors">
                                    <?php echo $title; ?>
                                </a>
                                <a href="prescriptions.php?view=<?php echo $view; ?>&date=<?php echo $nextDate; ?>&filter=<?php echo $filter; ?>"
                                   class="p-2 border rounded-lg hover:bg-gray-100 transition-colors">
                                    <i data-lucide="chevron-right" class="w-5 h-5"></i>
                                </a>
                            </div>
                            <div class="view-buttons flex rounded-lg border overflow-hidden">
                                <a href="prescriptions.php?view=day&date=<?php echo $currentDate; ?>&filter=<?php echo $filter; ?>"
                                   class="px-3 py-2 text-sm <?php echo ($view=='day')?'bg-blue-600 text-white':'hover:bg-gray-100'; ?>">
                                    Day
                                </a>
                                <a href="prescriptions.php?view=week&date=<?php echo $currentDate; ?>&filter=<?php echo $filter; ?>"
                                   class="px-3 py-2 text-sm <?php echo ($view=='week')?'bg-blue-600 text-white':'hover:bg-gray-100'; ?>">
                                    Week
                                </a>
                                <a href="prescriptions.php?view=month&date=<?php echo $currentDate; ?>&filter=<?php echo $filter; ?>"
                    ...
                    <div class="card w-full">
                        ...
                        <div class="tabs-wrapper">
                            <div class="flex flex-wrap gap-2" style="flex-wrap: nowrap;">
                                <div class="tab-btn <?php echo ($filter=='all')?'tab-active':'tab-inactive'; ?>" 
                                     id="tab-all" onclick="window.location.href='?filter=all&view=<?php echo $view; ?>&date=<?php echo $currentDate; ?>'">
                                    All <span class="badge-count"><?php echo $totalCount; ?></span>
                                </div>
                                <div class="tab-btn <?php echo ($filter=='today')?'tab-active':'tab-inactive'; ?>" 
                                     id="tab-today" onclick="window.location.href='?filter=today&view=<?php echo $view; ?>&date=<?php echo $currentDate; ?>'">
                                    Today <span class="badge-count"><?php echo $todayCount; ?></span>
                                </div>
                                <div class="tab-btn <?php echo ($filter=='tomorrow')?'tab-active':'tab-inactive'; ?>" 
                                     id="tab-tomorrow" onclick="window.location.href='?filter=tomorrow&view=<?php echo $view; ?>&date=<?php echo $currentDate; ?>'">
                                    Follow-up <span class="badge-count"><?php echo $followCount; ?></span>
                                </div>
                                <div class="tab-btn <?php echo ($filter=='week')?'tab-active':'tab-inactive'; ?>" 
                                     id="tab-week" onclick="window.location.href='?filter=week&view=<?php echo $view; ?>&date=<?php echo $currentDate; ?>'">
                                    Week <span class="badge-count"><?php echo $weekCount; ?></span>
                                </div>
                                <div class="tab-btn <?php echo ($filter=='month')?'tab-active':'tab-inactive'; ?>" 
                                     id="tab-month" onclick="window.location.href='?filter=month&view=<?php echo $view; ?>&date=<?php echo $currentDate; ?>'">
                        ...
                        <div class="card-body overflow-x-auto p-4">
                            ...
                            <div class="table-wrapper">
                                <table class="w-full text-sm">
                                    ...
                                    <tbody id="prescriptionTableBody">
                                        ...
                                        <tr class="border-b border-gray-100 clickable-row"
                            ...
                            <div class="py-12 text-center text-gray-500">
                                ...
                                <p class="text-sm text-gray-400">No prescriptions available for the selected period.</p>
                            </div>
                            <?php endif; ?>
                        </div>
                    </div>
