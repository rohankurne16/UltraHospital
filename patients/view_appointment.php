...
$error_message = null;
$redirect_page = 'appointments.php'; // Default redirect
    ...
    if ($stmt) {
        ...
        if ($result && $result->num_rows > 0) {
            ...
            if ($data['opd_ipd_type'] == 'IPD') {
                $redirect_page = 'appointments.php';
                        ...
                        <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
                            ...
                            <div class="info-card">
                                ...
                                <div class="card-body">
                                    <div class="flex items-center gap-4 mb-4">
                                        <?php
                                            $doctorImage = "../" . $doctor_details['doctor_photo'];

                                            if (!empty($doctor_details['doctor_photo']) && file_exists($doctorImage)) {
                                            ?>
                                                <img src="<?php echo htmlspecialchars($doctorImage); ?>" class="profile-image" alt="Doctor">
                                            <?php } else { ?>
                                                <div class="profile-image-placeholder">
                                                    <?php echo strtoupper(substr($doctor_details['doctor_name'], 0, 2)); ?>
                                                </div>
                                            <?php } ?>
                                        <div>
