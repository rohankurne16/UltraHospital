...
<head>
    ...
    <title>MedixPro - Patient Profile</title>
            ...
            <main class="flex-1 xl:ml-64 p-4 md:p-8">
                <div class="max-w-6xl mx-auto w-full">
                    <div class="flex items-center gap-4 mb-8">
                        <a href="../patients.php" class="p-2 border rounded-md hover:bg-gray-100">
                            ...
                            <div class="bg-white rounded-xl border shadow-sm overflow-hidden">
                                <div class="p-6 flex flex-col items-center text-center border-b">
                                  ...
                                  <img src="<?php echo $image; ?>" width="220" height="220" alt="Patient Image">
                                    ...
                                    <p class="text-sm text-gray-500">Patient ID: #<?php echo $id ?></p>
                                ...
                                <div class="p-4 bg-gray-50 flex gap-2">
                                    <button onclick="window.location.href='update_patient.php?id=<?php echo $patient_id; ?>'" class="flex-1 bg-white border px-4 py-2 rounded-md text-sm font-medium hover:bg-gray-100 transition">Edit</button>
                                    <button class="flex-1 bg-blue-600 text-white px-4 py-2 rounded-md text-sm font-medium hover:bg-blue-700 transition">Message</button>
                                </div>
                            </div>
                                        ...
                                        <div class="pt-8 border-t space-y-4">
                                            ...
                                            <div class="space-y-4">
                                                <div class="flex items-start gap-4">
                                                    ...
                                                    <div>
                                                        <p class="text-sm font-medium text-gray-900">Follow-up Appointment</p>
                                                        <p class="text-xs text-gray-500">Completed with Dr. Sarah Smith • June 15, 2026</p>
                                                    </div>
                                                </div>
                                                <div class="flex items-start gap-4">
                                                    ...
                                                    <div>
                                                        <p class="text-sm font-medium text-gray-900">Lab Results Uploaded</p>
                                                        <p class="text-xs text-gray-500">Blood Work Report • June 12, 2026</p>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div id="appointments" class="tab-content hidden">
                                            ...
                                            <table class="w-full border">
                                                ...
                                                <?php
                                                        ...
                                                        $patient_appointment="select * from appointments where patient_id='$patient_id' and (delete_flag = 0 or delete_flag is null) order by appointment_date DESC";
