<?php
// ============================================================
// ACCOUNTANT PROFILE - UPDATE PROFILE & PASSWORD
// (Any logged‑in Accountant, Admin or Super Admin can view/edit)
// ============================================================
...
// Allow only 'Accountant' (and Admins/Super Admins if needed)
$allowed_roles = ['Accountant', 'Admin', 'Super Admin'];
...
if ($result->num_rows > 0) {
    ...
    echo "<script>
            alert('Accountant profile not found.');
            window.location='dashboard_accountant.php';
          </script>";
    exit();
}
...
if (isset($_POST['update_profile'])) {
    ...
    if (isset($_FILES['profile_image']) && $_FILES['profile_image']['error'] == 0) {
        ...
        if (empty($errors['profile_image'])) {
            $folder = "documents/accountant/images/";
            if (!is_dir($folder)) {
...
<head>
    ...
    <title><?php echo htmlspecialchars($hospital_name); ?> - Accountant Profile</title>
        ...
        <div class="profile-container">
            ...
            <div class="form-card">
                <h2 class="card-title">
                    ...
                    Accountant Profile Information
                </h2>
                ...
                <form action="update_adminprofile.php" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="form-actions">
                        <a href="dashboard_accountant.php" class="btn btn-secondary">
