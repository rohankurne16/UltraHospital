<?php
// ============================================================
// BILLING LIST – Active bills only
// ============================================================
...
<head>
    ...
    <style>
        ...
        * { margin:0; padding:0; box-sizing:border-box; }
        ...
        .filter-bar .btn-secondary { background:#e2e8f0; color:#475569; }
        .filter-bar .btn-secondary:hover { background:#cbd5e1; }
        ...
        .action-btn .fa-edit { color:#ed8936; }
        .action-btn .fa-eye { color:#3b82f6; }
        .action-btn .fa-print { color:#38a169; }
        .action-btn .fa-trash { color:#e53e3e; }

        .empty { padding:40px 20px; text-align:center; color:#94a3b8; }
        .empty i { font-size:48px; display:block; margin-bottom:12px; color:#cbd5e1; }
        .empty p { font-size:16px; font-weight:500; color:#64748b; }
    </style>
</head>
<body>
    ...
    <div class="d-flex">
        ...
        <main class="main-content">
            ...
            <div class="greeting-gradient">
                <div>
                    <h1><i class="fas fa-file-invoice"></i> Billing List</h1>
                    <p>Manage all active bills</p>
                </div>
                <a href="create_bill.php" class="btn"><i class="fas fa-plus"></i> New Bill</a>
            </div>
            ...
            <div class="filter-bar">
                ...
                <a href="cancelled_bills.php" class="btn btn-secondary">Cancelled</a>
                <a href="deleted_bills.php" class="btn btn-secondary">Deleted</a>
            </div>
                                ...
                                <?php if ($result && $result->num_rows > 0): ?>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <a href="edit_bill.php?id=<?php echo $row['id']; ?>" class="action-btn" title="Edit"><i class="fas fa-edit"></i></a>
                                            <a href="print_bill.php?id=<?php echo $row['id']; ?>" class="action-btn" title="Print"><i class="fas fa-print"></i></a>
                                            <a href="cancelled_bills.php?action=cancel&id=<?php echo $row['id']; ?>" class="action-btn" title="Cancel" onclick="return confirm('Cancel this bill?')"><i class="fas fa-times-circle" style="color:#e53e3e;"></i></a>
                                        </td>
                                    </tr>
                                    <?php endwhile; ?>
                                <?php else: ?>
                                    <tr><td colspan="8" class="empty">No active bills found.</td></tr>
                                <?php endif; ?>
                            </tbody>
                        </table>
                    </div>
    ...
    <script>
        function applyFilters() {
            ...
            window.location.href = `billing_list.php?search=${encodeURIComponent(search)}&status=${status}&from=${from}&to=${to}`;
        }
