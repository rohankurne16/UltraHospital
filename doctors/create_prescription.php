...
if ($all_doctor_info && $all_doctor_info->num_rows > 0) {
    ...
    if ($selected_patient_id > 0) {
        $patientQuery = "SELECT patient_name FROM patients WHERE patient_id = '$selected_patient_id'";
    ...
    if ($_SERVER['REQUEST_METHOD'] == 'POST' && isset($_POST['submit'])) {
        ...
        $insertQuery = "INSERT INTO prescriptions (patient_id, doctor_id, medicine_name, dosage, frequency, days, timing, advice, followup_date, created_at, delete_flag) 
                        VALUES ('$patient_id', '$doctor_id', '$medicine_name', '$dosage', '$frequency', '$days', '$timing', '$advice', '$followup_date', NOW(), 0)";
                    ...
                    <div class="mb-8">
                        <div class="flex items-center gap-4">
                            ...
                            <div>
                                ...
                                <p class="text-gray-500">Enter medication details for the patient.</p>
                            </div>
                        </div>
                    </div>
                                ...
                                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                   <div class="form-group">
                                    ...
                                    <div class="form-group md:col-span-2">
                                        ...
                                        <input type="text" name="medicine_name" class="form-input" placeholder="e.g. Paracetamol" required>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="frequency" class="form-input" placeholder="e.g. Twice a day" required>
                                    </div>

                                    <div class="form-group">
                                        <label class="form-label">Duration (Days) <span class="required">*</span></label>
                                        <input type="number" name="days" class="form-input" placeholder="e.g. 7" required>
                                    </div>
                                    ...
                                    <div class="form-group md:col-span-2">
                                        ...
                                        <textarea name="advice" class="form-textarea" placeholder="e.g. Take after meal"></textarea>
                                    </div>
