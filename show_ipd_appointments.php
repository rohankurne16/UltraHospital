...
<body>
            ...
            <main class="main-content">
                <div class="max-w-6xl mx-auto w-full">
                    <div class="mb-6 flex items-center gap-4">
                        ...
                        <div>
                            <h1 class="text-2xl font-bold text-gray-900">IPD Appointments</h1>
                            <p class="text-gray-500">View all Inpatient Department appointments.</p>
                        </div>
                    </div>
                        ...
                        <table>
                            ...
                            <tbody>
                                <?php if (empty($appointments)): ?>
                                    <tr>
                                        <td colspan="10" class="text-center py-4 text-gray-500">No IPD appointments found.</td>
                                    </tr>
                                <?php else: ?>
    ...
    <td onclick="event.stopPropagation();">
        <a href="edit_appointment.php?id=<?php echo $appointment['appointment_id']; ?>" class="action-btn edit">
