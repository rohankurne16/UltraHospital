...
$doctorSql = "SELECT doctor_id, doctor_name
              FROM doctor
...
<div class="form-group">
    ...
    <select name="doctor_id" id="doctor_id" class="form-input" required>
        <option value="">Select Doctor</option>

        <?php while($doc = $doctorResult->fetch_assoc()) { ?>
...
doctor.addEventListener("change", function () {
    ...
    fetch("get_patients.php?doctor_id=" + this.value)
